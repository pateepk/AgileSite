...
namespace CMS.FormEngine.Web.UI
{
    ...
    public class BasicForm : AbstractBasicForm, IFormStyleConfiguration
    {
        ...
        private string mExpandCategoryImageUrl = UIHelper.GetImageUrl(null, "CMSModules/CMS_PortalEngine/WebpartProperties/plus.png");


        private string mCollapseCategoryImageUrl = UIHelper.GetImageUrl(null, "CMSModules/CMS_PortalEngine/WebpartProperties/minus.png");
        ...
        public ImageButton SubmitImageButton
        {
            get
            {
                return mSubmitImageButton ?? (mSubmitImageButton = new ImageButton
                {
                    ...
                    CssClass = FormButtonCssClass,
                    AlternateText =
                        ResHelper.GetString("general.ok"),
                    EnableViewState = false
                });
            }
            set
        ...
        public override bool Enabled
        {
            ...
            set
            {
                ...
                if (FieldEditingControls != null)
                {
                    ...
                    {
                        var control = entry.Value as EditingFormControl;
                        if (control != null)
                        {
                ...
                if (FieldControls != null)
                {
                    ...
                    {
                        var control = entry.Value as FormEngineUserControl;
                        if (control != null)
                        {
                            control.Enabled = base.Enabled;
        ...
        public string ExpandCategoryImageUrl
        {
            get
            {
                return mExpandCategoryImageUrl;
            }
            set
            {
        ...
        public string CollapseCategoryImageUrl
        {
            get
            {
                return mCollapseCategoryImageUrl;
            }
            set
            {
        ...
        protected void ProcessVisibility()
        {
            ...
            foreach (FormFieldInfo ffi in FormInformation.GetFields(true, true))
            {
                ...
                switch (ffi.Visibility)
                {
                    ...
                    // Set control to be visible only to current user's friends
                    case FormFieldVisibilityTypeEnum.Friends:
                        {
                            GeneralizedInfo editedUser = null;

                            var obj = EditedObject as BaseInfo;
                            if (obj != null)
                            {
                                // Get edited user
                                editedUser = obj.Generalized;
                            }

                            // Check friendship relationship
                            var currentUser = MembershipContext.AuthenticatedUser;

                            if ((editedUser != null) && (currentUser != null) &&
                                ((editedUser.ObjectID == currentUser.UserID) ||
                                 (currentUser.HasFriend(editedUser.ObjectID) == FriendshipStatusEnum.Approved)))
                            {
                                ffi.Visible = true;
                            }
                        }
        ...
        protected virtual void layout_OnAfterRegisterFormControl(object sender, EventArgs e)
        {
            ...
            if (DefaultFieldLayout != FieldLayoutEnum.Default)
            {
                ...
                var formField = args?.ChildControl as FormField;
                if (formField != null)
                {
            ...
            if (FieldEditingControls != null)
            {
                ...
                foreach (string columnName in Data.ColumnNames)
                {
                    ...
                    if (AllowEditVisibility && FieldVisibilityControls.Contains(columnName))
                    {
                        ...
                        FormEngineUserControl ctrlVisibility = FieldVisibilityControls[columnName] as FormEngineUserControl;
                        if (ctrlVisibility != null)
                        {
        ...
        public string GetWhereCondition()
        {
            ...
            if ((FieldControls != null) && (FieldControls.Values.Count > 0))
            {
                ...
                {
                    string condition = ctrl?.GetWhereCondition();
