...
{
    using TypedDataSet = InfoDataSet<TimeZoneInfo>;
    ...
    public class TimeZoneInfoProvider : AbstractInfoProvider<TimeZoneInfo, TimeZoneInfoProvider>
    {
        ...
        [Obsolete("Use method GetTimeZones() instead")]
        public static TypedDataSet GetTimeZones(string where, string orderBy)
        {
            return ProviderObject.GetTimeZonesInternal(where, orderBy);
        }
        ...
        [Obsolete("Use method GetTimeZones() instead")]
        public static TypedDataSet GetTimeZones(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetTimeZonesInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="orderBy">Order by clause</param>
        [Obsolete("Use method GetTimeZones() instead")]
        protected virtual TypedDataSet GetTimeZonesInternal(string where, string orderBy)
        {
            return GetTimeZonesInternal(where, orderBy, 0, null);
        }
        ...
        /// <param name="columns">Data columns to return</param>
        [Obsolete("Use method GetTimeZones() instead")]
        protected virtual TypedDataSet GetTimeZonesInternal(string where, string orderBy, int topN, string columns)
        {
