...
namespace CMS.Personas
{
    ...
    internal class PersonasUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("PersonasRulesCountPerRuleType", JsonConvert.SerializeObject(GetNumberOfRulesInPersonasGroupedByType()));
            usageData.Add("NumberOfContactsInEachPersona", JsonConvert.SerializeObject(GetNumberOfContactsInEachPersona()));
