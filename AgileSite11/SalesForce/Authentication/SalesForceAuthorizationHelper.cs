...
namespace CMS.SalesForce
{
    ...
    public sealed class SalesForceAuthorizationHelper
    {
        ...
        {
            return String.Format("https://login.salesforce.com/services/oauth2/authorize?response_type=code&client_id={0}&redirect_uri={1}&state={2}", HttpUtility.UrlEncode(mClientId), HttpUtility.UrlEncode(mRedirectUrl), HttpUtility.UrlEncode(state));
        }
