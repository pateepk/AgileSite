...
namespace CMS.SalesForce
{
    ...
    /// </summary>
    public sealed class IntegerAttributeValueConverter : AttributeValueConverterBase
    {
        ...
        public IntegerAttributeValueConverter(EntityAttributeModel attributeModel, FormFieldInfo fieldInfo)
        ...
        {
            string representation = Math.Floor(Math.Abs(value)).ToString("F0", CultureInfo.InvariantCulture);

            return representation.Length <= mAttributeModel.IntegerPrecision;
        }
