...
namespace CMS.Community
{
    ...
    public class CommunityResolvers : ResolverDefinition
    {
        ...
        private static MacroResolver mFriendsResolver = null;
        ...
        /// </summary>
        public static MacroResolver FriendsResolver
        {
            get
            {
                if (mFriendsResolver == null)
                {
                    ...
                    resolver.SetNamedSourceData("Friendship", ModuleManager.GetReadOnlyObject(FriendInfo.OBJECT_TYPE));

                    RegisterStringValues(resolver, new[] { "ManagementUrl", "ProfileUrl", "FormatedSenderName", "FormatedRecipientName" });
