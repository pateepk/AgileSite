...
namespace CMS.Community
{
    ...
    public class CommunityModule : Module
    {
        ...
        /// <summary>
        /// Name of email template type for friends.
        /// </summary>
        public const string FRIENDS_EMAIL_TEMPLATE_TYPE_NAME = "friends";
        ...
        protected override void OnInit()
        {
            ...
            ExtendList<MacroResolverStorage, MacroResolver>.With("FriendsResolver").WithLazyInitialization(() => CommunityResolvers.FriendsResolver);
        ...
        protected override void RegisterCommands()
        {
            ...
            RegisterCommand("GetUserFriendshipRelations", GetUserFriendshipRelations);
            ...
            RegisterCommand("FriendshipExists", FriendshipExists);
        ...
        /// <summary>
        /// Gets user friendships
        /// </summary>
        /// <param name="parameters">Parameters array</param>
        private static DataSet GetUserFriendshipRelations(object[] parameters)
        {
            int userId = (int)parameters[0];
            string orderBy = (string)parameters[1];
            int topN = (int)parameters[2];
            string columns = (string)parameters[3];

            // Gets user friendship relations
            return FriendInfoProvider.GetUserFriendshipRelations(userId, orderBy, topN, columns);
        }
        ...
        /// </summary>
        /// <param name="parameters">Parameters array</param>
        private static object FriendshipExists(object[] parameters)
        {
            int friendUserId = (int)parameters[0];
            int requestedId = (int)parameters[1];

            return FriendInfoProvider.FriendshipExists(friendUserId, requestedId);
        }
