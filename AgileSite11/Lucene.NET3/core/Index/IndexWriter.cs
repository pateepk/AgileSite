...
namespace Lucene.Net.Index
{
    ...
    */
    public class IndexWriter : System.IDisposable
	{
        ...
        /// Lock timeout
        /// </summary>
        private static long? mLockTimeout = null;
        ...
        public static long LockTimeout
        {
            get
            {
                if (mLockTimeout == null)
                {
                    string settingValue = ConfigurationManager.AppSettings["CMSSmartSearchLockTimeout"];
                    mLockTimeout = string.IsNullOrEmpty(settingValue) ? WRITE_LOCK_TIMEOUT : Convert.ToInt64(settingValue);
                }

                return mLockTimeout.Value;
            }
        }
		...
		private long writeLockTimeout = LockTimeout;
