        ...
        public virtual IInfoObjectCollection<ContactGroupInfo> ContactGroups
        {
            get
            {
                ...
                return CacheHelper.Cache(() =>
                {
                    ...
                    col.Where = new WhereCondition(string.Format("ContactGroupID IN (SELECT ContactGroupMemberContactGroupID FROM OM_ContactGroupMember WHERE ContactGroupMemberRelatedID = {0} AND ContactGroupMemberType = 0)", ObjectID));
