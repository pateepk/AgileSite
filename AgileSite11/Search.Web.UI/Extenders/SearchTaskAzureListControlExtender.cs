...
public class SearchTaskAzureListControlExtender : ControlExtender<UniGrid>
{
    ...
    private object RenderResult(DataRowView row)
    {
        ...
        return $"<a target=\"_blank\" href=\"{resultUrl}\" onclick=\"modalDialog('{resultUrl}', 'taskresult', 700, 500); return false;\">{LocalizationHelper.GetString("smartsearch.resultfailed")}</a>";
    }
    ...
    private void DisplayTaskRunningMessage()
    {
        ...
        {
            string message = LocalizationHelper.GetString("smartsearch.taskprocessingrunning.azure");
