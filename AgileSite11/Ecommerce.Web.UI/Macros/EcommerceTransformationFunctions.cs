    ...
    public class EcommerceTransformationFunctions
    {
        ...
        public static string GetAddToShoppingCartLink(object productId, object enabled, string imageUrl)
        {
            if (ValidationHelper.GetBoolean(enabled, false) && (ValidationHelper.GetInteger(productId, 0) != 0))
            {
                ...
                return "<img src=\"" + UIHelper.GetImageUrl(null, imageUrl) + "\" alt=\"Add to cart\" /><a href=\"" + ShoppingCartURL(SiteContext.CurrentSiteName) + "?productId=" + Convert.ToString(productId) + "&amp;quantity=1\">" + ResHelper.GetString("EcommerceTransformationFunctions.AddToShoppingCart") + "</a>";
            }
        ...
        public static string GetAddToWishListLink(object productId, string imageUrl)
        {
            if (ValidationHelper.GetInteger(productId, 0) != 0)
            {
                ...
                return "<img src=\"" + UIHelper.GetImageUrl(null, imageUrl) + "\" alt=\"Add to wishlist\" /><a href=\"" + WishlistURL(SiteContext.CurrentSiteName) + "?productId=" + Convert.ToString(productId) + "\">" + ResHelper.GetString("EcommerceTransformationFunctions.AddToWishlist") + "</a>";
            }
