...
namespace CMS.Ecommerce.Web.UI
{
    ...
    public class ProductUIHelper
    {
        ...
        public static DialogConfiguration GetProductDialogConfig(string action, string culture)
        {
            var config = DocumentUIHelper.GetDocumentDialogConfig(action, culture);
            if (config != null)
            {
                // Restrict selection to subtree specified by product starting path
                config.ContentStartingPath = HttpUtility.UrlEncode(ECommerceSettings.ProductsStartingPath(config.ContentSelectedSite));
            }
