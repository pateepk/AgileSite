...
namespace CMS.WebServices
{
    ...
    public class RESTSecurityInvoker : Attribute, IOperationBehavior, IOperationInvoker
    {
        ...
        public object Invoke(object instance, object[] inputs, out object[] outputs)
        {
            ...
            AbstractStockHelper<RequestStockHelper>.Add("ContextRawUrl", OperationContext.Current.IncomingMessageHeaders.To.PathAndQuery, true);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!String.IsNullOrEmpty(AuthenticateUser()))
                    {
                        ...
                        AbstractStockHelper<RequestStockHelper>.Add("RequestActionContextUser", BaseRESTService.GetCurrentUser(), true);
        ...
        {
            string userName = (string)AbstractStockHelper<RequestStockHelper>.GetItem(USER_NAME_KEY);
        ...
        internal static string AuthenticateUser(bool checkHash)
        {
            ...
            AbstractStockHelper<RequestStockHelper>.Add(USER_NAME_KEY, userName);
        ...
        private string GetAuthenticatedUserNameInternal(bool checkHash)
        {
            ...
            if (RequestHelper.IsWindowsAuthentication())
            {
                ...
                {
                    AbstractStockHelper<RequestStockHelper>.Add(BaseRESTService.USER_KEY, actualUser, true);
        ...
        private bool CheckHashInternal()
        {
            ...
            {
                AbstractStockHelper<RequestStockHelper>.Add(HASH_AUTH_KEY, false);
                return false;
            }
            ...
            AbstractStockHelper<RequestStockHelper>.Add(HASH_AUTH_KEY, hashValidationResult);
        ...
        private string AuthenticateUserBasicInternal()
        {
            ...
            if (SecurityHelper.TryParseBasicAuthorizationHeader(IncomingRequest.Headers["Authorization"], out username, out password))
            {
                ...
                if (user != null)
                {
                    AbstractStockHelper<RequestStockHelper>.Add(BaseRESTService.USER_KEY, user, true);
        ...
        {
            return AbstractStockHelper<RequestStockHelper>.Contains(HASH_AUTH_KEY) ? (bool)RequestStockHelper.GetItem(HASH_AUTH_KEY) : InternalImplementation.CheckHashInternal();
        }
