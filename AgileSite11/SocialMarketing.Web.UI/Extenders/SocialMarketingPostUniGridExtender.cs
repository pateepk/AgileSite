...
namespace CMS.SocialMarketing.Web.UI
{
    ...
    public class SocialMarketingPostUniGridExtender : ControlExtender<UniGrid>
    {
        ...
        private readonly string mPostDocumentUrlFormat = URLHelper.GetAbsoluteUrl("~/Admin/cmsadministration.aspx?action=edit&mode=editform") + "&nodeId={0}&culture={1}" + ApplicationUrlHelper.GetApplicationHash("cms.content", "content");
