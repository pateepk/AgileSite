...
namespace CMS.Search.Azure
{
    ...
    public class SearchServiceManager
    {
        ...
        /// after enumeration end.
        /// </summary>
        private IEnumerable<SearchResult> GetAllSearchResults(ISearchIndexClient searchIndexClient, string searchText, Microsoft.Azure.Search.Models.SearchParameters searchParameters)
        {
