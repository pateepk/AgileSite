...
namespace CMS.SocialMarketing
{
    ...
    public class URLShortenerHelper : AbstractHelper<URLShortenerHelper>
    {
        ...
        private IURLShortener mGooGl = null;
        ...
        private IURLShortener Googl
        {
            get
            {
                if (mGooGl == null)
                {
                    mGooGl = new GooGlShortener();
                }
                return mGooGl;
            }
        }
        ...
        /// <param name="gooGl">goo.gl  shortener mock</param>
        /// <param name="tinyUrl">tinyurl shortener mock</param>
        internal URLShortenerHelper(IURLShortenerHelperEnvironment environment, IURLShortener bitLy, IURLShortener gooGl, IURLShortener tinyUrl)
        {
        ...
        public static string ShortenURLsInText(string text, URLShortenerTypeEnum shortener, SiteInfoIdentifier siteIdentifier)
        {
            ...
            {
                throw new Exception(String.Format("[URLShortenerHelper.ShortenURLsInText]: Shortener '{0}' is not available for site '{1}'.", shortener, siteIdentifier));
            }
        ...
        protected virtual bool IsURLShortenerAvailableInternal(URLShortenerTypeEnum shortener, SiteInfoIdentifier siteIdentifier)
        {
            switch (shortener)
            {
                ...
                case URLShortenerTypeEnum.Googl:
                    {
                        return Googl.IsAvailable(siteIdentifier);
                    }
        ...
        protected virtual string GetShortenedURLInternal(URLParserMatch longURLMatch, URLShortenerTypeEnum shortener, SiteInfoIdentifier siteIdentifier)
        {
            ...
            switch (shortener)
            {
                ...
                case URLShortenerTypeEnum.Googl:
                    {
                        return Googl.Shorten(url, siteIdentifier);
                    }
