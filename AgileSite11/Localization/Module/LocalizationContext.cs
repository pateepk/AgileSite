...
{
    using TrackResourceDictionary = StringSafeDictionary<string>;
    ...
    public class LocalizationContext : AbstractContext<LocalizationContext>
    {
        ...
        private TrackResourceDictionary mCurrentResources;
        ...
        /// </summary>
        public static TrackResourceDictionary CurrentResources
        {
            get
            {
                return Current.mCurrentResources;
            }
            set
            {
                Current.mCurrentResources = value;
            }
        }
        ...
        /// <summary>
        /// Tracks the given resource for the current request
        /// </summary>
        /// <param name="stringName">String name</param>
        /// <param name="result">Resolved value</param>
        internal static void TrackResource(string stringName, string result)
        {
            var list = CurrentResources;
            if (list == null)
            {
                list = new TrackResourceDictionary();
