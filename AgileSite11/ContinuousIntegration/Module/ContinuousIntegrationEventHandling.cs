...
namespace CMS.ContinuousIntegration.Internal
{
    ...
    public static class ContinuousIntegrationEventHandling
    {
        ...
        private static IEnumerable<string> GetDependencyColumns(ObjectTypeInfo typeInfo)
        {
            ...
            {
                dependencyColumns.AddRange(typeInfo.TypeCondition.ConditionColumns);
            }

            dependencyColumns.AddRange(typeInfo.ContinuousIntegrationSettings.DependencyColumns);
            dependencyColumns.AddRange(typeInfo.ContinuousIntegrationSettings.ObjectFileNameFields);
