...
{
    using TypedDataSet = InfoDataSet<ReportCategoryInfo>;
    ...
    public class ReportCategoryInfoProvider : AbstractInfoProvider<ReportCategoryInfo, ReportCategoryInfoProvider>, IRelatedObjectCountProvider
    {
        ...
        /// <summary>
        /// Returns dataset of all ReportCategories.
        /// </summary>
        /// <param name="where">Where condition</param>
        /// <param name="orderBy">Order by columns</param>
        [Obsolete("Use method GetCategories() instead")]
        public static TypedDataSet GetCategories(string where, string orderBy)
        {
            return GetCategories(where, orderBy, -1, null);
        }
        ...
        [Obsolete("Use method GetCategories() instead")]
        public static TypedDataSet GetCategories(string where, string orderBy, int topN, string columns)
        {
            return GetCategories().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).BinaryData(true).TypedResult;
        }
