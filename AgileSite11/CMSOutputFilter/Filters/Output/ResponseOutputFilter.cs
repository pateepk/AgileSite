...
namespace CMS.OutputFilter
{
    ...
    public class ResponseOutputFilter : Stream
    {
        ...
        public static bool UseOutputFilterCache
        {
            get
            {
                return OutputHelper.UseOutputFilterCache;
            }
            set
            {
                OutputHelper.UseOutputFilterCache = value;
            }
        }
        ...
        public static bool TrackCacheDependencies
        {
            get
            {
                return CacheHelper.TrackCacheDependencies;
            }
            set
            {
                CacheHelper.TrackCacheDependencies = value;
            }
        }
        ...
        public static string CacheItems
        {
            get
            {
                return OutputHelper.CacheItems;
            }
            set
            {
                OutputHelper.CacheItems = value;
            }
        }
        ...
        {
            return OutputHelper.GetOutputCacheKey(viewMode, siteName);
        }
        ...
        {
            OutputHelper.SaveOutputToCache(outputData);
        }
        ...
        {
            return OutputHelper.SendOutputFromCache(viewMode, siteName, out output);
        }
