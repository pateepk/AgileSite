...
namespace CMS.PortalEngine.Web.UI
{
    ...
    public abstract partial class CMSAbstractWebPart : AbstractUserControl, ICMSVariantsControl, ITimeZoneManager, IDataControl, ISimpleDataContainer, IExceptionHandler
    {
        ...
        /// Short client ID.
        /// </summary>
        protected string mShortClientID = null;
        ...
        /// Web part info.
        /// </summary>
        protected WebPartInfo mPartInfo = null;

        /// <summary>
        /// Title information.
        /// </summary>
        protected string mTitleInfo = null;
        ...
        /// </summary>
        protected bool mNeedsLayoutScript = false;

        /// <summary>
        /// True if the web part is in design mode.
        /// </summary>
        protected bool? mIsDesign = null;
        ...
        /// </summary>
        protected CMSWebPartZone mParentZone = null;

        /// <summary>
        /// If true, the parent zone was already searched
        /// </summary>
        protected bool mParentZoneSearched = false;
        ...
        /// </summary>
        protected List<CMSPagePlaceholder> mChildPagePlaceholders = null;

        /// <summary>
        /// Container control for the design mode header.
        /// </summary>
        protected Control mHeaderContainer = null;

        /// <summary>
        /// Header control
        /// </summary>
        protected Control mHeaderControl = null;

        /// <summary>
        /// Web part title label.
        /// </summary>
        protected Label lblWebPartTitle = null;

        /// <summary>
        /// Web part title container
        /// </summary>
        protected PlaceHolder plcTitleContainer = null;
        ...
        /// Web part title container
        /// </summary>
        protected PlaceHolder TitleContainer
        {
            get
            {
                return plcTitleContainer ?? (plcTitleContainer = new PlaceHolder());
            }
        }
        ...
        /// </summary>
        public virtual bool RenderEnvelope
        {
            get;
            set;
        }
        ...
        /// </summary>
        public CMSAbstractWebPart ParentWebPart
        {
            get;
            protected set;
        }
        ...
        /// </summary>
        public virtual List<CMSPagePlaceholder> ChildPagePlaceholders
        {
            get
            {
                return mChildPagePlaceholders ?? (mChildPagePlaceholders = PortalHelper.CollectPlaceholders(this));
            }
        }
        ...
        public virtual CMSPortalManager PortalManager
        {
            get
            {
                return (PagePlaceholder != null) ? PagePlaceholder.PortalManager : null;
            }
            set
            {
        ...
        /// Nested web parts
        /// </summary>
        public List<CMSAbstractWebPart> NestedWebParts
        {
            get;
            protected set;
        }
        ...
        public virtual bool StandAlone
        {
            get
            {
                if ((PartInstance != null) && (PartInstance.ParentZone != null) && (ParentZone != null))
                {
                    return false;
                }
        ...
        /// Control page cycle status.
        /// </summary>
        public virtual PageCycleEnum PageCycle
        {
            get
            {
                return mPageCycle;
        ...
        /// </summary>
        internal WebPartLayoutInfo CurrentLayoutInfo
        {
            get;
            set;
        }
        ...
        public virtual bool HideOnCurrentPage
        {
            get
            {
                ...
                if (DisplayToRoles.Trim().Trim(';') != "")
                {
                    ...
                    {
                        if (((role.ToLowerCSafe() != RoleName.NOTAUTHENTICATED) && currentUser.CheckPrivilegeLevel(UserPrivilegeLevelEnum.Admin)) || currentUser.IsInRole(role, CurrentSiteName))
                        {
                            show = true;
                            break;
                        }
        ...
        public bool IsLayout
        {
            get
            {
                return (WebPartType == WebPartTypeEnum.Layout) || (this is CMSAbstractLayoutWebPart);
            }
        }
        ...
        public bool HasVariants
        {
            get
            {
                return PartInstance.HasVariants;
            }
        }
        ...
        private void CreateHeader()
        {
            ...
            string parameter = String.Format("webPartLocation['{0}']", GetContainerId());
            ...
            if (webPartManagement)
            {
                ...
                if (fullDesignMode)
                {
                    ...
                    pnlHeader.Attributes.Add("onmouseover", string.Format("ActivateBorder('{0}', this);", ShortClientID));
                    pnlHeader.Attributes.Add("onmouseout", string.Format("DeactivateBorder('{0}', 50);", ShortClientID));
                    ...
                    if (ViewMode != ViewModeEnum.DesignDisabled)
                    {
                        ...
                        string onClickScript = string.Format("return {0}(this, {1})", cmFunctionName, parameter);
                ...
                {
                    bool isUserWidget = (ParentZone.WidgetZoneType == WidgetZoneTypeEnum.User);
                    bool isDashboardWidget = (ParentZone.WidgetZoneType == WidgetZoneTypeEnum.Dashboard);
                        ...
                        && (viewMode != ViewModeEnum.DashboardWidgets))
                    {
                        if ((this is CMSAbstractEditableWebPart) && ViewMode.IsEditLive())
                        {
                            ...
                            imgSelect.ID = "imgSelect";
                            imgSelect.CssClass = "WebPartActionButton icon-edit";
        ...
        public void EnsureVariants()
        {
            if (RenderVariants && !variantsLoaded && HasVariants)
            {
                ...
                if ((PartInstance != null) && (PartInstance.PartInstanceVariants != null))
                {
        ...
        private string GetLocationScript()
        {
            ...
            if (pi != null)
            {
                ...
                string script = ScriptHelper.GetScript(String.Format(
                    ...
                    GetContainerId(),
                    WebPartClipBoardManager.ContainsClipBoardItem(zoneType, pageTemplateType).ToString().ToLowerCSafe(),
        ...
        public void LoadContent(WebPartInstance partInstance, bool reloadData = true)
        {
            ...
            if (partInstance != null)
            {
                ...
                if ((lblWebPartTitle == null) || string.IsNullOrEmpty(lblWebPartTitle.Text))
                {
                    TitleInfo = id;
                }
                ...
                ExecuteForAllNested(w => w.LoadContent(w.PartInstance, reloadData));
            }
        }
        ...
        private void SetupPartialCache(WebPartInstance partInstance)
        {
            ...
            if (!CanUsePartialCache())
            {
                ...
                CacheDebug.LogCacheOperation(CacheOperation.REMOVE, "Partial cache (" + partInstance.ControlID + ")", null, null, DateTime.MinValue, Cache.NoSlidingExpiration, CacheItemPriority.NotRemovable, true);
            }
            else
            {
                ...
                if (cacheMinutes > 0)
                {
                    ...
                    {
                        cachedControl.Dependency = cacheDependencies.CacheDependency;
                    }

                    CacheDebug.LogCacheOperation(CacheOperation.ADD, "Partial cache (" + partInstance.ControlID + ")", null, cacheDependencies, DateTime.Now.AddMinutes(cacheMinutes), Cache.NoSlidingExpiration, CacheItemPriority.NotRemovable, true);
                }
            }
        }
        ...
        private string GetPostbackExpiracyCacheKey()
        {
            ...
            string webPartAliasPath = (PagePlaceholder.PageInfo != null) ? PagePlaceholder.PageInfo.NodeAliasPath : null;
        ...
        protected void ExecuteForAllNested(Action<CMSAbstractWebPart> action)
        {
            // Process data source
            if (NestedWebParts != null)
            {
                foreach (var nested in NestedWebParts)
                {
                    action(nested);
                }
            }
        ...
        public virtual void OnContentLoaded()
        {
            ...
            if ((PartInstance != null) && (PartInstance.NestedWebParts != null) && (NestedWebParts == null))
            {
                NestedWebParts = new List<CMSAbstractWebPart>();

                foreach (var nested in PartInstance.NestedWebParts.TypedValues)
                {
                    // Load the data source web part
                    var nestedWebPart = CMSWebPartZone.LoadWebPart(this, ParentZone, nested, true) as CMSAbstractWebPart;
                    if (nestedWebPart != null)
                    {
                        // Fake the data source view mode to not display its header
                        nestedWebPart.ViewMode = ViewModeEnum.Preview;
                        nestedWebPart.ParentWebPart = this;

                        NestedWebParts.Add(nestedWebPart);
                    }
                }
            }

            ExecuteForAllNested(w => w.OnContentLoaded());
        }
        ...
        public virtual void ReloadData()
        {
            ...
            ExecuteForAllNested(w => w.ReloadData());
        }
        ...
        {
            ExecuteForAllNested(w => w.ClearCache());
        }
            ...
            if (HasVariants)
            {
                ...
                foreach (CMSAbstractWebPart webpart in VariantControlsPlaceHolder.Controls)
                {
                        ...
                        && (webpart.PartInstance.VariantID == variantId))
                    {
                        ...
                        if ((wpi != null) && (wpi.PartInstanceVariants != null))
                        {
        ...
        public virtual string GetDefaultCacheDependendencies()
        {
            ...
            if (instanceGuid != Guid.Empty)
            {
                ...
                return "webpartinstance|" + instanceGuid.ToString().ToLowerCSafe();
            }
            else
            {
                return null;
        ...
        private void LogEvals()
        {
            ...
            if (mLoggedEvals != null)
            {
                ...
                if (!usedColumns.EqualsCSafe(columns, true))
                {
        ...
        private string GetNotResolvingProperties(List<string> widgetFields, params string[] fields)
        {
            ...
            foreach (string field in fields)
            {
                ...
                if (!iFields.Contains(field.ToLowerCSafe()))
                {
                    result += field + ";";
                }
            }
        ...
        public virtual string GetHorizontalResizerScript(string elementId, string widthPropertyName, bool inverted = false, string infoElementId = null, string callback = null)
        {
            ...
            sb.Append("InitHorizontalResizer(event, this, '", ShortClientID, "', '", elementId, "', '", widthPropertyName, "', ", inverted.ToString().ToLowerCSafe(), ", ", (infoElementId == null ? "null" : "'" + infoElementId + "'"), ", ", (callback ?? "null"), ");");
        ...
        public TimeZoneTypeEnum TimeZoneType
        {
            get
            {
                return ValidationHelper.GetString(GetValue("TimeZoneType"), String.Empty).ToEnum<TimeZoneTypeEnum>();
            }
        }
