...
namespace CMS.Protection
{
    ...
    public class BadWordInfoProvider : AbstractInfoProvider<BadWordInfo, BadWordInfoProvider>
    {
        ...
        [Obsolete("Use CMS.DataEngine.ObjectQuery<BadWordInfo> instead")]
        public static TypedDataSet GetBadWords(string where, string orderBy)
        {
            return ProviderObject.GetBadWordsInternal(where, orderBy, 0, null);
        }
        ...
        [Obsolete("Use CMS.DataEngine.ObjectQuery<BadWordInfo> instead")]
        public static TypedDataSet GetBadWords(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetBadWordsInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="columns">Columns to be selected</param>
        [Obsolete("Use CMS.DataEngine.ObjectQuery<BadWordInfo> instead")]
        protected virtual TypedDataSet GetBadWordsInternal(string where, string orderBy, int topN, string columns)
        {
        ...
        {
            return GetObjectQuery().WhereEquals("WordGUID", guid).FirstObject;
        }
