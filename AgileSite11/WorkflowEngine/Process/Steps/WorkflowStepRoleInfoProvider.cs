...
namespace CMS.WorkflowEngine
{
    ...
    public class WorkflowStepRoleInfoProvider : AbstractInfoProvider<WorkflowStepRoleInfo, WorkflowStepRoleInfoProvider>
    {
        ...
        [Obsolete("Use method GetWorkflowStepRoles() instead.")]
        public static TypedDataSet GetWorkflowStepRoles(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetWorkflowStepRolesInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="columns">Column names</param>
        [Obsolete("Use method GetWorkflowStepRoles() instead.")]
        protected virtual TypedDataSet GetWorkflowStepRolesInternal(string where, string orderBy, int topN, string columns)
        {
            return GetWorkflowStepRoles().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).BinaryData(true).TypedResult;
        }
