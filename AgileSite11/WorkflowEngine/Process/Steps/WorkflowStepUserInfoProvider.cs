...
namespace CMS.WorkflowEngine
{
    ...
    public class WorkflowStepUserInfoProvider : AbstractInfoProvider<WorkflowStepUserInfo, WorkflowStepUserInfoProvider>
    {
        ...
        [Obsolete("Use method GetWorkflowStepUsers() instead.")]
        public static TypedDataSet GetWorkflowStepUsers(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetWorkflowStepUsersInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="columns">Column names</param>
        [Obsolete("Use method GetWorkflowStepUsers() instead.")]
        protected virtual TypedDataSet GetWorkflowStepUsersInternal(string where, string orderBy, int topN, string columns)
        {
            return GetWorkflowStepUsers().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).BinaryData(true).TypedResult;
        }
