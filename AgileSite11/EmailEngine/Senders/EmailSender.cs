...
namespace CMS.EmailEngine
{
    ...
    public static class EmailSender
    {
        ...
        [Obsolete("Use SendEmail(string, EmailMessage, bool) method instead.")]
        public static void SendEmail(string siteName, EmailMessage message, bool sendImmediately, string setName, int setRelatedId)
        {
            SendEmail(siteName, message, sendImmediately);
        }
