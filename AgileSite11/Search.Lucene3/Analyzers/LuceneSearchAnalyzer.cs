...
namespace CMS.Search.Lucene3
{
    ...
    internal class LuceneSearchAnalyzer : ISearchAnalyzer
    {
        ...
        private const string CLEAR_ANALYZERS_TASK_TYPE = "CLEARSEARCHANALYZERS";
        ...
        #region "Analyzers table methods"
        ...
        internal static void Init()
        {
            ...
            {
                Type = CLEAR_ANALYZERS_TASK_TYPE,
                Execute = (target, data, binaryData) => ClearAnalyzersTable(),
                IsMemoryTask = true
            });
        }
        ...
        {
            ClearAnalyzersTable();
            WebFarmHelper.CreateTask(CLEAR_ANALYZERS_TASK_TYPE);
        }
