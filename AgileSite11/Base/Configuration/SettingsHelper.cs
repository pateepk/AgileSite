...
namespace CMS.Base
{
    ...
    public static class SettingsHelper
    {
        ...
        {
            VirtualDirectoryMapping vdm = new VirtualDirectoryMapping(appPath, true, "web.config");
            WebConfigurationFileMap wcfm = new WebConfigurationFileMap();

            wcfm.VirtualDirectories.Add(String.Empty, vdm);
            ...
            try
            {
                config = WebConfigurationManager.OpenMappedWebConfiguration(wcfm, String.Empty);
            }
            catch
            {
                // If the web.config could not be loaded, try to open it with ConfigurationManager
