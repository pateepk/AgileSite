...
#pragma warning disable BH4004 // String comparison methods should not be used without specifying StringComparison.
        ...
        /// <param name="strB">Object to compare</param>
        /// <param name="ignoreCase">If true, compare is case insensitive</param>
        [Obsolete("Use method String.Compare(String, String, bool) instead")]
        public static bool EqualsCSafe(this String strA, object strB, bool ignoreCase)
        {
            return CMSString.Equals(strA, strB as String, ignoreCase);
        }
        ...
        /// <param name="str">String to find</param>
        /// <param name="comparison">Comparison type</param>
        [Obsolete("Use method String.IndexOf(String, StringComparison) instead")]
        public static int IndexOfCSafe(this string value, string str, StringComparison comparison)
        {
            return value.IndexOf(str, comparison);
        }
        ...
        [Obsolete("Use method String.LastIndexOf(char, int, int) instead")]
        public static int LastIndexOfCSafe(this string value, char chr, int startIndex, int count)
        {
            return value.LastIndexOf(chr, startIndex, count);
        }
