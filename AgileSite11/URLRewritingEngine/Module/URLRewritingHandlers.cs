...
namespace CMS.URLRewritingEngine
{
    ...
    internal class URLRewritingHandlers
    {
        ...
        private static void CheckSecurity(RequestStatusEnum status, SiteNameOnDemand siteName, ViewModeOnDemand viewMode, string relativePath)
        {
            ...
            {
                // Check page security
                if ((HttpContext.Current.Session != null) && !OutputFilterContext.OutputFilterEndRequestRequired)
                {
            ...
            else if ((HttpContext.Current.Session != null) && !OutputFilterContext.OutputFilterEndRequestRequired)
            {
        ...
        private static void RefreshRoutesAfterDocumentDelete(object sender, DocumentEventArgs e)
        {
            ...
            if (node != null)
            {
                ...
                // Document is defined by a route (or MVC route)
        ...
        /// <summary>
        /// Determines whether the given URL path specifies a route (or MVC route).
        /// </summary>
        ...
        private static bool IsRoutePath(string urlPath)
        {
            ...
            {
                return urlPath.StartsWithCSafe(TreePathUtils.URL_PREFIX_MVC) || urlPath.StartsWithCSafe(TreePathUtils.URL_PREFIX_ROUTE);
            }
