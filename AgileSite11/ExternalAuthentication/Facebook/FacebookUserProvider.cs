...
namespace CMS.ExternalAuthentication.Facebook
{
    ...
    /// </summary>
    public class FacebookUserProvider : IFacebookUserProvider
    {
        ...
        {
            return GetFacebookUser(facebookUserId, null);
        }
        ...
        /// <returns>Facebook user data class</returns>
        public FacebookUserProfile GetFacebookUser(string facebookUserId, string accessToken)
        {
            return GetFacebookUser(facebookUserId, accessToken, String.Empty);
        }
