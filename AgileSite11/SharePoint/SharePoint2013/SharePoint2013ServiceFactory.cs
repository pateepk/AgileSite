...
{
    /// <summary>
    /// Provides instances of SharePoint 2013 services' implementations.
    /// </summary>
    internal class SharePoint2013ServiceFactory : ISharePointServiceFactory
    {
        /// <summary>
        /// Contains mapping of SharePoint service interfaces to SharePoint 2013 implementations.
        /// </summary>
        private static readonly Dictionary<Type, Type> serviceImplementations = new Dictionary<Type, Type>()
        {
            ...
            {typeof(ISharePointFileService), typeof(SharePoint2013FileService)}
        };
            ...
            where IService : ISharePointService
        {
            if (!serviceImplementations.ContainsKey(typeof(IService)))
                throw new SharePointServiceNotSupportedException(String.Format("[SharePoint2013ServiceFactory.GetImplementationFor]: The service of type '{0}' does not have an implementation.", typeof(IService)));
            ...
            {
                throw new SharePointConnectionNotSupportedException(String.Format("[SharePoint2013ServiceFactory.GetImplementationFor]: Available service implementation '{0}' for '{1}' does not support given connectionData. The authentication mode might not be supported.",
