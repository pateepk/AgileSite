...
namespace CMS.SharePoint
{
    ...
    /// </summary>
    internal class SharePointOnlineServiceFactory : ISharePointServiceFactory
    {
        /// <summary>
            ...
            where IService : ISharePointService
        {
            if (!serviceImplementations.ContainsKey(typeof(IService)))
                throw new SharePointServiceNotSupportedException(String.Format("[SharePointOnlineServiceFactory.GetImplementationFor]: The service of type '{0}' does not have an implementation.", typeof(IService)));
            ...
            {
                throw new SharePointConnectionNotSupportedException(String.Format("[SharePointOnlineServiceFactory.GetImplementationFor]: Available service implementation '{0}' for '{1}' does not support given connectionData. The authentication mode might not be supported.",
