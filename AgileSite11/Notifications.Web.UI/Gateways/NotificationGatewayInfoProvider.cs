...
namespace CMS.Notifications.Web.UI
{
    ...
    public class NotificationGatewayInfoProvider : AbstractInfoProvider<NotificationGatewayInfo, NotificationGatewayInfoProvider>
    {
        ...
        [Obsolete("Use method GetNotificationGateways() instead")]
        public static TypedDataSet GetGateways(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetGatewaysInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="columns">Data columns to return</param>
        [Obsolete("Use method GetNotificationGateways() instead")]
        protected TypedDataSet GetGatewaysInternal(string where, string orderBy, int topN, string columns)
        {
