...
namespace CMS.DocumentEngine.Web.UI
{
    ...
    /// </summary>
    [ToolboxData("<{0}:QueryRepeaterWithEffect runat=server></{0}:QueryRepeaterWithEffect>")]
    [ToolboxItem(typeof(WebControlToolboxItem))]
    [ParseChildren(true)]
    [PersistChildren(true)]
    public class QueryRepeaterWithEffect : QueryRepeater, INamingContainer
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!StopProcessing)
            {
                ...
                if (!string.IsNullOrEmpty(resolvedInlineCSS))
                {
                    ...
                    CssRegistration.RegisterCssBlock(Page, "queryRepeaterWithEffectInlineCss_" + ClientID, resolvedInlineCSS);
                }
            }
        ...
        protected override void Render(HtmlTextWriter output)
        {
            if (Context == null)
            {
                output.Write("[QueryRepeaterWithEffect: " + ClientID + " ]");
                return;
            }
