...
namespace CMS.DocumentEngine.Web.UI
{
    ...
    /// </summary>
    [ToolboxData("<{0}:QueryDataList runat=server></{0}:QueryDataList>")]
    [ParseChildren(true)]
    [PersistChildren(true)]
    public class QueryDataList : BasicDataList, ICMSQueryProperties
    {
        #region "Variables"
        ...
        /// <summary>
        /// Gets or sets the site name, this property has no effect in this control.
        /// </summary>
        ...
        ///<summary>Enables paging and show the DataPager control.</summary>
        ...
        protected override void Render(HtmlTextWriter output)
        {
            if (Context == null)
            {
                output.Write("[ QueryDataList : " + ClientID + " ]");
                return;
            }
            ...
            if (!StopProcessing)
            {
                if (!NoData)
                {
                    ...
                    bool isVisible = PagerControl.Visible;
