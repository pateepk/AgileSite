...
namespace CMS.DocumentEngine.Web.UI
{
    ...
    /// </summary>
    [ToolboxData("<{0}:CMSDataList runat=server></{0}:CMSDataList>")]
    [ParseChildren(true)]
    [PersistChildren(true)]
    public class CMSDataList : BasicDataList, ICMSDataProperties
    {
        #region "Variables"
        ...
        /// </summary>
        /// <param name="position">Position in controls collection</param>
        private void AddPager(int position)
        {
            if (mDataPager == null)
            {
            ...
            if (!pagerAdded)
            {
                Controls.AddAt(position, mDataPager);
                pagerAdded = true;
            }
        }
        ...
        /// </summary>
        private void CMSDataList_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            // Bind the container
        ...
        /// <summary>
        /// When Page is changed reload data.
        /// </summary>
        ...
        /// <summary>
        /// Disable default create child controls.
        /// </summary>
        protected override void CreateChildControls()
        {
            // Necessary for inserting DataPager - removing may cause errors            
        }


        /// <summary>
        /// Disable prepare control hierarchy.
        /// </summary>
        ...
        /// <summary>
        /// Render pager and datalist.
        /// </summary>
        protected override void Render(HtmlTextWriter output)
        {
            if (Context == null)
            {
                output.Write("[CMSDataList: " + ID + "]");
                return;
            }
        ...
        public static RepeatLayout GetRepeatLayout(string layout)
        {
            if (layout == null)
            {
                return RepeatLayout.Flow;
            }
            else
            {
        ...
        /// <summary>
        /// Returns the repeat direction based on the given string.
        /// </summary>
        /// <param name="direction">String direction representation</param>
        public static RepeatDirection GetRepeatDirection(string direction)
        {
            if (direction == null)
            {
        ...
        private void RegisterHandlers()
        {
            ...
            {
                ItemDataBound += CMSDataList_ItemDataBound;
