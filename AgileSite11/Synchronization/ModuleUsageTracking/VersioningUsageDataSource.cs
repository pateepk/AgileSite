...
namespace CMS.Synchronization
{
    ...
    internal class VersioningUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            result.Add("VersionedObjects", JsonConvert.SerializeObject(versioningSettingKeys.TypedResult.Select(s => s.KeyName.Substring(VERSIONING_SETTING_KEY_PREFIX.Length))));
