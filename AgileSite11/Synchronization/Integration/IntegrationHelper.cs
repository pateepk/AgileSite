...
namespace CMS.Synchronization
{
    ...
    public static class IntegrationHelper
    {
        ...
        public static List<string> TouchedConnectorNames
        {
            get
            {
                List<string> touchedConnectorNames = (List<string>)AbstractStockHelper<RequestStockHelper>.GetItem(TOUCHED_CONNECTOR_NAMES, true);
                if (touchedConnectorNames == null)
                {
                    touchedConnectorNames = new List<string>();
                    AbstractStockHelper<RequestStockHelper>.Add(TOUCHED_CONNECTOR_NAMES, touchedConnectorNames, true);
                }
                return touchedConnectorNames;
            }
            set
            {
                AbstractStockHelper<RequestStockHelper>.Add(TOUCHED_CONNECTOR_NAMES, value, true);
            }
        }
