...
namespace CMS.TranslationServices
{
    ...
    public abstract class AbstractHumanTranslationService : BaseTranslationService
    {
        ...
        private static readonly SafeDictionary<string, AbstractHumanTranslationService> mServicesTable = new SafeDictionary<string, AbstractHumanTranslationService>();
