...
namespace CMS.TranslationServices
{
    ...
    public abstract class AbstractMachineTranslationService : BaseTranslationService
    {
        ...
        private static readonly SafeDictionary<string, AbstractMachineTranslationService> mServicesTable = new SafeDictionary<string,AbstractMachineTranslationService>();
