...
#pragma warning restore BH1014 // Do not use System.IO
        ...
        private static bool mLogWarning = true;
        private static bool? mHealthMonitoringEnabled = null;
            ...
            get
            {
                if (mHealthMonitoringEnabled == null)
                {
                    ...
                    if (mLogWarning)
                    {
                        ...
                        {
                            EventLogProvider.LogEvent(EventType.WARNING, "Health monitoring", "NotEnabled", "Health monitoring was not enabled as it requires fully trusted application.");
                        }
                    }

                    // Setting is enabled and is full trust level
                    mHealthMonitoringEnabled = (SettingsKeyInfoProvider.GetBoolValue("CMSEnableHealthMonitoring") && SystemContext.IsFullTrustLevel);
                }
