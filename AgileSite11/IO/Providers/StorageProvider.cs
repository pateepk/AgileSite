...
namespace CMS.IO
{
    ...
    public class StorageProvider : AbstractStorageProvider
    {
        ...
        /// </summary>
        [Obsolete("Use CreateFileSystemStorageProvider method instead of name based initialization.")]
        public const string DEFAULT_STORAGE = FILESYSTEM_STORAGE;
        ...
        /// </summary>
        [Obsolete("Use StorageProvider.CreateFileSystemStorageProvider() instead. ")]
        public StorageProvider()
            : this("", FILESYSTEM_STORAGE)
        {
        }
        ...
        public StorageProvider(string externalStorageName, string providerAssemblyName, bool isSharedStorage = false)
        {
            ...
            ProviderAssemblyName = providerAssemblyName; // This property also set IsSharedStorage and ExternalStorageName in case of Amazon/Azure provider
        }
