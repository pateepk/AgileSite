...
namespace CMS.IO
{
    ...
    public static class Directory
    {
        ...
        public static bool Exists(string path)
        {
            ...
            {
                // Exception is not propagated (similar behavior as native implementation of Directory.Exists method)
            }
        ...
        {
            var dir = AbstractStorageProvider.DefaultProvider.DirectoryProviderObject;

            string result = dir.GetCurrentDirectory();

            LogDirectoryOperation(result, FileDebugOperation.GET_CURRENT_DIR);
