...
namespace CMS.DocumentEngine
{
    internal class DocumentQueryColumnBuilder
    {
        ...
        /// <summary>
        /// Method returns priority column for document aliases based on sections count in <see cref="DocumentAliasInfo.AliasURLPath"/>.
        /// </summary>
        public static string GetURLSectionsCountPriority()
        {
            return "LEN(AliasURLPath) - LEN(REPLACE(AliasURLPath, '/', ''))";
        }


        /// <summary>
        /// Method returns priority column for document aliases based on wildcards count in <see cref="DocumentAliasInfo.AliasWildcardRule"/>.
        /// </summary>
        public static string GetWildcardCountPriority()
        {
            return "LEN(AliasWildcardRule) - LEN(REPLACE(AliasWildcardRule, '%', ''))";
        }


        /// <summary>
        /// Method returns priority column for document based on sections count in <see cref="PageInfo.DocumentUrlPath"/>.
        /// </summary>
        public static string GetDocumentURLSectionsCountPriority()
        {
            return "LEN(DocumentURLPath) - LEN(REPLACE(DocumentURLPath, '/', ''))";
        }
    }
}
