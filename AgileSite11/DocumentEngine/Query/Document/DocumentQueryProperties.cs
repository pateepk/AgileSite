...
namespace CMS.DocumentEngine
{
    ...
    public class DocumentQueryProperties
    {
        ...
        public TreeProvider TreeProvider
        {
            get
            {
                return mTreeProvider ?? (mTreeProvider = new TreeProvider(CMSActionContext.CurrentUser));
            }
            set
            {
                mTreeProvider = value;
        ...
        public void ApplyProperties(DocumentQueryProperties p)
        {
            ...
            p.SiteIDs.AddRange(SiteIDs);
            p.Paths.AddRange(Paths);
            p.ExcludedPaths.AddRange(ExcludedPaths);
        ...
        public DocumentQueryProperties Clone()
        {
            ...
            clone.SiteIDs.AddRange(SiteIDs);
            clone.Paths.AddRange(Paths);
            clone.ExcludedPaths.AddRange(ExcludedPaths);
