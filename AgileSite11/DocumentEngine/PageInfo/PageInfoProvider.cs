...
DocumentWorkflowCycleGUID, DocumentGUID, DocumentSearchExcluded, DocumentLogVisitActivity, DocumentMenuRedirectToFirstChild";
        ...
        public static PageInfo GetPageInfo(string siteName, string aliasPath, string cultureCode, string urlPath, int nodeId, bool combineWithDefaultCulture)
        {
            ...
            if (AbstractStockHelper<RequestStockHelper>.Contains(PageInfoCacheHelper.CACHE_KEY, requestStockKey, false))
            {
                result = (PageInfo)AbstractStockHelper<RequestStockHelper>.GetItem(PageInfoCacheHelper.CACHE_KEY, requestStockKey, false);
            }
            else
            {
                ...
                AbstractStockHelper<RequestStockHelper>.AddToStorage(PageInfoCacheHelper.CACHE_KEY, requestStockKey, result, false);
            }
