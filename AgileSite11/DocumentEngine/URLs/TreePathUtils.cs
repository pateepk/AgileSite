...
namespace CMS.DocumentEngine
{
    ...
    public static class TreePathUtils
    {
        ...
        /// </summary>
        public const string URL_PREFIX_MVC = "MVC:";
...
#pragma warning restore BH2000 // Method 'WhereLike()' or 'WhereNotLike()' should not be used used.
        ...
        public static string GetUrlPathDisplayName(string urlPath)
        {
            ...
            if (prefix.StartsWith(URL_PREFIX_MVC, StringComparison.InvariantCultureIgnoreCase))
            {
                urlPath = ResHelper.GetString("URLPath.MVC") + ": " + urlPath;
            }
            else if (prefix.StartsWith(URL_PREFIX_ROUTE, StringComparison.InvariantCultureIgnoreCase))
            {
