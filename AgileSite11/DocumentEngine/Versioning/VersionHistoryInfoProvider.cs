...
namespace CMS.DocumentEngine
{
    ...
    public class VersionHistoryInfoProvider : AbstractInfoProvider<VersionHistoryInfo, VersionHistoryInfoProvider>
    {
        ...
        [Obsolete("Use GetVersionHistories() instead.")]
        public static ObjectQuery<VersionHistoryInfo> GetVersionHistories(string where, string orderBy = null, int topN = 0, string columns = null)
        {
            return GetVersionHistories().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns);
        }
