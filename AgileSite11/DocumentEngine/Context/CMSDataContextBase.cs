...
namespace CMS.DocumentEngine
{
        ...
        where ParentType : CMSDataContextBase<ParentType>
    {
        ...
        [Obsolete("This variable is used for backward compatibility reasons and will be removed.")]
        private SettingsCategoryContainer mSettings;
        ...
        /// </summary>
        [Obsolete("This property should not be used directly and will be removed from public API.")]
        public virtual SettingsCategoryContainer Settings
        {
            get
            {
                if (mSettings == null)
                {
                    mSettings = new SettingsCategoryContainer(SettingsCategoryInfoProvider.RootCategory, SiteInfoProvider.GetSiteID(SiteName), false);
                }
