...
namespace CMS.DataEngine
{
        ...
        where TInfo : AbstractInfoBase<TInfo>, new()
    {
        ...
        /// </summary>
        protected IDataClass mDataClass;
        ...
        protected virtual IDataClass DataClass
        {
            get
            {
                if ((mDataClass == null) && (mTypeInfo.ObjectClassName != ObjectTypeInfo.VALUE_UNKNOWN))
                {
        ...
        public virtual string GetSearchImageUrl(string id, string image)
        {
