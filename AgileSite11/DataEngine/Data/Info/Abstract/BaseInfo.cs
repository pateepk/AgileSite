...
namespace CMS.DataEngine
{
    ...
    public abstract partial class BaseInfo : AbstractObject, IInfo
    {
        ...
        ~BaseInfo()
        {
            ...
            if (!SystemContext.ApplicationTerminating && (mTypeInfo != null) && (mTypeInfo != InfoHelper.UNKNOWN_TYPEINFO))
            {
        ...
        protected string GetUniqueName(string name, int currentObjectId, string columnName, string suffixFormat, string suffixFormatRegex, bool ensureLength)
        {
            ...
            {
                name = ResHelper.LocalizeString(name);
                wasLocalizable = true;
            }
            ...
            if (collisions.Any())
            {
                var names = collisions.ToHashSet(StringComparer.InvariantCultureIgnoreCase);
        ...
        {
            return new List<string>(GetCacheDependencies());
        }
        ...
        {
            return InfoCloneHelper.InsertAsClone(this, settings, result, true);
        }
