...
namespace CMS.DataEngine.Serialization
{
    ...
    internal class InfoSerializer
    {
        ...
        private bool mAllowStructuredColumns = true;
        ...
        /// <summary>
        /// If true, structured columns are processed through their strongly typed wrappers. Otherwise they are processed as regular string columns.
        /// </summary>
        public bool AllowStructuredColumns
        {
            get
            {
                return mAllowStructuredColumns;
            }
            set
            {
                mAllowStructuredColumns = value;
            }
        }
        ...
        private void WriteValue(ObjectTypeInfo typeInfo, XmlDocument document, XmlElement fieldElement, string fieldName, object value, SerializationSettings settings)
        {
            ...
            var structuredField = AllowStructuredColumns ? settings.GetStructuredField(fieldName) : null;
