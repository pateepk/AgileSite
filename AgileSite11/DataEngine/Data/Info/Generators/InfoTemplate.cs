...
namespace CMS.DataEngine.Generators
{
 ...
 if (GeneratePartialClass) { 
            ...
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(LastModifiedColumn));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GuidColumn));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(CodeNameColumn));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(DisplayNameColumn));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(BinaryColumn));
            this.Write(", ");
 ...
 if (property.AllowEmpty && !String.IsNullOrEmpty(property.TypeDefaultValue)) { 
        ...
        protected ");
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(InfoClassName));
            this.Write("()\r\n            : base(TYPEINFO)\r\n        {\r\n        }\r\n\r\n\r\n        /// <summary>" +
                    "\r\n        /// Creates a new instances of the <see cref=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(InfoClassName));
