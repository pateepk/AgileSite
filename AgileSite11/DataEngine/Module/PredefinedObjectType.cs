...
namespace CMS.DataEngine
{
    ...
    public static class PredefinedObjectType
    {
        ...
        /// </summary>
        public const string FRIEND = "community.friend";
        ...
        #region "MessagingObjectType"

        /// <summary>
        /// Code name for contact list.
        /// </summary>
        public const string CONTACTLIST = "messaging.contactlist";


        /// <summary>
        /// Code name for ignore list.
        /// </summary>
        public const string IGNORELIST = "messaging.ignorelist";
