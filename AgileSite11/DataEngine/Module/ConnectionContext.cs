...
namespace CMS.DataEngine
{
    ...
    public class ConnectionContext : AbstractContext<ConnectionContext>, INotCopyThreadItem
    {
        ...
        private CMSTransactionScope mCurrentTransactionScope;
        ...
        /// </summary>
        [Obsolete("Use member CMS.DataEngine.ConnectionContext.CurrentScopeConnection.Transaction instead")]
        public static CMSTransactionScope CurrentTransactionScope
        {
            get
            {
                return Current.mCurrentTransactionScope;
            }
            set
            {
                Current.mCurrentTransactionScope = value;
            }
        }
