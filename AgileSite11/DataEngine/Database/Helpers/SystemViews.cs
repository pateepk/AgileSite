...
namespace CMS.DataEngine
{
    ...
    internal class SystemViews
    {
        ...
        private SystemViews()
        {
            ...
            AddViewTables("View_Community_Friend_Friends", "community_friend", "cms_user", "cms_usersettings");
            AddViewTables("View_Community_Friend_RequestedFriends", "community_friend", "cms_user", "cms_usersettings");

            AddViewTables("View_OM_Contact_Joined", "om_contact");
            AddViewTables("View_OM_ContactGroupMember_ContactJoined", "om_contact");
