...
namespace CMS.DataEngine
{
    ...
    /// </summary>
    [Obsolete("This class should not be used directly and will be removed from public API.")]
    public class SettingsCategoryContainer : IDataContainer, IMacroSecurityCheckPermissions
    {
        #region "Variables"
