...
namespace CMS.DataEngine
{
        ...
        where TObject : BaseInfo
    {
        ...
        private bool mUseObjectQuery = true;
        ...
        protected bool UseObjectQuery
        {
            get
            {
                return mUseObjectQuery;
            }
            set
            {
                mUseObjectQuery = value;
            }
        }
        ...
        protected BaseInfo Object
        {
            ...
            set
            {
                ...
                mObjectType = (value != null) ? value.TypeInfo.ObjectType : null;
                mTypeInfo = (value != null) ? value.TypeInfo : null;
        ...
        public TQuery WithObjectType(string objectType)
        {
            ...
            {
                throw new NotSupportedException(String.Format("New object type for the query must have the same class name as the original object type. Requested object type was {0} with class name {1}. Original object type was {2} with class name {3}.", newTypeInfo.ObjectType, newTypeInfo.ObjectClassName, typeInfo.ObjectType, typeInfo.ObjectClassName));
            }
        ...
        public static implicit operator TObject(ObjectQueryBase<TQuery, TObject> query)
        {
            if (query == null)
            {
                return null;
