    ...
    public class DataClassInfo : DataClassInfoBase<DataClassInfo>
    {
        ...
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(DataClassInfoProvider), OBJECT_TYPE, "CMS.Class", "ClassID", "ClassLastModified", "ClassGUID", "ClassName", "ClassDisplayName", null, null, null, null)
        {
            ...
            DefaultData = new DefaultDataSettings
            {
                ...
                Where = "((ClassName LIKE 'cms.%' OR ClassName LIKE 'messaging.%' OR ClassName LIKE 'newsletter.%' OR ClassName LIKE 'forums.%' OR ClassName LIKE 'ecommerce.%' OR ClassName LIKE 'staging.%' OR ClassName LIKE 'polls.%' OR ClassName LIKE 'reporting.%' OR ClassName LIKE 'analytics.%' OR ClassName LIKE 'blog.%' OR ClassName LIKE 'export.%' OR ClassName LIKE 'board.%' OR ClassName LIKE 'badwords.%' OR ClassName LIKE 'notification.%' OR ClassName LIKE 'community.%' OR ClassName LIKE 'media.%' OR ClassName LIKE 'om.%' OR ClassName LIKE 'temp.file' OR ClassName LIKE 'pm.%' OR ClassName LIKE 'integration.%' OR ClassName LIKE 'chat.%' OR ClassName LIKE 'sm.%' OR ClassName LIKE 'sharepoint.%' OR ClassName LIKE 'personas.%' OR ClassName LIKE 'ci.%') AND ClassIsDocumentType=0) OR ((ClassName = 'cms.root' OR ClassName='cms.file' OR ClassName='chat.transformations') AND ClassIsDocumentType=1)",
