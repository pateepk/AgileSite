...
namespace CMS.DataEngine
{
    ...
    public class QueryInfo : AbstractInfo<QueryInfo>
    {
        ...
        /// Type information.
        /// </summary>
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(QueryInfoProvider), OBJECT_TYPE, "CMS.Query", "QueryID", "QueryLastModified", "QueryGUID", "QueryName", "QueryName", null, null, "ClassID", DataClassInfo.OBJECT_TYPE)
        {
            LogEvents = true,
