...
namespace CMS.DataEngine
{
    ...
    public static class ModuleCommands
    {
        ...
        public static DataSet CommunityGetUserFriendshipRelations(int userId, string orderBy, int topN, string columns)
        {
            return (DataSet)ProcessModuleCommand(ModuleName.COMMUNITY, "GetUserFriendshipRelations", new object[] { userId, orderBy, topN, columns });
        }
        ...
        /// <returns></returns>
        public static bool CommunityFriendshipExists(int friendUserId, int requestedId)
        {
            return (bool)ProcessModuleCommand(ModuleName.COMMUNITY, "FriendshipExists", new object[] { friendUserId, requestedId });
        }
        ...
        public static void MessagingAddToContactList(int ownerId, int contactId)
        {
            ProcessModuleCommand(ModuleName.MESSAGING, "AddToContactList", new object[] { ownerId, contactId });
        }
        ...
        public static void MessagingAddToIgnoreList(int ownerId, int contactId)
        {
            ProcessModuleCommand(ModuleName.MESSAGING, "AddToIgnoreList", new object[] { ownerId, contactId });
        }
        ...
        public static bool MessagingIsInContactList(int ownerId, int contactId)
        {
            object inContactListObj = ProcessModuleCommand(ModuleName.MESSAGING, "IsInContactList", new object[] { ownerId, contactId });
            if (inContactListObj != null)
            {
                return (bool)inContactListObj;
            }
            return false;
        }
        ...
        public static bool MessagingIsInIgnoreList(int ownerId, int contactId)
        {
            object inIgnoreList = ProcessModuleCommand(ModuleName.MESSAGING, "IsInIgnoreList", new object[] { ownerId, contactId });
            if (inIgnoreList != null)
            {
                return (bool)inIgnoreList;
            }
            return false;
        }
        ...
        /// </summary>
        /// <param name="userInfo">User info</param>
        public static void OnlineMarketingLogLogin(object userInfo)
        {
            ProcessModuleCommand(ModuleName.ONLINEMARKETING, "logwinauthlogin", new object[] { userInfo });
        }
