...
namespace CMS.Membership
{
    ...
    public class MembershipContext : AbstractContext<MembershipContext>
    {
        ...
        /// </summary>
        private const int SHIFTED_INTERVAL_IN_MINUTES = 6;
        ...
        /// </summary>
        internal static string OriginalUserName
        {
            get
            {
        ...
        public static bool AllowOnlyRead
        {
            get
            {
                ...
                if (c.mAllowOnlyRead == null)
                {
                    ...
                    c.mAllowOnlyRead = VirtualContext.IsPreviewLinkInitialized;
                }
        ...
        {
            // Create timestamp
            long timestamp = time.AddMinutes(SHIFTED_INTERVAL_IN_MINUTES).Ticks;
