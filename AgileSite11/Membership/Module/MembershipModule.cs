...
namespace CMS.Membership
{
    ...
    public class MembershipModule : Module
    {
        ...
        protected override void RegisterCommands()
        {
            ...
            RegisterCommand("GetOriginalUserName", GetOriginalUserName);
        }


        private static object GetOriginalUserName(object[] parameters)
        {
            return MembershipContext.OriginalUserName;
        }
