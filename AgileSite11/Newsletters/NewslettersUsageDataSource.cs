...
namespace CMS.Newsletters
{
    ...
    internal class NewslettersUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("IssuesInNewslettersCount", JsonConvert.SerializeObject(GetIssuesInNewslettersCount(newsletters, EmailCommunicationTypeEnum.Newsletter)));
            usageData.Add("IssuesInEmailCampaignCount", JsonConvert.SerializeObject(GetIssuesInNewslettersCount(newsletters, EmailCommunicationTypeEnum.EmailCampaign)));
            usageData.Add("SubscribersInNewslettersCount", JsonConvert.SerializeObject(GetSubscribersInNewslettersCount()));
            ...
            usageData.Add("AdditionalTemplatesPerEmailFeedCount", JsonConvert.SerializeObject(GetAdditionalTemplatesInNewslettersCount()));
            ...
            usageData.Add("NewslettersSettingsUsageOnSites", JsonConvert.SerializeObject(GetSettingsUsage(global: false)));
            usageData.Add("NewslettersSettingsUsageGlobal", JsonConvert.SerializeObject(GetSettingsUsage(global: true).Select(s => new { s.KeyName, s.KeyValue })));
