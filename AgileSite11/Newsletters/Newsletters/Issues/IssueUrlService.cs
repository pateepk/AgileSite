...
[assembly: RegisterImplementation(typeof(IIssueUrlService), typeof(IssueUrlService), Priority = CMS.Core.RegistrationPriority.SystemDefault)]
...
namespace CMS.Newsletters
{
    ...
    internal class IssueUrlService : IIssueUrlService
    {
        ...
        public string CreateActivationUrl(NewsletterInfo newsletter, SubscriberInfo subscriber, SubscriberNewsletterInfo subscription)
        {
            ...
            return $"{baseUrl}?subscriptionhash={hash}&datetime={DateTimeUrlFormatter.Format(hashTime)}";
        }
