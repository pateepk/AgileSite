    ...
    internal sealed class AttachmentsMessageModifier : IEmailMessageModifier
    {
        ...
        private IEnumerable<MetaFileInfo> GetMetafiles()
        {
            ...
            if (!DataHelper.DataSourceIsEmpty(ds))
            {
                ...
                CacheHelper.Add(GetCacheKey(), metafiles, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(1), System.Web.Caching.CacheItemPriority.Normal);
            }
