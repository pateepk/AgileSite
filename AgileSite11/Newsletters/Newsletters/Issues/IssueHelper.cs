...
namespace CMS.Newsletters
{
    ...
    public class IssueHelper : AbstractHelper<IssueHelper>
    {
        ...
        public static string GetBreadcrumbsData(IssueInfo issue, NewsletterInfo newsletter = null)
        {
            ...
            return new JavaScriptSerializer().Serialize(new { data = breadcrumbsList });
        }
        ...
        public static List<IssueABVariantItem> GetIssueVariants(IssueInfo issue, string additionalWhereCondition)
        {
            ...
            if (issue != null)
            {
                if (issue.IssueIsABTest)
                {
                    ...
                    string whereCond = "IssueVariantOfIssueID=" + issueId;
                    if (!String.IsNullOrEmpty(additionalWhereCondition))
                    {
                        whereCond = SqlHelper.AddWhereCondition(whereCond, additionalWhereCondition);
                    }
                    ...
                    var issues = IssueInfoProvider.GetIssues().Where(whereCond).Columns("IssueID", "IssueVariantName", "IssueStatus", "IssueVariantOfIssueID", "IssueIsABTest");
                    if (issues.Any())
                    {
