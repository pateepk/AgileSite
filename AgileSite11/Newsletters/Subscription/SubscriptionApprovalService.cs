...
namespace CMS.Newsletters
{
    ...
    internal class SubscriptionApprovalService : ISubscriptionApprovalService
    {
        ...
        public SubscriptionApprovalService(IUnsubscriptionProvider unsubscriptionProvider, ISubscriptionHashValidator subscriptionHashValidator, ISubscriberEmailRetriever subscriberEmailRetriever, IConfirmationSender confirmationSender)
        {
        ...
        private void TryToLogSubscribingActivity(NewsletterInfo newsletter, SubscriberInfo subscriber, string email)
        {
            ...
            if (contactId > 0)
            {
                new NewslettersActivityLogger().LogNewsletterSubscribingActivity(newsletter, subscriber.SubscriberID, contactId);
            }
        }
