...
namespace CMS.Modules
{
    ...
    public class PermissionNameInfoProvider : AbstractInfoProvider<PermissionNameInfo, PermissionNameInfoProvider>
    {
        ...
        [Obsolete("Use method GetPermissionNames() instead.")]
        public static TypedDataSet GetPermissionNames(string where, string orderBy, int topN, string columns)
        {
            // Get the data
            return ProviderObject.GetPermissionNamesInternal(where, orderBy, topN, columns);
        }
        ...
        [Obsolete("Use method GetPermissionNames() instead.")]
        protected virtual TypedDataSet GetPermissionNamesInternal(string where, string orderBy, int topN, string columns)
        {
            // Get the data
            return GetPermissionNames().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).BinaryData(true).TypedResult;
        }
