...
{
    using TypedDataSet = InfoDataSet<ResourceSiteInfo>;
    ...
    public class ResourceSiteInfoProvider : AbstractInfoProvider<ResourceSiteInfo, ResourceSiteInfoProvider>
    {
        ...
        [Obsolete("Use method GetResourceSites() instead")]
        public static TypedDataSet GetResourceSites(string where, string orderBy)
        {
            return GetResourceSites(where, orderBy, -1, null);
        }
        ...
        [Obsolete("Use method GetResourceSites() instead")]
        public static TypedDataSet GetResourceSites(string where, string orderBy, int topN, string columns)
        {
            return GetResourceSites().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).TypedResult;
        }
