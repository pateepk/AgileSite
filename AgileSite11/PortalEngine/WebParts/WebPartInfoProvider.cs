...
namespace CMS.PortalEngine
{
    ...
    public class WebPartInfoProvider : AbstractInfoProvider<WebPartInfo, WebPartInfoProvider>
    {
        ...
        [Obsolete("Use GetWebParts() with custom where condition instead.")]
        public static WebPartInfo GetWebPartInfoByGUID(Guid guid)
        {
        ...
        [Obsolete("Use GetWebParts() with custom where condition instead.")]
        public static InfoDataSet<WebPartInfo> GetAllWebParts(int webPartCategoryId)
        {
            return GetWebParts()
                .WhereEquals("WebPartCategoryID", webPartCategoryId)
                .TypedResult;
        }
        ...
        [Obsolete("Use GetWebParts() with custom where condition instead.")]
        public static InfoDataSet<WebPartInfo> GetChildWebParts(int webPartId)
        {
            return ProviderObject.GetChildWebPartsInternal(webPartId);
        }
        ...
        [Obsolete("Use GetBaseWebPart(WebPartInfo) instead.")]
        public static WebPartInfo GetBaseWebPart(string webPartName)
        {
            WebPartInfo wpi = GetWebPartInfo(webPartName);
            return GetBaseWebPart(wpi);
        }
        ...
        [Obsolete("Use GetWebPartUrl(WebPartInfo, bool) instead.")]
        public static string GetWebPartUrl(string codeName, bool resolveUrl = true)
        {
            WebPartInfo part = GetWebPartInfo(codeName);
            return GetWebPartUrl(part, resolveUrl);
        }
        ...
        /// <param name="webPartId">Web part ID</param>
        [Obsolete("Use GetWebParts() with custom where condition instead.")]
        protected virtual InfoDataSet<WebPartInfo> GetChildWebPartsInternal(int webPartId)
        {
            return GetWebParts()
                    .WhereEquals("WebPartParentID", webPartId)
                    .TypedResult;
        }
