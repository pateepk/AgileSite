...
namespace CMS.PortalEngine.ModuleUsageTracking
{
    ...
    internal class PortalEngineUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            // Get count of MVC templates
            result.Add("MvcTemplatesCount", PageTemplateInfoProvider.GetTemplates()
                    .Column("PageTemplateType")
                    .WhereEquals("PageTemplateType", PageTemplateTypeEnum.MVC.ToStringRepresentation())
                    .Count);
