...
namespace CMS.PortalEngine
{
    ...
    public class PageTemplateInfo : AbstractInfo<PageTemplateInfo>, IThemeInfo
    {
        ...
        /// </summary>
        [RegisterProperty]
        public bool IsThemeFolderExternal
        {
            get
            {
        ...
        /// </summary>
        [DatabaseField]
        public string PageTemplateDefaultController
        {
            get
            {
                return GetStringValue("PageTemplateDefaultController", null);
            }
            set
            {
                SetValue("PageTemplateDefaultController", value);
            }
        }
        ...
        /// </summary>
        [DatabaseField]
        public string PageTemplateDefaultAction
        {
            get
            {
                return GetStringValue("PageTemplateDefaultAction", null);
            }
            set
            {
                SetValue("PageTemplateDefaultAction", value);
            }
        }
