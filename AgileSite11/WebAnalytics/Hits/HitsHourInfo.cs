...
[assembly: RegisterObjectType(typeof(HitsHourInfo), HitsHourInfo.OBJECT_TYPE)]
...
namespace CMS.WebAnalytics
{
    ...
    /// </summary>
    public class HitsHourInfo : AbstractInfo<HitsHourInfo>
    {
        ...
        /// Object type
        /// </summary>
        public const string OBJECT_TYPE = "analytics.hitshour";


        /// <summary>
        /// Type information.
        /// </summary>
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(HitsHourInfoProvider), OBJECT_TYPE, "Analytics.HitsHour", "HitsID", null, null, null, null, null, null, null, null)
        {
        ...
        {
            HitsHourInfoProvider.DeleteHitsHourInfo(this);
        }
        ...
        {
            HitsHourInfoProvider.SetHitsHourInfo(this);
        }
        ...
        public HitsHourInfo(DataRow dr)
            : base(TYPEINFO, dr)
        {
        }
