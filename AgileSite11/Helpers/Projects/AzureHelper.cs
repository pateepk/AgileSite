...
namespace CMS.Base
{
    ...
    public class AzureHelper
    {
        ...
        /// <summary>
        /// Event which is thrown when Azure application should be restarted.
        /// </summary>
        public static event EventHandler OnRestartRequired;
        ...
        /// </summary>
        public static void RestartAzureInstance()
        {
            if (OnRestartRequired != null)
            {
                OnRestartRequired(null, null);
            }
        }
