...
namespace CMS.Helpers
{
    ...
    public class DateTimeHelper : CoreMethods
    {
        ...
        /// </summary>
        [Obsolete("Use CMS.Helpers.CultureHelper.EnglishCulture instead. Will be removed in the next version.")]
        public static IFormatProvider DefaultIFormatProvider => CultureHelper.EnglishCulture;
