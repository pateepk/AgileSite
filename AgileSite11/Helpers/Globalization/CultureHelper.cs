...
namespace CMS.Helpers
{
    ...
    public class CultureHelper : AbstractHelper<CultureHelper>
    {
        ...
        /// <param name="useUserOverride">If true, the user selected culture is used</param>
        public static CultureInfo GetCultureInfo(string cultureCode, bool useUserOverride = false)
        {
            ...
            try
            {
                return useUserOverride ? new CultureInfo(cultureCode, true) : CultureInfo.GetCultureInfo(cultureCode);
            }
        ...
        public static string GetPreferredCulture()
        {
            ...
            string virtualCulture = (string)VirtualContext.GetItem("Culture");
