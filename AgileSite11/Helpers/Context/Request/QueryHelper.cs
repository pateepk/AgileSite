...
namespace CMS.Helpers
{
    ...
    public class QueryHelper : IDataContainer
    {
        ...
        /// Route data
        /// </summary>
        protected static RouteValueDictionary RouteValues
        {
            get
            {
        ...
        {
            return GetHash(input, input.StartsWithCSafe("?"));
        }
        ...
        public List<string> ColumnNames
        {
            get
            {
                return new List<string>(CMSHttpContext.Current.Request.QueryString.AllKeys);
            }
        }
        ...
        private static string GetQueryStringValue(string columnName)
        {
            ...
            return (query != null) ? query[columnName] : null;
        }
        ...
        private static string GetRouteValue(string columnName)
        {
            ...
            return (routes != null) ? ValidationHelper.GetString(routes[columnName], null) : null;
        }
