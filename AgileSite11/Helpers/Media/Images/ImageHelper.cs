...
namespace CMS.Helpers
{
    ...
    public class ImageHelper
    {
        ...
        /// </summary>
        /// <param name="postedFile">Posted file data</param>
        ...
        public static byte[] GetResizedImageData(HttpPostedFile postedFile, int width, int height, int maxSideSize)
        {
            ...
            if (postedFile != null)
            {
                ...
                byte[] fileBinary = new byte[size];
                postedFile.InputStream.Read(fileBinary, 0, size);
                return GetResizedImageData(fileBinary, Path.GetExtension(postedFile.FileName), width, height, maxSideSize);
            }
