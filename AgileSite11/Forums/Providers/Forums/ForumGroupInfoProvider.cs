...
namespace CMS.Forums
{
    ...
    public class ForumGroupInfoProvider : AbstractInfoProvider<ForumGroupInfo, ForumGroupInfoProvider>
    {
        ...
        [Obsolete("Use method GetForumGroups() instead")]
        public static InfoDataSet<ForumGroupInfo> GetGroups(string where, string orderBy)
        {
            return GetGroups(where, orderBy, -1, null);
        }
        ...
        [Obsolete("Use method GetForumGroups() instead")]
        public static InfoDataSet<ForumGroupInfo> GetGroups(string where, string orderBy, int topN, string columns)
        {
            return ProviderObject.GetGroupsInternal(where, orderBy, topN, columns);
        }
        ...
        /// <param name="columns">Columns</param>
        [Obsolete("Use method GetForumGroups() instead")]
        protected InfoDataSet<ForumGroupInfo> GetGroupsInternal(string where, string orderBy, int topN, string columns)
        {
            return GetForumGroups().Where(where).OrderBy(orderBy).TopN(topN).Columns(columns).BinaryData(true).TypedResult;
        }
