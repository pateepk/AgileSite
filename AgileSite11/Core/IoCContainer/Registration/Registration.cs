...
namespace CMS.Core
{
    ...
    {
        private readonly RegistrationCore<object> registration = new RegistrationCore<object>();
        ...
        public Registration(Type service)
        {
            ...
            registration.componentRegistrationBuilder = () => Component.For(service);
        }
        ...
        public Registration ImplementedBy(Type implementation)
        {
            ...
            registration.componentRegistrationBuilder = () => baseComponentRegistrationBuilder().ImplementedBy(implementation);
