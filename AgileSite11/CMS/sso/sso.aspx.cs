...
public partial class sso : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CompanyID = GetSafeInt(Request.QueryString["CompanyID"], 0);
        // double check company
        CheckCompanyFromDB();

        FullName = GetSafeString(Request.QueryString["name"]);
        EmailAddress = GetSafeString(Request.QueryString["email"]);
