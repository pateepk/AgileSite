<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sso_strategic_comp_test.aspx.cs" Inherits="sso_strategic_comp_test" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SSO: Strategic Comp - SAML Test Page</title>
</head>
<body>
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <asp:Button ID="btnSubmitLogin" runat="server" Enabled="false" PostBackUrl="~/sso/sso_strategic_comp.aspx" Text="SUBMIT" OnClick="btnSubmitLogin_Click" />
                    </td>
                </tr>
            </table>
            <br />
            Post URL is: http://learn.streamery.co/sso/sso_strategic_comp.aspx
            <br />
