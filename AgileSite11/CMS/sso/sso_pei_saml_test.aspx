<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sso_pei_saml_test.aspx.cs" Inherits="sso_pei_saml_test" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SSO: Preferred Employers Insurance - SAML Test Page</title>
</head>
<body>
        ...
        <div>
            <table>
                ...
                <tr>
                    <td>CompanyID</td>
                    <td width="100%">
                        <asp:TextBox ID="txtCompanyID" runat="server" value="5211"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="SAMLRespEncoded" runat="server" Rows="5" TextMode="MultiLine" Height="251px" Width="600px" Enabled="false"></asp:TextBox>
                        <br />
                        <br />
                        <strong>SAML (ENCODED)</strong>:<br />
                        <asp:TextBox ID="SAMLRespDecoded" runat="server" Rows="5" TextMode="MultiLine" Height="251px" Width="600px" Enabled="false"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <asp:Button ID="btnSubmitLogin" runat="server" Enabled="false" PostBackUrl="~/sso/sso_pei_saml.aspx" Text="SUBMIT" OnClick="btnSubmitLogin_Click" />
                    </td>
                </tr>
            </table>
            <br />
            Post URL is:
            <asp:Literal ID="litPostbackUrl" runat="server"></asp:Literal>
            <br />
            ...
            <table>
                ...
                <tr>
                    <td>Preferred Employers Insurance</td>
                    <td>5211</td>
                </tr>
            </table>
            <br />
