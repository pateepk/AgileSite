<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sso_quality_refrig_services_test.aspx.cs" Inherits="sso_quality_refrig_services_test" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SSO: Quality Refrigerated Services - SAML Test Page</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <table>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <asp:Button ID="btnSubmitLogin" runat="server" Enabled="false" PostBackUrl="~/sso/sso_quality_refrig_services.aspx" Text="SUBMIT" OnClick="btnSubmitLogin_Click" />
                    </td>
                </tr>
            </table>
            <br />
            ...
            <table>
                ...
                <tr>
                    <td>Quality Refrigerated Services</td>
                    <td>5200</td>
                </tr>
            </table>
            <br />
