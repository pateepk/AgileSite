...
public partial class sso_strategic_comp_test : System.Web.UI.Page
{
    ...
    public X509Certificate2 GetX509Certificate2()
    {
        ...
        string path2 = "D:\\Perforce\\AS_DEV_V11\\AgileSite\\Kentico11_Source\\CMS\\sso\\Certs\\trainingnetwork.pfx";
        cert = new X509Certificate2(path2, _pfxPassword, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.Exportable);
    ...
    protected void btnSubmitLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("https://learn.streamery.co/sso/sso_strategic_comp.aspx?m=test", false);
        }
    }
}