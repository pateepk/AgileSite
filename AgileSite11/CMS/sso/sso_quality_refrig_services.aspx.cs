...
public partial class sso_quality_refrig_services : System.Web.UI.Page
{
    #region constant
    ...
    private string _testUrl = "~/sso/sso_quality_refrig_services_test.aspx";
    ...
    private const string TestPageURL = "https://www.trainingnetwork.com/sso_quality_refrig_services_test.aspx";
    ...
    private int[] allowed_companyID = new int[] { 1, 543, 5200, 3023 };
    private int DefaultCompanyID = 5200;
    ...
    protected bool ProcessRequest(out string p_errorMessage)
    {
        ...
        {
            // catch and ignore it.
            KenticoLogEvent(tae, "Quality Refrigerated SSO: Redirected before requests is completely processed");
        }
        catch (Exception ex)
        {
            canprocess = false;
