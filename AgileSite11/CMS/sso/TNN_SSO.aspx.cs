...
/// <summary>
/// Handles SSO (ADFS/O365)
/// </summary>
public partial class TNN_SSO : System.Web.UI.Page
{
    #region Global Vars
    ...
    private int DefaultCompanyID = 5051; //5051
    ...
    public bool CheckAndLogCert(XmlDocument samlXMLDoc, out string message)
    {
        ...
        try
        {
            if (GetCompanyX509Certificatte(CompanyID) == true) // Fetch x509 company data and if sso is allowed
            {
    ...
    /// </summary>
    /// <returns></returns>
    protected bool GetCompanyX509Certificatte(int CompanyID)
    {
