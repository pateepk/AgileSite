...
/// <summary>
/// Basic SSO with encryption
/// </summary>
public partial class sso_pei_encrypt : System.Web.UI.Page
{
    ...
    //private string SharedKey = "XJK531LHQE819KDQ"; // for testing it is should be same shared key. take a look at sso_encrypt_test.aspx.cs
    private string SharedKey = "KbNcBur2aYeIj4Ku"; // shared key for PEI
    private string SSOErrorURL = "/system/SSOError?SSOLogID=";
    private string SSOOkURL = "/home.aspx";
    private string hash = "";
    ...
    protected bool ProcessRequest(out string p_errorMessage)
    {
        ...
        {
            // catch and ignore it.
            KenticoLogEvent(tae, "ENCRYPTED SSO: Redirected before requests is completely processed");
        }
        catch (Exception ex)
        {
            canprocess = false;
    ...
    /// <summary>
    /// Verify that required field exists
    /// </summary>
