<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sso_pei_encrypt_test.aspx.cs" Inherits="sso_pei_encrypt_test" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SSO: Preferred Employers Insurance - Encrypt Test Page</title>
    <style type="text/css">
        .auto-style1 {
            width: 646px;
        } 
        ...
        <div>
            <fieldset>
                ...
                <table style="height: 271px;">
                    ...
                    <tr>
                        <td>Hash (CompanyID + Email + SharedKey)
                        </td>
                        <td width="100%">
                            <asp:Literal ID="LiteralHash" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
