...
public partial class CMSWebParts_Ecommerce_Checkout_Forms_CustomerAddress : CMSCheckoutWebPart
{
    ...
    protected override void LoadStep(object sender, StepEventArgs e)
    {
        ...
        if (PropagateChangesOnPostback && (AddressType == SHIPPING) && (!chkShowAddress.Checked) && CurrentCartAddress != null)
        {
    ...
    private void SetupSelectedAddress(IAddress selectedAddress, bool forceReload = false)
    {
        var addressToSetup = selectedAddress as AddressInfo;
