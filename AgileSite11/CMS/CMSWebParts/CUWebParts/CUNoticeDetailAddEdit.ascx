<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUNoticeDetailAddEdit.ascx.cs" Inherits="CMSApp.CMSWebParts.CUWebParts.CUNoticeDetailAddEdit" %>
    ...
    <tbody>
        <tr>
            ...
            <td class="EditingFormValueCell">
                <asp:TextBox ID="txtParentID" runat="server" TextMode="SingleLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="EditingFormLabelCell">
        ...
        <tr>
            ...
            <td class="EditingFormValueCell">
                <asp:TextBox ID="txtTableKey" runat="server" TextMode="SingleLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="EditingFormLabelCell">
            ...
            <td class="EditingFormValueCell">
                <asp:TextBox ID="txtForeignKeyTableName" runat="server" TextMode="SingleLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="EditingFormLabelCell">
            ...
            <td class="EditingFormValueCell">
                <asp:TextBox ID="txtForeignKeyTableKey" runat="server" TextMode="SingleLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="EditingFormLabelCell">
