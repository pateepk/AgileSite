...
{
    public partial class CUSQLDataSource : CMSAbstractWebPart
    {
        ...
        public bool ShowSQL
        {
            get
            {
                return ValidationHelper.GetBoolean(GetValue("ShowSQL"), false);
            }
            set
            {
                SetValue("ShowSQL", value);
                srcSQL.ShowSQL = value;
            }
        }
        ...
        public string WhereCondition
        {
            ...
            set
            {
                ...
                srcSQL.WhereCondition = value;
            }
        }

        /// <summary>
        /// Gets or sets Group By condition.
        /// </summary>
        public string GroupBy
        {
            get
            {
                return ValidationHelper.GetString(GetValue("GroupBy"), "");
            }
            set
            {
                SetValue("GroupBy", value);
                srcSQL.GroupBy = value;
            }
        }
        ...
        protected void SetupControl()
        {
            ...
            else
            {
                ...
                srcSQL.LoadPagesIndividually = false;

                srcSQL.SourceFilterName = FilterName;

                srcSQL.WhereCondition = WhereCondition;
                srcSQL.GroupBy = GroupBy;
                srcSQL.OrderBy = OrderBy;
