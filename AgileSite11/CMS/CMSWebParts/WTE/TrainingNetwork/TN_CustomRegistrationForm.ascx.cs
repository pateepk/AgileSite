...
{
    public partial class TN_CustomRegistrationForm : CMSAbstractWebPart
    {
        ...
        private void formUser_OnAfterSave(object sender, EventArgs e)
        {
            ...
            string pw = (string)ui.GetValue("UserPassword");
        ...
        /// </summary>
        private void SendRegistrationEmail(UserInfo ui, string p_clearPassword = null)
        {
            bool error = false;
