...
namespace CMSApp.CMSWebParts.WTE.TrainingNetwork
{
    ...
    public partial class TN_CatalogManage : CMSAbstractWebPart
    {
        ...
        public string SessionMessage
        {
            get
            {
                string ret = GetSession("TNCatalogManageSessionMessage");

                if (String.IsNullOrWhiteSpace(ret))
                {
                    if (String.IsNullOrWhiteSpace(ret))
                    {
                        ret = GetStringProperty("TNCatalogManageSessionMessage", "");
                    }
                }
            ...
            set
            {
                this.SetValue("TNCatalogManageSessionMessage", value);
                SetSession("TNCatalogManageSessionMessage", value);
            }
        }
