...
{
    public partial class TN_MyProfileControl : CMSAbstractWebPart
    {
        #region "Variables"
        ...
        private bool mMarkRequiredFields;
        private bool mUseColonBehindLabel = true;
        private string mAfterSaveRedirectURL;
        private string mFormCSSClass;
        private string mSubmitButtonResourceString;
        private string mValidationErrorMessage;

        // pass in from the parent
        private bool mSelfMode = true;
        ...
        protected void SetupControl()
        {
            ...
            if (Visible)
            {
                ...
                {
                    ui = UserInfoProvider.GetUserInfoByGUID(ValidationHelper.GetGuid(mUserGUID, Guid.Empty));
                }
        ...
        private void editProfileForm_OnBeforeSave(object sender, EventArgs e)
        {
            ...
            #endregion "Reserved names - nickname"
        }
