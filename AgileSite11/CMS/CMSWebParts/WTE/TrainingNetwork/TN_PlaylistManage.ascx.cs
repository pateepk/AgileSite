...
{
    /// <summary>
    /// Web part for managing a TN play list (multiple row selection support)
    /// </summary>
    public partial class TN_PlaylistManage : CMSAbstractWebPart
    {
        #region "Custom Classes"

        /// <summary>
        /// Data for assigning playlist to a client/company/users
        /// </summary>
        ...
        /// </summary>
        public class PlaylistManageData
        {
            /// <summary>
            /// The action.
            /// </summary>
            ...
            /// <summary>
            /// Playlist display order
            /// </summary>
            public int DisplayOrder { get; set; }

            /// <summary>
            /// CompanyID this playlist is associated with
            /// </summary>
        ...
        public string SessionMessage
        {
            get
            {
                string ret = GetSession("TNPlaylistManageSessionMessage");

                if (String.IsNullOrWhiteSpace(ret))
                {
                    if (String.IsNullOrWhiteSpace(ret))
                    {
                        ret = GetStringProperty("TNPlaylistManageSessionMessage", "");
                    }
                }
            ...
            set
            {
                this.SetValue("TNPlaylistManageSessionMessage", value);
                SetSession("TNPlaylistManageSessionMessage", value);
            }
        }
        ...
        /// </summary>
        public string PlaylistIDColumnKey
        {
            get
            {
                return GetStringProperty("PlaylistIDColumnKey", "PlaylistID");
            }
            set
            {
                this.SetValue("PlaylistIDColumnKey", value);
            }
        }
        ...
        /// <summary>
        /// Process Catalog Actions (disable, enable, delete, copy function etc)
        /// </summary>
        /// <returns></returns>
        protected bool ProcessManageCatalog()
        {
            ...
            PlaylistManageData data = GetJSONPostedData<PlaylistManageData>(null);
            if (data != null)
            {
                action = data.Action;
                try
                {
                    ...
                    List<string> itemids = data.PlaylistID;
        ...
        /// <summary>
        /// Assign product or category to a playlist
        ...
        public bool AssignedProduct(ProductAssignmentData p_data, out string p_message)
        {
            ...
            if (item != null)
            {
                SetCustomTableItemValue(item, PlaylistIDColumnKey, GetInt(p_data.PlaylistID));
        ...
        /// <summary>
        /// Remove product and category assignment from a playlist
        /// </summary>
        /// <param name="p_data"></param>
        /// <param name="p_message"></param>
        /// <returns></returns>
        ...
        public bool AssignedCompany(CompanyAssignmentData p_data, out string p_message)
        {
            ...
            if (item != null)
            {
                ...
                SetCustomTableItemValue(item, PlaylistIDColumnKey, GetInt(p_data.PlaylistID));
                SetCustomTableItemValue(item, CategoryIDColumnKey, GetInt(p_data.ClientID));
                SetCustomTableItemValue(item, UserIDColumnKey, GetInt(p_data.UserID));
                SetCustomTableItemValue(item, ActiveColumnKey, true);
                item.Update();
            }
            else
