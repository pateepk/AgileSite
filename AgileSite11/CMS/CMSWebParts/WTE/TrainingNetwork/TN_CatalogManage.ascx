<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TN_CatalogManage.ascx.cs" Inherits="CMSApp.CMSWebParts.WTE.TrainingNetwork.TN_CatalogManage" %>
...
<div id="divtest" runat="server" visible="false">
    ...
    <script type="text/javascript">
        function btnTest_Clicked() {
            PerformMultipleManageAction('ddlManageActionTest', 'catalogselecttest', 'hdnPostbackUrl')
        }
        ...
        function catalogselectalltest_checkchanged() {
            doselectall('catalogselecttest_all', 'catalogselecttest');
        }
    </script>

    <div class="inline-form-group">
        1:
    <input type="checkbox" id="catalogselecttest_1" checked="checked" value="1" />
        2:
    <input type="checkbox" id="catalogselecttest_2" checked="checked" value="2" />
        3:
    <input type="checkbox" id="catalogselecttest_3" checked="checked" value="3" />
    </div>
    ...
    <div class="inline-form-group">
        <label for="catalogselecttest_all">select all:</label><input type="checkbox" id="catalogselecttest_all" onchange="catalogselectalltest_checkchanged();return false;" />
    </div>
...
<script type="text/javascript">
    ...
    function chkManageSelectAll_checkchanged() {
        doselectall('select_all', 'catalogselect');
    }

    // button clicked
    function btnPerformMultipleManageAction_Clicked() {
        PerformMultipleManageAction('ddlManageAction', 'catalogselect', 'hdnPostbackUrl')
    }
    ...
    if (typeof PerformMultipleManageAction !== 'function' || typeof PerformMultipleManageAction === 'undefined') {
        ...
        function PerformMultipleManageAction(actionDropdownName, checkboxName, postbackUrlName) {
            ...
            if (selectedid.length > 0) {
                var actionstring = 'Are you sure you want to ' + action + ' all selected catalog?'
        ...
        function PerformMultipleProductAssignmentAction(actionDropdownName, checkboxName, postbackUrlName) {
            ...
            $('input[type=checkbox][id*=' + cbname + ']').each(function () {
                ...
                if (checked == true) {
                    ...
                    var assignmentdata = '{"AssignmentID":"' + assignmentid + '","CatalogID":"' + catalogid + '","CategoryID":"' + nodeid + '","VideoID":"' + videoid + '"}';
            ...
            if (selectedid.length > 0) {
                var actionstring = 'Are you sure you want to ' + action + ' all selected products/category to this catalog?'
                if (confirm(actionstring)) {
