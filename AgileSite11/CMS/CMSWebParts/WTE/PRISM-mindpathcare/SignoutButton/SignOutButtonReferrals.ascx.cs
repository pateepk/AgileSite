...
public partial class CMSWebParts_WTE_PRISM_mindpathcare_Registration_SignOutButtonReferrals : CMSAbstractWebPart
{
    #region "Variables"
    ...
    protected void btnSignOut_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            if (AuthenticationHelper.IsAuthenticated())
            {
                ...
                URLHelper.Redirect(CustomRedirect());
    ...
    {
        // Lets get the current url and check if we are in sadmin
        string urlString = HttpContext.Current.Request.Url.AbsoluteUri.ToString().ToUpper();
        
        if (urlString.Contains("SADMIN")) {
            return "https://referrals.mindpathcare.com/sadmin";
        } else {
            return "https://referrals.mindpathcare.com";
        }
