<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSApp.CMSWebParts.WTE.Custom.Modules.CMSModules_Reporting_Controls_ReportTable" Codebehind="ReportTable.ascx.cs" %>
