<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSApp.CMSWebParts.WTE.Custom.Modules.CMSModules_Membership_Controls_ResetPassword"  Codebehind="ResetPassword.ascx.cs" %>
