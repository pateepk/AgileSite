<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WTECustomOfficeParkWebPart_old.ascx.cs" Inherits="CMSApp.CMSWebParts.WTE.MOBLZ.WTECustomOfficeParkWebPart_old" %>
...
<asp:UpdatePanel runat="server" ID="upnlMain" UpdateMode="Conditional">
    <ContentTemplate>
        <div class="aisdemo-filters">
            ...
            <div class="aisdemo-filters_item">
                <div class="aisdemo-filters_title">
                    <asp:Literal ID="litOfficePark" runat="server" Text="Office Park" Visible="false"></asp:Literal></div>
                <div id="park_types">
                    <div data-reactroot="">
                        <div class="ais-root ais-refinement-list">
                            <div class="ais-body ais-refinement-list--body">
