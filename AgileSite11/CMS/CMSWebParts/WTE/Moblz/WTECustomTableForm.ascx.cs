...
{
    public partial class WTECustomTableForm : CMSAbstractWebPart
    {
        ...
        private void SetupControl()
        {
            ...
            else
            {
                ...
                {
                    form.SubmitButton.CssClass = SubmitButtonCssClass;
                }

                if (!String.IsNullOrWhiteSpace(SubmitButtonText))
                {
                    form.SubmitButton.ResourceString = SubmitButtonText;
                    form.SubmitButton.Text = SubmitButtonText;
                }
