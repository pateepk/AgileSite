<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUFLogonFormTable.ascx.cs"
    Inherits="CMSApp.CMSWebParts.CUFWebParts.FirstCitizens.CUFLogonFormTable" %>
                                    ...
                                    <td colspan="3" class="LogonDialog">
                                        <table style="border: none; width: 100%; border-collapse: separate;">
                                            <asp:PlaceHolder runat="server" ID="plcTokenInfo" Visible="false">
                                                <tr>
                                                    <td class="logon-label">
                                                        <cms:LocalizedLabel ID="lblTokenIDlabel" runat="server" CssClass="control-label"
                                                            ResourceString="mfauthentication.label.token" />
                                                    </td>
                                            ...
                                            <asp:PlaceHolder runat="server" ID="plcPasscodeBox" Visible="false">
                                                <tr>
                                                    <td style="white-space: nowrap;">
                                                        <cms:LocalizedLabel ID="lblPasscode" runat="server" AssociatedControlID="txtPasscode"
                                                            CssClass="control-label" ResourceString="mfauthentication.label.passcode" />
                                                    </td>
                                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;">
                                                    <cms:LocalizedButton ID="LoginButton" runat="server" ButtonStyle="Primary" CommandName="Login"
