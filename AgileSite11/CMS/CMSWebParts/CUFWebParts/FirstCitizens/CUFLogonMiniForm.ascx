<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUFLogonMiniForm.ascx.cs"
    Inherits="CMSApp.CMSWebParts.CUFWebParts.FirstCitizens.CUFLogonMiniForm" %>
        ...
        <asp:Panel ID="pnlLogonMiniForm" runat="server" DefaultButton="btnLogon" EnableViewState="true"
            ...
            <asp:PlaceHolder runat="server" ID="plcPasscodeBox" Visible="false">
                <cms:LocalizedLabel ID="lblPasscode" runat="server" AssociatedControlID="txtPasscode"
                    ResourceString="mfauthentication.label.passcode" />
                <cms:CMSTextBox ID="txtPasscode" runat="server" MaxLength="100" />
            </asp:PlaceHolder>
            <cms:LocalizedButton ID="btnLogon" runat="server" ResourceString="LogonForm.LogOnButton"
                CommandName="Login" EnableViewState="false" />
