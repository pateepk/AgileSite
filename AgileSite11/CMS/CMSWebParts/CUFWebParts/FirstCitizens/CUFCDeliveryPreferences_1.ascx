<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSWebParts/CUFWebParts/FirstCitizens/CUFCDeliveryPreferences_1.ascx.cs" Inherits="CMSWebParts_CUFWebParts_FirstCitizens_CUFCDeliveryPreferences_1" %>
