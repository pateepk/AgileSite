<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUFAcceptDisclosure.ascx.cs"
    Inherits="CMSApp.CMSWebParts.CUFWebParts.FirstCitizens.CUFAcceptDisclosure" %>
...
<asp:CheckBox ID="cbAcceptTerms" name="cbAcceptTerms" runat="server" />&nbsp;<b>I agree
    to the terms stated
    above</b>
