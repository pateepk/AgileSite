<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUCFAdminHistoricalStatementsFilter.ascx.cs"
    Inherits="CMSApp.CMSWebParts.CUFWebParts.ComFirst.CUCFAdminHistoricalStatementsFilter" %>
...
<telerik:RadDatePicker ID="radDatetime" EnableViewState="true" runat="server" Visible="false">
</telerik:RadDatePicker>
<asp:Button ID="btnFilter" runat="server" Text="Search" class="btn btn-inverse" />
<br />
<small>
    <asp:Label ID="lblMsg" runat="server" /></small>