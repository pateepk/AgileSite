<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CUFDeliveryPreferences.ascx.cs"
    Inherits="CMSApp.CMSWebParts.CUFWebParts.CUFDeliveryPreferences" %>
...
<telerik:RadGrid ID="rgAccounts" runat="server" Width="100%" AutoGenerateColumns="False"
    ...
    <MasterTableView DataKeyNames="MasterAccountID, AccountName, AccountNumber, IsE, IsP"
...
<table style="padding-left: 5px;">
    <tr>
        ...
        <td style="padding-left: 10px;">
            ...
            <div>
                <asp:CustomValidator ID="cvAgree" Display="Dynamic" runat="server" ClientValidationFunction='IsAgreeChecked'
