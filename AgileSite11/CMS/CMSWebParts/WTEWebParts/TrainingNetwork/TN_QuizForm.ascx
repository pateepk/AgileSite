<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TN_QuizForm.ascx.cs" Inherits="CMSWebParts_WTE_TrainingNetwork_TN_QuizForm2" %>
        ...
        <ItemTemplate>
            ...
            <div id="divQuestionItem" class="form-group" runat="server">
                ...
                <div class="editing-form-value-cell">
                    <asp:RadioButtonList ID="rblAnswers" runat="server" AutoPostBack="true"></asp:RadioButtonList>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
