...
public partial class CMSWebParts_WTE_TrainingNetwork_TN_QuizForm2 : CMSAbstractWebPart
{
    #region data classes
    ...
    public class TNQuiz : TNQuizDataContainerBase
    {
        ...
        private void SaveQuizResults(List<TNQuizQuestion> p_questions)
        {
            ...
            ConnectionHelper.ExecuteQuery("dbo.Proc_TN_customtable_QuizResults_Insert", qdp, QueryTypeEnum.StoredProcedure);
        }
