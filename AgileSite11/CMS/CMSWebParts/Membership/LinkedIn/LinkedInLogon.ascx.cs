...
public partial class CMSWebParts_Membership_LinkedIn_LinkedInLogon : CMSAbstractWebPart
{
    ...
    protected void CheckStatus()
    {
        ...
        currentUrl = URLHelper.RemoveParameterFromUrl(currentUrl, "code");
        currentUrl = URLHelper.RemoveParameterFromUrl(currentUrl, "error");
        currentUrl = URLHelper.RemoveParameterFromUrl(currentUrl, "error_description");
        currentUrl = URLHelper.RemoveParameterFromUrl(currentUrl, "state");
