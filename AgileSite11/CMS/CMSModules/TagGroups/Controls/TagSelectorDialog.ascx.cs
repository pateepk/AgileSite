...
public partial class CMSModules_TagGroups_Controls_TagSelectorDialog : CMSUserControl
{
    ...
    public void SaveTags()
    {
        ...
        if (items.Count > 0)
        {
            ...
            resultTags = new HashSet<string>(resultTags.Union(savedTagNames), StringComparer.InvariantCultureIgnoreCase);
        }
    ...
    protected void gridElem_OnAfterDataReload()
    {
        ...
        UnsavedTags = new HashSet<string>(selectedTags.Except(tags.Select(t => t.Item2)));
