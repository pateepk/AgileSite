...
<asp:Panel ID="pnlUpdate" runat="server">
    <cms:UniGrid runat="server" ID="gridElem" IsLiveSite="false" HideFilterButton="true" Columns="ActivityID,ActivityTitle,ActivityType,ActivityCreated,ActivitySiteID" RememberStateByParam="issitemanager">
