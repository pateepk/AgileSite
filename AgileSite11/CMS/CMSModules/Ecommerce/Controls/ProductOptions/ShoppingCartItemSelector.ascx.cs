...
public partial class CMSModules_Ecommerce_Controls_ProductOptions_ShoppingCartItemSelector : CMSUserControl
{
    ...
    /// <summary>
    /// Logs product added to shopping cart activity.
    /// </summary>
    private void LogProductAddedToSCActivity(ShoppingCartItemInfo item)
    {
        var logger = new EcommerceActivityLogger();
        logger.LogProductAddedToShoppingCartActivity(item.SKU, item.CartItemUnits);
    }
