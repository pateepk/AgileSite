...
[Obsolete("Form control will be removed in the next version. The Facebook page ID has to be set manually.")]
public partial class CMSModules_SocialMarketing_FormControls_FacebookPageId : FormEngineUserControl
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Form != null)
        {
            ...
            {
                PageUrl = txtPageUrl.Text = EditedAccount.FacebookAccountPageUrl;
                PageId = EditedAccount.FacebookAccountPageID;
            }
        }
    }
