...
public partial class CMSAdminControls_MultiFileUploader_MultiFileUploader : CMSUserControl, IUploadHandler
{
    ...
    private static string GetArgumentsString(string[] args, string purpose)
    {
        ...
        {
            arguments = String.Format("{0}{1}Hash{1}{2}", arguments, PARAMETER_SEPARATOR, ValidationHelper.GetHashString(arguments, new HashSettings() { HashSalt = purpose }));
        }
    ...
    private string GetAdditionalParameters()
    {
        ...
        return "AdditionalParameters=" + GetArgumentsString(args, "MultiFileUploader - AddiotionalParameter");
    }
    ...
    private string GetModeParameters()
    {
        ...
        if (MediaLibraryID > 0)
        {
            ...
            return "MediaLibraryArgs=" + GetArgumentsString(args, "MultiFileUploader - MediaLibraryArgs");
        }
        ...
        if ((NodeID > 0) && (SourceType == MediaSourceEnum.Content))
        {
            ...
            return "FileArgs=" + GetArgumentsString(args, "MultiFileUploader - FileArgs");
        }
        ...
        if (ObjectID > 0)
        {
            ...
            return "MetaFileArgs=" + GetArgumentsString(args, "MultiFileUploader - MetaFileArgs");
        }
        ...
        if (PostForumID > 0)
        {
            ...
            return "ForumArgs=" + GetArgumentsString(args, "MultiFileUploader - ForumArgs");
        }
        ...
        if ((DocumentID > 0) || (FormGUID != Guid.Empty))
        {
            ...
            return "AttachmentArgs=" + GetArgumentsString(args, "MultiFileUploader - AttachementArgs");
        }
        return String.Empty;
    }
    ...
    private string GetAllowedExtensions()
    {
        ...
        if (!string.IsNullOrEmpty(filter))
        {
            ...
            string hash = ValidationHelper.GetHashString(filter, new HashSettings() { HashSalt = "MultiFileUploader - AllowedExtensions" });
