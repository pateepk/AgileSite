...
public partial class CMSAdminControls_ContextMenus_UserContextMenu : CMSContextMenuControl, IPostBackEventHandler
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var query = "?userid=" + currentUser.UserID;
        ...
        script += "function ContextPrivateMessage(id) { \n" +
                  "modalDialog('" + ApplicationUrlHelper.ResolveDialogUrl("~/CMSModules/Messaging/CMSPages/SendMessage.aspx") + query + "&requestid=' + id , 'sendMessage', 700, 650); \n" +
                  " } \n";
