...
var map = new google.maps.Map(document.getElementById("google_map"), myOptions);
    ...
    function populateMoveinFilterMap(neighborhoods) {
        ...
        j.each(infoArray, function (item, val) {
            ...
            addNewNeighborhood(val.neighborhood.neighborhoodName, position, "<div style='height: 100px'><a href=" + val.neighborhood.neighborhoodUrl + ">" + val.neighborhood.neighborhoodName + "</a>" + listingHtml + "<a href='http://maps.google.com/maps?daddr=" + position + "' target='_blank'>GetDirections</a></div>", val.neighborhood.neighborhoodIcon + ".png");
        })
    }
//})(jQuery);