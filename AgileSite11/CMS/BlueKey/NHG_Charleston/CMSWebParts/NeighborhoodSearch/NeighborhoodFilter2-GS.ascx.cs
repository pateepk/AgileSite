...
namespace NHG_C
{
    public partial class CMSWebParts_NeighborhoodFilter2_GS : CMSAbstractBaseFilterControl
    {
        #region "Properties"
        ...
        **/
        ...
        private void GetFilter()
        {
            ...
            if (county == "")
            {
                if (url.Contains("Georgetown-County"))
                {
                    county = "64";
                }
                if (url.Contains("Horry-County"))
                {
                    county = "65";
                }
                if (url.Contains("Brunswick-County"))
                {
                    county = "66";
                }
            }

            //lblmsg.Text = "County id is: " + county + "<br />";
            //lblmsg.Text += "URL is: " + url;
