...
namespace NHG_C
{
    public partial class CMSWebParts_BuildersFilter : CMSAbstractBaseFilterControl
    {
        ...
        private void SetFilter()
        {
            ...
            CMS.EventLog.EventLogProvider.LogInformation("BlueKey", "Debug", "BuildersFilter where: " + where);
        ...
        private void GetFilter()
        {
            ...
            else
            {
                ...
                btnFilterCustom.Text = "Show Custom";
            }
        ...
        public void btnFilter_Click(object sender, EventArgs e)
        {
            if (this.FilterByQuery)
            {
                ...
                url = URLHelper.RemoveParametersFromUrl(url, "city");
                ...
                if (ValidationHelper.GetInteger(high, 0) > 0 && ValidationHelper.GetInteger(high, 0) != 100000)
                {
