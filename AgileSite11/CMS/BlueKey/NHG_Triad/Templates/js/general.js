    ...
    $(document).ready(function () {
        ...
        $('.mobileAccordionToggle').click(function () {
            if (overallWidth < 992) {
                if ($(this).hasClass('on')) {
                    $(this).removeClass('on');
                    $(this).next('.accordionContent').removeClass('on');
                } else {
                    $(this).addClass('on');
                    $(this).next('.accordionContent').addClass('on');
                }
            }
        });
        ...
        $('.listingFilter .filterWrapper').addClass('on').removeClass('off');
        $('.listingFilter .mobileFilterToggle').text('Hide Filters');
        $('.moveInFilters .filterWrapper').addClass('off').removeClass('on');
        $('.moveInFilters .mobileFilterToggle').text('Show Filters');
