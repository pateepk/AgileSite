...
namespace NHG_T
{
    public partial class BlueKey_CMSWebParts_NeighborhoodSearch_MoveInFilter_TR_WTE : CMSAbstractBaseFilterControl
    {
        #region "Properties"
        ...
        protected void PopulateBuilders()
        {
            ...
            ds = tree.SelectNodes(SiteContext.CurrentSiteName, "/Builders/%", "en-us", true, "custom.Developers", "DeveloperActive = 1", "DeveloperName ASC");
        ...
        protected void PopulateTypes()
        {
            ...
            ddType.Items.Insert(0, new ListItem("Any Type", "4"));
        ...
        protected void PopulateNeighborhoods()
        {
            ...
            ds = tree.SelectNodes(SiteContext.CurrentSiteName, "/Neighborhoods/%", "en-us", true, "custom.Neighborhood", "NeighborhoodActive = 1", "NeighborhoodName ASC");
        ...
        private void SetFilter()
        {
            ...
            {
                if (ddType.SelectedValue == "4")
                {
                    where += " AND ( ListingType = 1 OR ListingType = 2 ) ";
                }
                else
                {
