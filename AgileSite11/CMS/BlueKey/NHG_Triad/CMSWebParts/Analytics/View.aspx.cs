...
namespace NHG_T.CMSApp.utils
{
    public partial class View : CMSPage
    {
        ...
        {
            string sid = QueryHelper.GetString("SiteID", "");
            string dlDataUrl = "";

            if (sid == "10")
            {
                dlDataUrl = "https://www.triadnewhomeguide.com/BlueKey/CMSWebParts/Analytics/pixel.png";
            }
            if (sid == "5")
            {
                dlDataUrl = "https://www.grandstrandnewhomeguide.com/BlueKey/CMSWebParts/Analytics/pixel.png";
            }
            ...
            byte[] data = wc.DownloadData(dlDataUrl);
