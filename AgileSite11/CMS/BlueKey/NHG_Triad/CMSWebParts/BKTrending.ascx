<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BKTrending.ascx.cs" Inherits="NHG_T.BlueKey_CMSWebParts_BKTrending" %>
...
<asp:Panel ID="pnlNeighborhoods" runat="server" Visible="false">
    ...
    <asp:Repeater ID="rptNeighborhoods" runat="server">
        <ItemTemplate>
            <a class="asideBox trendingAside trendingNeighborhood" href="/CMSPages/TrackClick.aspx?url=<%# GetNeighborhood(Eval("DocumentNodeID"), "", true, true) %>&type=Trending&id=<%# Eval("DocumentID") %>&LinkNote=Side Bar Neighborhood List">
                ...
                <div class="trendingAction">Learn More &raquo;</div>
              </a>
        </ItemTemplate>
    </asp:Repeater>
</asp:Panel>
...
<asp:Panel ID="pnlBuilders" runat="server" Visible="false">
    ...
    <asp:Repeater ID="rptDevelopers" runat="server">
        <ItemTemplate>
            <a class="asideBox trendingAside" href="/CMSPages/TrackClick.aspx?url=<%# GetDeveloper(Eval("DevelopersID"), false, false, "", true) %>&type=Trending&id=<%# Eval("DocumentID") %>&LinkNote=Side Bar Developer List">
...
<asp:Panel ID="pnlHomes" runat="server" Visible="false">
    ...
    <asp:Repeater ID="rptHomes" runat="server">
        <ItemTemplate>
            <a class="asideBox trendingAside trendingHomeAside" href="/CMSPages/TrackClick.aspx?url=<%# GetListing(Eval("DocumentID")) %>&type=Trending&id=<%# Eval("DocumentNodeID") %>&LinkNote=Side Bar Listing List">
