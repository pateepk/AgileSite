<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalyticsReportsDashboardAnnual.aspx.cs" Inherits="NHG_T.BlueKey_CMSModules_AnalyticsReportsDashboardAnnual" 
...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">    
    ...
    <p><a href="AnalyticsReportsDashboard.aspx">Monthly Reports</a> | <a href="AnalyticsReportsDashQuarterly.aspx">Quarterly Reports</a>

    </p>

    <h2 ID="hdrAnalyticsTitle" runat="server">Analytics Dashboard for the Current Year</h2>

    <label>See Records for: <asp:DropDownList ID="ddYearSelector" runat="server" /></label><asp:Button ID="btnChangeToYear" runat="server" OnClick="btnChangeToYearClick" Text="Submit" />

    <h3>Records for <asp:Label ID="lblYearRecords" runat="server" /></h3>
