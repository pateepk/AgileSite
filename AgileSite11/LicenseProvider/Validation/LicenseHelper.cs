...
namespace CMS.LicenseProvider
{
    ...
    public static class LicenseHelper
    {
        ...
        /// </summary>
        public static void ClearLicenseLimitation()
        {
        ...
        public static int GetSiteIDbyDomain(string domain)
        {
            ...
            if (InternalHelper.SiteIds.TryGetValue(domainToLower, out siteId))
            {
        ...
        public static string GetEditionName(ProductEditionEnum edition)
        {
            switch (edition)
            {
                case ProductEditionEnum.Free:
                    return ResHelper.GetAPIString("Edition.F", "Free");
                    
                case ProductEditionEnum.UltimateV7:
                    return ResHelper.GetAPIString("Edition.V", "Ultimate");

                case ProductEditionEnum.Base:
                    return ResHelper.GetAPIString("Edition.B", "Base");

                case ProductEditionEnum.SmallBusiness:
                    return ResHelper.GetAPIString("Edition.N", "Small business");

                case ProductEditionEnum.EnterpriseMarketingSolution:
                    return ResHelper.GetAPIString("Edition.X", "Enterprise marketing solution");
            }
        ...
        public static string GetValidationResultString(LicenseValidationEnum result)
        {
            ...
            return ResHelper.GetString("invalidlicense." + stringResult);
        }
        ...
        public static void ReportFailedLicenseCheck(FeatureEnum feature, string domain, bool throwError)
        {
            ...
            if (throwError)
            {
                ...
                var message = String.Format("License for feature '{0}' not found.", feature);
        ...
        private static int GetSiteIDFromDataSet(DataSet ds)
        {
            if (!DataHelper.DataSourceIsEmpty(ds))
            {
                ...
                {
                    if (ValidationHelper.GetString(dr["SiteStatus"], "stopped").ToLowerCSafe() == "running")
                    {
