...
namespace CMS.LicenseProvider
{
    ...
    internal class LicenseHelperInternal
    {
        ...
        private readonly CMSStatic<SafeDictionary<string, LicenseKeyInfo>> mA7BF6 = new CMSStatic<SafeDictionary<string, LicenseKeyInfo>>(() => new SafeDictionary<string, LicenseKeyInfo>());
        ...
        internal virtual LicenseValidationEnum ValidateLicenseForDomain(string domain)
        {
            ...
            domain = ParseDomainName(domain.ToLowerCSafe());
        ...
        /// <summary>
        /// Removes www prefix and port from lowered form of given url.
        /// </summary>
        /// <param name="url">Url to remove from.</param>
        internal virtual string ToLowerAndRemoveWWWAndPort(string url)
        {
            return URLHelper.RemoveWWW(URLHelper.RemovePort(url.ToLowerCSafe()));
        }
        ...
        {
            if (!String.IsNullOrEmpty(redirectUrl) && CMSActionContext.CurrentAllowLicenseRedirect && (HttpContext.Current != null))
            {
        ...
        {
            return ResHelper.GetString("licenselimitation.featurenotavailable");
        }
        ...
        {
            return ResHelper.GetString("licenselimitation.featurelimitexceeded");
        }
