...
{
    /// <summary>
    /// Sample implementation of <see cref="IPersonalDataCollector"/> interface for collecting customer's personal data.
    /// </summary>
    internal class SampleCustomerDataCollector : IPersonalDataCollector
    {
        /// <summary>
        ...
        public PersonalDataCollectorResult Collect(IEnumerable<BaseInfo> identities, string outputFormat)
        {
            ...
            {
                var dataCollector = new SampleCustomerDataCollectorCore(writer);
