...
namespace CMS.UIControls
{
    ...
    /// </summary>
    [CheckLicence(FeatureEnum.BannerManagement)]
    [Security(Resource = ModuleName.BANNERMANAGEMENT, ResourceSite = true)]
    public class CMSBannerManagementPage : CMSDeskPage
    {
        /// <summary>
        ...
        protected string ResourceName
        {
            get
            {
                return ModuleName.BANNERMANAGEMENT;
            }
        }
        ...
        protected void CheckReadPermission(int? siteID)
        {
            ...
            else
            {
                ...
                {
                    RedirectToInformation(GetString("banner.error.siteidisnotcurrentsite"));
                }
            }
        }
        ...
        protected bool HasUserModifyPermission(int? siteID = null)
        {
            // Global
            if ((siteID == null) || (siteID <= 0))
            {
