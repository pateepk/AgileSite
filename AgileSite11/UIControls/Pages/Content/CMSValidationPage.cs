...
namespace CMS.UIControls
{
    ...
    public abstract class CMSValidationPage : CMSContentPage
    {
        ...
        /// HTML
        /// </summary>
        protected const String TAB_HTML = "html";

        /// <summary>
        /// CSS
        /// </summary>
        protected const String TAB_CSS = "css";

        /// <summary>
        /// Links
        /// </summary>
        protected const String TAB_LINKS = "links";

        /// <summary>
        /// Accessibility
        /// </summary>
        protected const String TAB_ACCESSIBILITY = "accessibility";
        ...
        /// <summary>
        /// Gets current validation tab.
        /// </summary>
        protected String GetValidationTab()
        {
            return ValidationHelper.GetString(ContextHelper.GetItem(CookieName.ValidationTab, true, false, true), TAB_HTML);
        }


        /// <summary>
        /// Sets current validation tab.
        /// </summary>
        /// <param name="value">Value to store</param>
        protected void SetValidationTab(String value)
        {
            ContextHelper.Add(CookieName.ValidationTab, value, true, false, true, DateTime.Now.AddDays(1));
        }
