...
namespace CMS.UIControls
{
    ...
    public class ObjectCustomizationPanel : Panel
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                MessagesPlaceHolder.ShowInformation(LocalizationHelper.GetString(EditedObject.TypeInfo.ObjectType + ".customization.information|customization.information"));
            }
            else
            {
                MessagesPlaceHolder.ShowInformation(LocalizationHelper.GetString(EditedObject.TypeInfo.ObjectType + ".customization.howtocustomize|customization.howtocustomize"));
