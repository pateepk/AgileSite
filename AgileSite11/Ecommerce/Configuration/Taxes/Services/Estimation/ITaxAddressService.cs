namespace CMS.Ecommerce
{
    ...
    public interface ITaxAddressService
    {
        ...
        /// </summary>
        /// <remarks>
        /// Note that the result can be <paramref name="billingAddress"/>, <paramref name="shippingAddress"/> or any other <see cref="IAddress"/> instance.
        /// </remarks>
        ...
        IAddress GetTaxAddress(IAddress billingAddress, IAddress shippingAddress, TaxClassInfo taxClass, CustomerInfo customer);
    }
}
