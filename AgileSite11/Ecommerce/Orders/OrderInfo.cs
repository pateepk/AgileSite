    ...
    public class OrderInfo : AbstractInfo<OrderInfo>
    {
        ...
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(OrderInfoProvider), OBJECT_TYPE, "ECommerce.Order", "OrderID", "OrderLastModified", "OrderGUID", null, "OrderInvoiceNumber", null, "OrderSiteID", null, null)
        {
            ...
            DependsOn = new List<ObjectDependency>
                                    {
                                        new ObjectDependency("OrderBillingAddressID", OrderAddressInfo.OBJECT_TYPE),
                                        new ObjectDependency("OrderShippingAddressID", OrderAddressInfo.OBJECT_TYPE),
                                        new ObjectDependency("OrderCompanyAddressID", OrderAddressInfo.OBJECT_TYPE),
        ...
        private IAddress mBillingAddress;
        private IAddress mShippingAddress;
        private IAddress mCompanyAddress;
        ...
        /// </summary>
        [DatabaseField]
        public virtual int OrderShippingAddressID
        {
            get
            {
                return GetIntegerValue("OrderShippingAddressID", 0);
            }
            internal set
            {
                SetValue("OrderShippingAddressID", value, value > 0);
            }
        }
        ...
        /// </summary>
        [DatabaseField]
        public virtual int OrderBillingAddressID
        {
            get
            {
                return GetIntegerValue("OrderBillingAddressID", 0);
            }
            internal set
            {
                SetValue("OrderBillingAddressID", value);
            }
        }
        ...
        /// </summary>
        [DatabaseField]
        public virtual int OrderCompanyAddressID
        {
            get
            {
                return GetIntegerValue("OrderCompanyAddressID", 0);
            }
            internal set
            {
                SetValue("OrderCompanyAddressID", value, value > 0);
            }
        }
        ...
        /// </summary>        
        public IAddress OrderBillingAddress
        {
            get
            {
                if ((mBillingAddress == null) || ((mBillingAddress is BaseInfo) && !((BaseInfo)mBillingAddress).Generalized.IsObjectValid))
                {
                    mBillingAddress = OrderAddressInfoProvider.GetAddressInfo(OrderBillingAddressID);
                }
            ...
            set
            {
                if (value is AddressInfo)
                {
                    mBillingAddress = OrderAddressInfoProvider.CreateOrderAddressInfo(value);
                    OrderBillingAddressID = 0;
                }
                else
                {
                    OrderBillingAddressID = value?.AddressID ?? 0;
        ...
        /// </summary>
        public IAddress OrderShippingAddress
        {
            get
            {
                if ((mShippingAddress == null) || ((mShippingAddress is BaseInfo) && !((BaseInfo)mShippingAddress).Generalized.IsObjectValid))
                {
                    mShippingAddress = OrderAddressInfoProvider.GetAddressInfo(OrderShippingAddressID);
                }
            ...
            set
            {
                if (value is AddressInfo)
                {
                    mShippingAddress = OrderAddressInfoProvider.CreateOrderAddressInfo(value);
                    OrderShippingAddressID = 0;
                }
                else
                {
                    OrderShippingAddressID = value?.AddressID ?? 0;
        ...
        /// </summary>
        public IAddress OrderCompanyAddress
        {
            get
            {
                if ((mCompanyAddress == null) || ((mCompanyAddress is BaseInfo) && !((BaseInfo)mCompanyAddress).Generalized.IsObjectValid))
                {
                    mCompanyAddress = OrderAddressInfoProvider.GetAddressInfo(OrderCompanyAddressID);
                }
            ...
            set
            {
                if (value is AddressInfo)
                {
                    mCompanyAddress = OrderAddressInfoProvider.CreateOrderAddressInfo(value);
                    OrderCompanyAddressID = 0;
                }
                else
                {
                    OrderCompanyAddressID = value?.AddressID ?? 0;
