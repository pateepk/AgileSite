...
namespace CMS.Ecommerce
{
    ...
    /// </summary>
    [Serializable]
    public class OrderAddressInfo : AbstractInfo<OrderAddressInfo>, IAddress
    {
        ...
        /// Type information.
        /// </summary>
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(OrderAddressInfoProvider), OBJECT_TYPE, "ECommerce.OrderAddress", "AddressID", "AddressLastModified", "AddressGUID", null, "AddressPersonalName", null, null, null, null)
                                              {
                                                  // Child object types
                                                  // - None
