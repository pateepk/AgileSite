...
namespace CMS.OnlineForms
{
    ...
    public class FormSubmitActivityInitializer : IActivityInitializer
    {
        ...
        public void Initialize(IActivityInfo activity)
        {
            ...
            var formSite = SiteInfoProvider.GetSiteInfo(form.FormSiteID);
            if (formSite?.SiteIsContentOnly == true)
            {
                var referrerUrl = CMSHttpContext.Current.Request.UrlReferrer?.AbsoluteUri;
