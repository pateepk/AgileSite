...
namespace CMS.OnlineForms
{
    ...
    public class BizFormItem : AbstractInfoBase<BizFormItem>
    {
        ...
        public BizFormInfo BizFormInfo
        {
            get
            {
                return BizFormInfoProvider.GetBizForms().WhereEquals("FormClassID", DataClassInfo.ClassID).TopN(1).FirstOrDefault();
            }
        }
        ...
        public override string GetSearchImageUrl(string image)
        {
            ...
            return base.GetSearchImageUrl(image);
        }
