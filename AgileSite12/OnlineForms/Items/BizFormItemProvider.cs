...
namespace CMS.OnlineForms
{
    ...
    public class BizFormItemProvider : AbstractInfoProvider<BizFormItem, BizFormItemProvider>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BizFormItemProvider"/> class.
        /// </summary>
        ...
        internal static void Clear(bool logTask)
        {
            ...
            if (logTask)
            {
                WebFarmHelper.CreateTask(new ClearBizFormTypeInfosWebFarmTask());
            }
        }
        ...
        internal static void InvalidateTypeInfo(string className, bool logTask)
        {
            ...
            if (logTask)
            {
                WebFarmHelper.CreateTask(new InvalidateBizFormTypeInfoWebFarmTask { ClassName = className });
            }
        }
