...
namespace CMS.OnlineForms
{
    ...
    internal static class BizFormExport
    {
        ...
        private static void ExportData(SiteExportSettings settings, DataSet data, TranslationHelper th)
        {
            ...
            foreach (DataRow dr in table.Rows)
            {
                ...
                try
                {
                    ...
                    var formDevelopmentModel = (FormDevelopmentModelEnum)dr["FormDevelopmentModel"].ToInteger(0);
                    ...
                    if (!DataHelper.DataSourceIsEmpty(ds))
                    {
                        ...
                        {
                            CopyFiles(settings, ds, formImportObjectType, formName, formDevelopmentModel, dci);
                        }
                    }
                }
        ...
        private static void CopyFiles(SiteExportSettings settings, DataSet data, string objectType, string formName, FormDevelopmentModelEnum formDevelopmentModel, DataClassInfo dataClass)
        {
            ...
            // Get file columns
            var fileColumns = BizFormInfoProvider.GetBizFormFileColumns(dataClass.ClassFormDefinition, formDevelopmentModel);
            if (fileColumns == null)
            {
                return;
            }
