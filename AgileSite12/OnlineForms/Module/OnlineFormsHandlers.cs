...
namespace CMS.OnlineForms
{
    ...
    internal class OnlineFormsHandlers
    {
        ...
        public static void Init()
        {
            ...
            FormClassInfo.TYPEINFOFORM.Events.Insert.After += CreateIndexIfNeeded;
            FormClassInfo.TYPEINFOFORM.Events.Update.After += CreateIndexIfNeeded;
        }
        ...
        /// <summary>
        /// Ensures index existence after each <see cref="FormClassInfo"/> info insert or update operation.
        /// </summary>
        private static void CreateIndexIfNeeded(object sender, ObjectEventArgs e)
        {
            if (e.Object is FormClassInfo formClassInfo)
            {
                var formInfo = new FormInfo(formClassInfo.ClassFormDefinition);
                if (formInfo.ContainsSmartField())
                {
                    SmartFieldDatabaseUtils.EnsureContactColumnIndex(formClassInfo.ClassTableName);
                }
            }
        }
