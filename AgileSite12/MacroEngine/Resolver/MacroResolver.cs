...
namespace CMS.MacroEngine
{
    ...
    public class MacroResolver : IMacroResolver, INotCopyThreadItem
    {
        ...
        public virtual bool CheckObjectPermissions(BaseInfo obj, MacroIdentityOption identityOption)
        {
            // Get the user
            IUserInfo user = null;
        ...
        protected string FinalizeResult(object result, bool processChilden, EvaluationContext context)
        {
            ...
            // Localize result
            stringResult = CoreServices.Localization.LocalizeString(stringResult, Settings.Culture);
