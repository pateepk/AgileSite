...
namespace CMS.MacroEngine
{
    ...
    internal class UtilMethods : MacroMethodContainer
    {
        ...
        public static object Localize(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 1:
                    return CoreServices.Localization.LocalizeString(GetStringParam(parameters[0], context.Culture), context.Culture);

                case 2:
                    return CoreServices.Localization.LocalizeString(GetStringParam(parameters[0], context.Culture), GetStringParam(parameters[1], context.Culture));
        ...
        public static object MapPath(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 1:
                    return CMSHttpContext.Current?.Server.MapPath(GetStringParam(parameters[0], context.Culture));
