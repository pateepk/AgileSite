...
namespace CMS.SiteProvider
{
    ...
    public class CultureSiteInfoProvider : AbstractInfoProvider<CultureSiteInfo, CultureSiteInfoProvider>
    {
        ...
        {
            return GetCultureSites().WhereEquals("CultureID", cultureId).OnSite(siteId, siteId == ProviderHelper.ALL_SITES).BinaryData(true).TopN(1).FirstOrDefault();
        }
        ...
        protected virtual InfoDataSet<CultureInfo> LoadSiteCulturesInternal(int siteId)
        {
            return CultureInfoProvider.GetCultures()
                .WhereIn("CultureID", GetCultureSites()
