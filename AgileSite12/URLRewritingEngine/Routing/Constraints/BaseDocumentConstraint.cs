...
namespace CMS.URLRewritingEngine
{
    ...
    public abstract class BaseDocumentConstraint
    {
        ...
        /// </summary>
        private static bool? mSwitchToRouteCulture;
        ...
        protected BaseDocumentConstraint(string siteName, string aliasPath, int nodeId, string culture, string urlPath, PageInfoSource pageInfoSource)
        {
            mSiteName = siteName;
        ...
        {
            // Check site
            return mSiteName.Equals(siteName.Value, StringComparison.InvariantCulture);
        }
