...
namespace CMS.UIControls
{
    ...
    public abstract class AbstractCMSPage : Page, ICMSPage
    {
        ...
        /// </summary>
        protected virtual ICMSDocumentManager CreateDocumentManager()
        {
        ...
        public static string GetString(string stringName, string culture = null)
        {
        ...
        protected void LoadContextHelp()
        {
            ...
            {
                var uiElementHelpTopics = FilterVisibleHelpTopics(UIContext.UIElement.HelpTopics);
                ...
                RegisterContextHelpScript(appCaption, appDescriptionUrl, FilterVisibleHelpTopics(app.HelpTopics), UIContext.UIElement.IsApplication ? null : uiElementHelpTopics);
            }
            else
            {
        ...
        /// <summary>
        /// Filters collection of <paramref name="helpTopics"/> by <see cref="UIContextHelper.CheckHelpTopicVisiblityCondition"/> predicate.
        /// </summary>
        private static IEnumerable<HelpTopicInfo> FilterVisibleHelpTopics(IInfoObjectCollection<BaseInfo> helpTopics)
        {
            if (helpTopics == null)
            {
                return null;
            }
            return helpTopics.ToList().Cast<HelpTopicInfo>().Where(ht => UIContextHelper.CheckHelpTopicVisiblityCondition(ht));
        }
