...
namespace CMS.UIControls
{
    ...
    public class BaseFormBuilder : BaseFieldEditor
    {
        ...
        private string GetUniqueFieldName(string name)
        {
            ...
            {
                name = ValidationHelper.GetIdentifier(name);
            }
            return FormInfoHelper.GetUniqueFieldName(FormInfo, name);
        }
        ...
        private string EnsureNiceFieldName(FormFieldInfo oldInfo, FormFieldInfo newInfo)
        {
            ...
            if (!ValidationHelper.IsIdentifier(controlName))
            {
                controlName = ValidationHelper.GetIdentifier(controlName);
            }
