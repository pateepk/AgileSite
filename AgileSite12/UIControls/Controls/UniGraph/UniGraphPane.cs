    ...
    internal class UniGraphPane : CMSPanel
    {
        ...
        protected void PrintGraph()
        {
            if (GraphConfiguration != null)
            {
                ...
                string graphJson = JsonConvert.SerializeObject(GraphConfiguration, settings);
                string sourcePointsLimits = JsonConvert.SerializeObject(NodeSourcePointsLimits.GetSerializableObject(), settings);
