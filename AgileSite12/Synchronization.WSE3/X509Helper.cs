...
namespace CMS.Synchronization.WSE3
{
    ...
    public class X509Helper
    {
        ...
        {
            var location = Service.Resolve<IX509StoreLocationProvider>().GetStoreLocation();

            return RetrieveX509TokenFromStore(location, StoreName.My, keyIdentifier);
        }
        ...
        {
            foreach (var sign in security.Elements.OfType<MessageSignature>())
            {
