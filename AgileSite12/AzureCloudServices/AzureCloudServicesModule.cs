...
namespace CMS.AzureCloudServices
{
    ...
    internal class AzureCloudServicesModule : Module
    {
        ...
        private void ApplicationStartInit()
        {
            ...
            SystemEvents.RestartRequired.Execute += RestartApplication;
        ...
        private static string GetApplicationSettings(string key)
        {
            try
            {
        ...
        private static void RestartApplication(object sender, RestartRequiredEventArgs args)
        {
            RoleEnvironment.RequestRecycle();
            args.IsRestarted = true;
        }
    }
}
