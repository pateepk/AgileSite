    ...
    public class UIHelper
    {
        ...
        public static bool AllowUpdateProgress
        {
            get
            {
                ...
                return mAllowUpdateProgress.Value && ValidationHelper.GetBoolean(RequestStockHelper.GetItem("CMSAllowProgressScript"), true);
            }
            set
            {
                RequestStockHelper.Add("CMSAllowProgressScript", value);
            }
        }
        ...
        /// </summary>
        /// <param name="site">Site from which is user signs out.</param>
        /// <remarks>
        /// <see cref="SiteInfo.SitePresentationURL"/> is returned if the <paramref name="site"/> is <see cref="SiteInfo.SiteIsContentOnly"/>. 
        /// Otherwise url to live site root is returned.
        /// </remarks>
        public static string GetSignOutUrl(SiteInfo site)
        {            
            return site.SiteIsContentOnly ? site.SitePresentationURL : UrlResolver.ResolveUrl("~/");
        }
