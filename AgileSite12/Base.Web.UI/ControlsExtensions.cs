...
namespace CMS.Base.Web.UI
{
    ...
    public static class ControlsExtensions
    {
        ...
        {
            if ((ctrl.ShortID != null) && RenderShortIDs && (ctrl.ID != ctrl.ShortID) && (CMSHttpContext.Current != null))
            {
        ...
        public static Control LoadUserControl(this Page page, ControlDefinition control)
        {
            ...
            if ((page == null) && (CMSHttpContext.Current != null))
            {
                // Try to use handler as a page
                var p = CMSHttpContext.Current.Handler as Page;
                if (p != null)
                {
        ...
        /// <param name="resourceStrings">Resource strings</param>
