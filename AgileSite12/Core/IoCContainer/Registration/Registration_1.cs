...
namespace CMS.Core
{
    ...
    {
        private readonly RegistrationCore<TService> registration;
        ...
        public Registration()
        {
            registration = new RegistrationCore<TService>(Component.For<TService>());
        }
        ...
        {
            registration.ComponentRegistration = registration.ComponentRegistration.ImplementedBy<TImplementation>();
