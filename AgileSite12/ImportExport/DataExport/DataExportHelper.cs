...
namespace CMS.ImportExport
{
    ...
    public class DataExportHelper : CoreMethods
    {
        ...
        /// </summary>
        protected MacroResolver mMacroResolver;


        /// <summary>
        /// Indicates whether to use shared string table during Excel export.
        /// </summary>
        protected bool? mUseSharedStringStorage;

        /// <summary>
        /// File of name to export with extension.
        /// </summary>
        protected string mFileNameWithExtension;
        ...
        /// </summary>
        protected string mDataExportTemplatePath;
        ...
        /// </summary>
        protected Hashtable mExportedColumns;
        ...
        /// </summary>
        protected event OnExternalDataBound ExternalDataBound;
        ...
        public string CSVDelimiter
        {
            get;
            set;
        } = CultureHelper.PreferredUICultureInfo.TextInfo.ListSeparator;
        ...
        private Cell CreateCell(string cellReference, object cellValue)
        {
            ...
            {
                cell.DataType = new EnumValue<CellValues>(CellValues.Number);
                cell.CellValue = new CellValue(String.Format(System.Globalization.CultureInfo.InvariantCulture, "{0}", cellValue));
            }
            else
            {
        ...
        {
            DataSet resultDataSet = new DataSet(dataSet.DataSetName);
            ...
            foreach (DataTable dataTable in dataSet.Tables)
            {
                ...
                DataTable resultDataTable = new DataTable(tableName);

                resultDataSet.Tables.Add(resultDataTable);

                foreach (string columnName in exportedColumns)
                {
                    var resultDC = resultDataTable.Columns.Add(columnName, typeof(string));

                    // Initialize the column caption
                    int columnIndex = GetColumnIndex(tableName, columnName);

                    string columnCaption = GetColumnCaptionText(columnIndex, dataTable.TableName);
                ...
                foreach (DataRowView dataRowView in dataView)
                {
                    ...
                    {
                        // Apply external data bound if set
                        var value = GetExportedValue(dataRowView, columnName, dataRow);
        ...
        protected virtual object GetExportedValue(DataRowView drv, string columnName, DataRow dataRow)
        {
