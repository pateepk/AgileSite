...
namespace CMS.DataEngine
{
    ...
    public class ObjectTypeSequenceAnalyzer
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="ObjectTypeSequenceAnalyzer"/> class.
        /// </summary>
        ...
        public ObjectTypeSequenceAnalyzer(IObjectTypeFilter filter, IEnumerable<string> types)
        {
            ...
            ObjectTypes = AvailableTypes.Where(t => ObjectTypeFilter.IsIncludedType(t));
            ...
            foreach (var objectType in objectTypes)
            {
                ...
                if (ti == null)
                {
                    var message =
                        ...
                        $"This error can be caused by materialization of elements from the tail of the sequence when metadata from head elements of the sequence were not processed.";
