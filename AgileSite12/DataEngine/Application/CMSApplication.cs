...
namespace CMS.DataEngine
{
    ...
    public class CMSApplication
    {
        ...
        private static void ReportApplicationInitError(string message = null)
        {
            ...
            if (SystemContext.IsCMSRunningAsMainApplication && (CMSHttpContext.Current != null))
            {
                CMSHttpContext.Current.Server.Transfer("~/CMSMessages/error.aspx");
            }
            else
            {
        ...
        private static bool RecoverFromFailedInitialization()
        {
            ...
            if ((RecoveryTime != null) && (CMSHttpContext.Current != null) && (DateTime.Now > RecoveryTime))
            {
        ...
        public static bool InstallRedirect(bool forceRedirect)
        {
            ...
            if (forceRedirect || !ConnectionHelper.IsConnectionStringInitialized)
            {
                ...
                if (install)
                {
                    ...
                    if ((CMSHttpContext.Current == null) || !SystemContext.IsCMSRunningAsMainApplication)
                    {
                        ReportApplicationInitError(
