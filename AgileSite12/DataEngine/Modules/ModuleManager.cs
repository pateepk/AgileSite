...
namespace CMS.DataEngine
{
    ...
    public class ModuleManager : ModuleEntryManager
    {
        ...
        public static void RemoveReadOnlyObject(string objectType, bool logTask)
        {
            ...
            if (logTask)
            {
                WebFarmHelper.CreateTask(new RemoveReadOnlyObjectWebFarmTask { ObjectType = objectType });
            }
        }
        ...
        public static void ClearReadOnlyObjects(bool logTask)
        {
            ...
            if (logTask)
            {
                WebFarmHelper.CreateTask(new ClearReadOnlyObjectsWebFarmTask());
            }
        }
        ...
        public static void ClearHashtables(bool logTasks = true)
        {
            ...
            if (logTasks)
            {
                WebFarmHelper.CreateTask(new ClearHashtablesWebFarmTask());
            }
        }
