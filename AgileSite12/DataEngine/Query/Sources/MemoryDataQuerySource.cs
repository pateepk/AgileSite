            ...
            try
            {
                ...
                foreach (DataTable dt in sourceData.Tables)
                {
                    ...
                    else
                    {
                        ...
                        if (columnsSet && IsCountColumn(columns))
                        {
...
",
        ...
        private static bool IsCountColumn(string columns)
        {
            // exact match is not enough as the column string could contain alias
            return columns.Trim().Contains("COUNT(*)");
        }
