...
namespace CMS.DataEngine
{
    ...
    public class ProviderDictionary<TKey, TValue> : IProviderDictionary<TKey, TValue>
    {
        ...
        public virtual void Invalidate(bool logTask)
        {
            ...
            if (logTask && LogWebFarmTasks)
            {
                LogWebFarmTask(AbstractProviderDictionary.COMMAND_INVALIDATE, "");
            }
        }
        ...
        public void Clear(bool logTask)
        {
            ...
            if (logTask && LogWebFarmTasks)
            {
                LogWebFarmTask(AbstractProviderDictionary.COMMAND_CLEAR, "");
            }
        }
        ...
        {
            WebFarmService.CreateTask(new DictionaryCommandWebFarmTask
            {
                TaskTarget = Name,
                TaskTextData = taskTextData
            });
        }
