...
namespace CMS.DataEngine
{
    ...
    public static class AbstractProviderDictionary
    {
        ...
        public static string GetDictionaryDisplayName(IProviderDictionary dict)
        {
            ...
            string name = CoreServices.Localization.GetAPIString(resStringKey, null, String.Empty);
            ...
            if (String.IsNullOrEmpty(name))
            {
                ...
                if (obj != null)
                {
                    ...
                    {
                        var localization = CoreServices.Localization;
                        name = String.Format(localization.GetString(res), localization.GetString(TypeHelper.GetTasksResourceKey(dict.ObjectType)));
                    }
                }
            }
