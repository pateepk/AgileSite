    ...
    public class DataTypeManager
    {
        ...
        private static void RegisterSystemTypes()
        {
            RegisterDataTypesInternal(true,
                ...
                new DataType<int>("int", FieldDataType.Integer, "xs:int", ValidationHelper.GetInteger, (value, culture) => ValidationHelper.IsInteger(value))
                {
                    TypeAlias = "int",
                    SqlValueFormat = PLAIN,
                    MaxValueLength = 11,
                ...
                new DataType<long>("bigint", FieldDataType.LongInteger, "xs:long", ValidationHelper.GetLong, (value, culture) => ValidationHelper.IsLong(value))
                {
                    TypeAlias = "long",
                    SqlValueFormat = PLAIN,
                    MaxValueLength = 20,
                ...
                new DataType<double>("float", FieldDataType.Double, "xs:double", ValidationHelper.GetDouble, (value, culture) => ValidationHelper.IsDouble(value, culture?.Name))
                {
                    CodeValueFormat = "{0}d",
                    DefaultValue = 0d,
                    DefaultValueCode = "0d",
                ...
                new DataType<DateTime>("datetime2", FieldDataType.DateTime, "xs:dateTime", ValidationHelper.GetDateTime, ValidationHelper.IsDateTime)
                {
                ...
                new DataType<Guid>("uniqueidentifier", FieldDataType.Guid, "xs:string", ValidationHelper.GetGuid, (value, culture) => ValidationHelper.IsGuid(value))
                {
                    DefaultValueCode = "Guid.Empty",
                    TypeGroup = "Guid",
                },
                new DataType<decimal>("decimal", FieldDataType.Decimal, "xs:decimal", ValidationHelper.GetDecimal, (value, culture) => ValidationHelper.IsDecimal(value, culture?.Name))
                {
                    TypeAlias = "decimal",
                    SqlValueFormat = PLAIN,
                    CodeValueFormat = "{0}m",
                ...
                new DataType<TimeSpan>("time", FieldDataType.TimeSpan, "xs:duration", ValidationHelper.GetTimeSpan, ValidationHelper.IsTimeSpan)
                {
            ...
            RegisterDataTypesInternal(false,
                ...
                new DataType<DateTime>("date", FieldDataType.Date, "xs:dateTime", ValidationHelper.GetDate, ValidationHelper.IsDateTime)
                {
