...
namespace CMS.Search.Azure
{
    ...
    public class DocumentCreator
    {
        ...
        /// <summary>
        /// Creates an Azure Search <see cref="Document"/> for given <paramref name="searchDocument"/>. The <paramref name="searchable"/>, <paramref name="searchIndex"/> and <paramref name="fields"/> parameters
        ...
        /// <param name="fields">Enumeration of Azure Search fields corresponding to the <paramref name="searchable"/>.</param>
        /// <returns>Returns Azure Search document for <paramref name="searchable"/>.</returns>
        public Document CreateDocument(SearchDocument searchDocument, ISearchable searchable, ISearchIndexInfo searchIndex, IEnumerable<Field> fields = null)
        {
            ...
            using (var h = CreatingDocument.StartEvent(eventArgs))
            {
                ...
                {
                    AddDocumentValue(eventArgs.Document, eventArgs.SearchDocument, name, searchable, searchIndex, eventArgs.Fields);
                }
        ...
        /// <param name="fields">Enumeration of Azure Search fields defined in the index the resulting document belongs to.</param>
        private void AddDocumentValue(Document document, SearchDocument searchDocument, string name, ISearchable searchable, ISearchIndexInfo searchIndex, IEnumerable<Field> fields)
        {
