...
namespace CMS.FormEngine.Web.UI
{
    ...
    public class Html5InputFormControl : FormEngineUserControl
    {
        ...
        {
            return IsCheckbox(type) ? (HtmlInputControl)new HtmlInputCheckBox { EnableViewState = false } : new HtmlInputGenericControl { EnableViewState = false };
        }


        /// <summary>
        /// Adds class and style attributes to input control considering
        /// <see cref="FormEngineUserControl.CssClass"/> and <see cref="FormEngineUserControl.ControlStyle"/> values.
        /// </summary>
        private void AddStyleAttributes()
        {
            ...
            if (!String.IsNullOrEmpty(CssClass))
            {
                ...
                // atribute is propagated to input, keeping value renders wrapping div with duplicite attributes
                CssClass = null;
            }
            ...
            {
                Input.Attributes["style"] = ControlStyle;
