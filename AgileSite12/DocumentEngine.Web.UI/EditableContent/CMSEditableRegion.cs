...
namespace CMS.DocumentEngine.Web.UI
{
    ...
    public class CMSEditableRegion : CMSAbstractEditableControl, INamingContainer
    {
        ...
        /// <summary>
        /// Creates configuration for on-site editting.
        /// </summary>
        protected override OnSiteEditStartTagConfiguration GetOnSiteTagConfiguration()
        {
            var baseConfig = base.GetOnSiteTagConfiguration();
            baseConfig.WebPartTitle = RegionTitle;
            return baseConfig;
        }
