...
namespace CMS.DocumentEngine.Web.UI
{
    ...
    public class TransformationMethods : MacroMethodContainer
    {
        ...
        /// <param name="context">Evaluation context with child resolver</param>
        /// <param name="parameters">Method parameters</param>
        [MacroMethod(typeof(string), "Returns URL to current search result item.", 2)]
        ...
        public static object GetSearchImageUrl(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 2:
                    return TransformationHelper.HelperObject.GetSearchImageUrl((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetString(parameters[0], ""), ValidationHelper.GetInteger(parameters[1], 0));
        ...
        public static object SearchHighlight(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 3:
                    return TransformationHelper.HelperObject.SearchHighlight((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetString(parameters[0], ""), ValidationHelper.GetString(parameters[1], ""), ValidationHelper.GetString(parameters[2], ""));
        ...
        /// <param name="context">Evaluation context with child resolver</param>
        /// <param name="parameters">Method parameters</param>
        [MacroMethod(typeof(string), "Returns content parsed as XML if required and removes dynamic controls.", 1)]
        ...
        public static object GetSearchedContent(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 1:
                    return TransformationHelper.HelperObject.GetSearchedContent((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetString(parameters[0], ""));
        ...
        /// <param name="context">Evaluation context with child resolver</param>
        /// <param name="parameters">Method parameters</param>
        [MacroMethod(typeof(object), "Returns column value for current search result item.", 1)]
        ...
        public static object GetSearchValue(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 1:
                    return TransformationHelper.HelperObject.GetSearchValue((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetString(parameters[0], ""));
        ...
        /// <param name="context">Evaluation context with child resolver</param>
        /// <param name="parameters">Method parameters</param>
        [MacroMethod(typeof(string), "Returns URL for current search result.", 0)]
        ...
        public static object SearchResultUrl(EvaluationContext context, params object[] parameters)
        {
            ...
            {
                case 0:
                    return TransformationHelper.HelperObject.SearchResultUrl((SearchResultItem)context.Resolver.SourceObject, false);
                case 1:
                    return TransformationHelper.HelperObject.SearchResultUrl((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetBoolean(parameters[0], false));
                case 2:
                    return TransformationHelper.HelperObject.SearchResultUrl((SearchResultItem)context.Resolver.SourceObject, ValidationHelper.GetBoolean(parameters[0], false), ValidationHelper.GetBoolean(parameters[1], true));
