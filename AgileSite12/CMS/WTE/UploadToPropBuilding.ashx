<%@ WebHandler Language="C#" Class="UploadToPropBuilding" %>
...
/// <summary>
/// Summary description for UploadToPropBuilding
/// </summary>
public class UploadToPropBuilding : Telerik.Web.UI.CloudUploadHandler
{

    public override void SetKeyName(object sender, Telerik.Web.UI.CloudUpload.SetKeyNameEventArgs e)
    {
        var customFolder = "building/";
