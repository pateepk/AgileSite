...
{
    /// <summary>
    /// Web part for managing the "Associated Account"
    /// Add/Edit/Remove
    /// </summary>
    public partial class Slipcash_Manage_Associated_Account : CMSAbstractWebPart
    {
        ...
        public class AssociatedAccountData
        {
            ...
            public string AsscociatedMemberID { get; set; }
        ...
        /// </summary>
        public class AssociatedAccountManageData
        {
            /// <summary>
            /// The action.
            /// </summary>
        ...
        /// The primary key
        /// </summary>
        public string AssociatedAccountIDColumnKey
        {
            get
            {
                return GetStringProperty("AssociatedAccountIDColumnKey", "ItemID");
            }
            set
            {
                this.SetValue("AssociatedAccountIDColumnKey", value);
            }
        }

        /// <summary>
        /// MemberUserID column key
        /// </summary>
        public string MemberUserIDColumnKey
        {
            get
            {
                return GetStringProperty("MemberUserIDColumnKey", "MemberUserID");
            }
            set
            {
                this.SetValue("MemberUserIDColumnKey", value);
            }
        }

        /// <summary>
        /// MemberID ID column key
        /// </summary>
        ...
        /// MemberHandle column
        /// </summary>
        public string MemberHandleColumnKey
        {
            get
            {
                return GetStringProperty("MemberHandleColumnKey", "MemberHandle");
            }
            set
            {
                this.SetValue("MemberHandleColumnKey", value);
            }
        }
        ...
        public string AssociatedUserIDColumnKey
        {
            get
            {
                return GetStringProperty("AssociatedUserIDColumnKey", "AssociatedUserID");
            }
            set
            {
                this.SetValue("AssociatedUserIDColumnKey", value);
            }
        }
        ...
        /// AssociatedMemberID
        /// </summary>
        public string AssociatedMemberIDColumnKey
        {
            get
            {
                return GetStringProperty("AssociatedMemberIDColumnKey", "AssociatedMemberIDHandle");
            }
            set
            {
                this.SetValue("AssociatedMemberIDColumnKey", value);
            }
        }
        ...
        protected bool ProcessUpdatePaymentProfile()
        {
            ...
            AssociatedAccountManageData managedata = GetJSONPostedData<AssociatedAccountManageData>(null);
