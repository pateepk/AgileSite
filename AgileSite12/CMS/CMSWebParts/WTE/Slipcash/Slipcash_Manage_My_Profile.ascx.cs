...
{
    /// <summary>
    /// Web part for managing the "My Pay Profile Page"
    /// Save/Edit, etc
    /// </summary>
    public partial class Slipcash_Manage_My_Profile : CMSAbstractWebPart
    {
        #region "Custom Classes"

        /// <summary>
        /// Data from updating/adding payment methods.
        /// </summary>
        public class UserPaymentMethodData
        {
        ...
        /// </summary>
        public class MyProfileManageData
        {
            /// <summary>
            /// The action.
            /// </summary>
            ...
            public List<UserPaymentMethodData> PaymentMethodData { get; set; }
        ...
        #region "MemberToPayment" 

        /// <summary>
        /// The primary key
        /// </summary>
        public string UserPaymentMethodIDColumnKey
        {
            get
            {
                return GetStringProperty("UserPaymentMethodIDColumnKey", "ItemID");
            }
            set
            {
                this.SetValue("UserPaymentMethodIDColumnKey", value);
            }
        }

        /// <summary>
        /// Playlist ID column key
        /// </summary>
        public string MemberIDColumnKey
        {
            get
            {
                return GetStringProperty("MemberIDColumnKey", "MemberID");
            }
            set
            {
                this.SetValue("MemberIDColumnKey", value);
            }
        }
        ...
        /// </summary>
        public string UserIDColumnKey
        {
            get
            {
                return GetStringProperty("UserIDColumnKey", "UserID");
            }
            set
            {
                this.SetValue("UserIDColumnKey", value);
            }
        }
        ...
        /// </summary>
        public string PaymentTypeIDColumnKey
        {
            get
            {
                return GetStringProperty("PaymentTypeIDColumnKey", "PaymentTypeID");
            }
            set
            {
                this.SetValue("PaymentTypeIDColumnKey", value);
            }
        }

        /// <summary>
        /// PaymentLink (The value of the MemberToPayment Record)
        /// </summary>
        public string PaymentLinkColumnKey
        {
            get
            {
                return GetStringProperty("PaymentLinkColumnKey", "PaymentLink");
            }
            set
            {
                this.SetValue("PaymentLinkColumnKey", value);
            }
        }

        /// <summary>
        /// Column indicating the item is enabled.
        /// </summary>
        public string IsEnabledColumnKey
        {
            get
            {
                return GetStringProperty("IsEnabledColumnKey", "IsEnabled");
            }
            set
            {
                this.SetValue("IsEnabledColumnKey", value);
            }
        }
        ...
        protected bool ProcessUpdatePaymentProfile()
        {
            ...
            MyProfileManageData managedata = GetJSONPostedData<MyProfileManageData>(null);
            ...
            if (managedata != null)
            {
                ...
                try
                {
                    ...
                    List<UserPaymentMethodData> paymentData = managedata.PaymentMethodData;

                    if (paymentData != null && paymentData.Count > 0)
                    {
                        foreach (UserPaymentMethodData pdata in paymentData)
                        {
        ...
        /// <summary>
        /// Insert/Update (Save) the uesr payment method data
        /// </summary>
        /// <param name="p_data"></param>
        /// <param name="p_message"></param>
        /// <returns></returns>
        public bool SaveUserPaymentMethod(UserPaymentMethodData p_data, out string p_message)
        {
            bool ret = false;

            CustomTableItem item = GetCustomTableItem(p_data.UserPaymentMethodID, out p_message);
            if (item != null)
            {
                ...
                item.ItemModifiedWhen = DateTime.Now;
                if (item.ItemGUID == null || item.ItemGUID == Guid.Empty)
                {
                    item.ItemGUID = new Guid();
                }
                item.Update();
            }
            else
