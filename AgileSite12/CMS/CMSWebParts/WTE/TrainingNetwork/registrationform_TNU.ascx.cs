...
{
    public partial class registrationform_TNU : CMSAbstractWebPart
    {
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (template != null)
                {
                    ...
                    //var resolver = MembershipResolvers.GetMembershipRegistrationResolver(ui, passStrength.Text);
                    //var resolver = GetForgottenPasswordResolver.GetMembershipRegistrationResolver(ui, passStrength.Text, "https://www.trainingnetworknow.com/");
                    var resolver = MembershipResolvers.GetForgottenPasswordResolver(ui, passStrength.Text, "https://www.trainingnetworknow.com/");
