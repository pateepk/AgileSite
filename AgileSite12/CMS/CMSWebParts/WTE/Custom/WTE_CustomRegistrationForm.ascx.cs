...
{
    public partial class WTE_CustomRegistrationForm : CMSAbstractWebPart
    {
        #region "classes"
        ...
        public class CustomRegistrationData
        {
            ...
            private string _sprocName = String.Empty;
            ...
            /// <summary>
            /// Sproc to execute to get registration info
            /// </summary>
            public string SprocName
            {
                get
                {
                    return !String.IsNullOrWhiteSpace(_sprocName) ? _sprocName: "custom_GetRegistrationInformation";
                }
                set
                {
                    _sprocName = value;
            ...
            /// <summary>
            /// lookup key for the registration data
            /// </summary>
            public string LookupKey
            {
                get
                {
                    return !String.IsNullOrWhiteSpace(_lookupKey) ? _lookupKey : "UserID";
                }
                set
                {
                    _lookupKey = value;
            ...
            /// </summary>
            /// <param name="p_lookup"></param>
            /// <returns></returns>
            public void SetRegistrationInformation(string p_lookup)
            {
                DataSet ds = null;
                try
                {
                    ...
                    QueryParameters qp = new QueryParameters(SprocName, parameters, QueryTypeEnum.StoredProcedure, false);
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (row != null)
                        {
                            FirstName = GetStringOrNull(row["FirstName"]);
                            LastName = GetStringOrNull(row["LastName"]);
                            FullName = GetStringOrNull(row["FullName"]);
                            UserRoles = GetStringOrNull(row["UserRoles"]);
                        }
                    }
                }
                catch (Exception ex)
        ...
        public string UserID
        {
            get
            {
                string ret = ValidationHelper.GetString(GetValue("UserID"), String.Empty);
        ...
        /// <summary>
        /// Enabled Custom registration data
        /// </summary>
        public bool EnableCustomRegistrationData
        {

            get
            {
                return ValidationHelper.GetBoolean(GetValue("EnableCustomRegistrationData"), true);
            }
            set
            {
                SetValue("EnableCustomRegistrationData", value);
            }
        }

        /// <summary>
        /// name of the store procedure that pull the registration data
        /// </summary>
        public string CustomRegistrationDataSprocName
        {
            get
            {
                return ValidationHelper.GetString(GetValue("CustomRegistrationDataSprocName"), String.Empty);
            }
            set
            {
                SetValue("CustomRegistrationDataSprocName", value);
            }
        }

        /// <summary>
        /// Custom registration data look up key
        /// </summary>
        public string CustomRegistrationDataLookupKey
        {
            get
            {
                return ValidationHelper.GetString(GetValue("CustomRegistrationDataLookupKey"), String.Empty);
            }
            set
            {
                SetValue("CustomRegistrationDataLookupKey", value);
            }
        }
        ...
        protected void SetupControl()
        {
            ...
            else
            {
                ...
                if (afi != null)
                {
                    ...
                    {
                        formUser.CssClass = FormCSSClass;
                    }
        ...
        private void formUser_OnAfterSave(object sender, EventArgs e)
        {
            ...
            UserInfo currentUi = UserInfoProvider.GetUserInfo(MembershipContext.AuthenticatedUser.UserID);
            if (ui.Enabled)
            {
                if (currentUi.UserID != ui.UserID)
                {
        ...
        private void SendRegistrationEmail(UserInfo ui)
        {
            ...
            if (template != null)
            {
                ...
                try
                {
                    ...
                    string pw = ValidationHelper.GetString(ui.GetValue("UserPassword"), String.Empty);
                    MacroResolver resolver = MembershipResolvers.GetForgottenPasswordResolver(ui, pw, AuthenticationHelper.GetRegistrationApprovalUrl(ApprovalPage, ui.UserGUID, CurrentSiteName, NotifyAdministrator));
