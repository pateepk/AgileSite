<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSApp.CMSWebParts.WTE.Custom.WTE_CustomRegistrationForm" CodeBehind="WTE_CustomRegistrationForm.ascx.cs" %>
