<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WTE_LogonForm.ascx.cs" Inherits="CMSApp.CMSWebParts.WTE.Custom.WTE_LogonForm" %>
...
<asp:Panel ID="pnlBody" runat="server" CssClass="logon-page-background">
    ...
    <cms:CMSUpdatePanel runat="server" ID="pnlUpdatePasswordRetrievalLink" UpdateMode="Conditional" class="logon-password-retrieval">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlPasswdRetrieval" runat="server" CssClass="logon-panel-password-retrieval" DefaultButton="btnPasswdRetrieval" Visible="False">
                ...
                <div class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <asp:Label ID="lblPasswordRetrievalInstruction" class="explanation-text" runat="server"></asp:Label>
                    </div>
                    <%-- Form End --%>
                </div>
    ...
    <cms:CMSUpdatePanel runat="server" ID="pnlUpdatePasswordRetrievalResult" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlPasswordRetrievalResult" runat="server" CssClass="logon-panel-password-retrieval" Visible="False">
                <asp:Label ID="lblResult" runat="server" Visible="false" EnableViewState="false" CssClass="logon-password-retrieval-result" />
            </asp:Panel>
        </ContentTemplate>
        <Triggers>
            <asp:AsyncPostBackTrigger EventName="Click" ControlID="btnPasswdRetrieval" />
            <asp:AsyncPostBackTrigger EventName="Click" ControlID="lnkPasswdRetrieval" />
        </Triggers>
    </cms:CMSUpdatePanel>
