<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSApp.CMSWebParts.WTE.Custom.Modules.UserControl.WTE_ChangePassword" Codebehind="WTE_ChangePassword.ascx.cs" %>
<%@ Register Src="../FormControl/WTE_PasswordStrength.ascx" TagName="PasswordStrength" TagPrefix="cms" %>
