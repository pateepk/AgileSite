...
namespace CMSApp.CMSWebParts.WTE.Custom.Modules.UserControls
{
    public partial class WTE_MyProfile : CMSUserControl
    {
        public class WTEUserInfo : UserInfo
        {
            public WTEUserInfo(UserInfo ui)
                :base(ui, false, false)
            {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if ((MembershipContext.AuthenticatedUser != null) && AuthenticationHelper.IsAuthenticated())
            {
                ...
                editProfileForm.SubmitButton.CssClass = "btn btn-dark";
                editProfileForm.FormButtonCssClass = "btn btn-dark";
                // reauthenticate the user
                //AuthenticationHelper.AuthenticateUser(MembershipContext.AuthenticatedUser.UserName, true);
                // Get up-to-date info of current user and use it for the form
                string username = MembershipContext.AuthenticatedUser.UserName;
                //CurrentUserInfo cur = MembershipContext.AuthenticatedUser;
                //bool complete = cur.IsComplete;
                //string test0 = (string)cur.GetValue("UserSlipcashID");
                ...
                //string test1 = (string)ui.GetValue("UserSlipcashID");
                ////ui = new CurrentUserInfo(ui, false);
                //ui = new UserInfo(ui, false, false);
                //string test2 = (string)ui.GetValue("UserSlipcashID");
                //ui.MakeComplete(true);

                WTEUserInfo resetuser = new WTEUserInfo(ui);
                resetuser.ResetUserInfo();
                ui = UserInfoProvider.GetFullUserInfo(username);

                if (ui != null)
                {
                    string test3 = (string)ui.GetValue("UserSlipcashID");
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            //editProfileForm.FormButtonPanelCssClass = "";
            //editProfileForm.FormButtonCssClass = "btn btn-dark";
            //editProfileForm.SubmitButton.CssClass = "btn btn-dark";
            //editProfileForm.SubmitButton.ResourceString = "test";
            //editProfileForm.SubmitButton.Text = "test";
