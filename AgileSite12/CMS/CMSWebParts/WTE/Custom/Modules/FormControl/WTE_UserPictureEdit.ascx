<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSApp.CMSWebParts.WTE.Custom.Modules.WTE_UserPictureEdit" Codebehind="WTE_UserPictureEdit.ascx.cs" %>

<%@ Reference Control="WTE_UserPicture.ascx" %>
