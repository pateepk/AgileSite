...
{
    public partial class WTE_TagCloud : CMSAbstractWebPart
    {
        #region "Variables"
                        ...
                        if (cs.LoadData)
                        {
                            ...
                            if (!DataHelper.DataSourceIsEmpty(ds))
                            {
                                ...
                                foreach (DataRow dr in ds.Tables[0].Rows)
                                {
                                    ...
                                    sb.Append("<span><a href=\"" + HTMLHelper.HTMLEncode(paramUrl) + "\"  style=\"font-size:" + pixelSize.ToString() + "px;\" rel=\"nofollow\">" + HTMLHelper.HTMLEncode(dr["TagName"].ToString()) + "</a></span>");
