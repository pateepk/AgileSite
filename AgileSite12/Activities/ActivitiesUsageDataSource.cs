...
namespace CMS.Activities
{
    ...
    internal class ActivitiesUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("ActivitiesSettingsUsageOnSites", JsonConvert.SerializeObject(GetSettingsUsage(global: false), settings));
            usageData.Add("ActivitiesSettingsUsageGlobal", JsonConvert.SerializeObject(GetSettingsUsage(global: true).Select(s => new { s.KeyName, s.KeyValue }), settings));
