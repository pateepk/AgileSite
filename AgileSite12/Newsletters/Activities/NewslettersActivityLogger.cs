...
[assembly: RegisterImplementation(typeof(INewslettersActivityLogger), typeof(NewslettersActivityLogger), Priority = RegistrationPriority.SystemDefault, Lifestyle = Lifestyle.Singleton)]
...
namespace CMS.Newsletters
{
    ...
    /// </summary>
    public class NewslettersActivityLogger : INewslettersActivityLogger
    {
        ...
        private void AddContactToActivityAndLogIfEnabled(IActivityInitializer activityInitializer, bool logActivity, int? contactId, bool loggingDisabledInAdministration = true)
        {
            ...
            if (logActivity && request != null)
            {
                activityInitializer = contactId.HasValue ? activityInitializer.WithContactId(contactId.Value) : activityInitializer;
                mActivityLogService.Log(activityInitializer, request, loggingDisabledInAdministration);
            }
        }
    }
}
