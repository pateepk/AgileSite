...
namespace CMS.Newsletters
{
    ...
    internal class NewsletterHandlers
    {
        ...
        {
            WebFarmHelper.RegisterTask<EmailsEnabledSettingChangedWebFarmTask>();
            WebFarmHelper.RegisterTask<ClearLicenseLimitationCacheWebFarmTask>();

            SettingsKeyInfoProvider.OnSettingsKeyChanged += EmailsEnabledSettingChanged;
        ...
        /// </summary>
        private static void EmailsEnabledSettingChanged(object sender, SettingsKeyChangedEventArgs e)
        {
            if ((String.Equals(e.KeyName, "CMSEmailsEnabled", StringComparison.OrdinalIgnoreCase) || String.Equals(e.KeyName, "CMSGenerateNewsletters", StringComparison.OrdinalIgnoreCase))
                && !e.KeyValue.ToBoolean(false))
            {
                ThreadEmailSender.NotifyEmailsEnabledSettingChanged();
            }
        }
        ...
        private static void SubscriberClicksTrackedLink(object sender, LinksEventArgs e)
        {
            ...
            Service.Resolve<INewslettersActivityLogger>().LogNewsletterClickThroughActivity(originalURL, issue, newsletter, contactID);
        }
        ...
        private static void SubscriberOpensEmail(object sender, LinksEventArgs e)
        {
            ...
            Service.Resolve<INewslettersActivityLogger>().LogNewsletterOpenedEmailActivity(issue, newsletter, contactID);
        }
        ...
        private static void LogNewsletterUnsubscribingFromAllActivity(object sender, UnsubscriptionEventArgs e)
        {
            ...
            if (contactID > 0)
            {
                ...
                Service.Resolve<INewslettersActivityLogger>().LogUnsubscribeFromAllNewslettersActivity(issue, contactID);
            }
        }
