...
namespace CMS.Newsletters
{
    ...
    public class SubscriberInfoProvider : AbstractInfoProvider<SubscriberInfo, SubscriberInfoProvider>
    {
                ...
                case PredefinedObjectType.CONTACT:
                    {
                        ...
                        var subscriberMember = CreateSubscriberFromContact(subscriber.SubscriberRelatedID, subscriber);
                ...
                case PredefinedObjectType.CONTACTGROUP:
                    {
                        ...
                        var contacts = ContactGroupMemberInfoProvider.GetContactGroupMembers(subscriber.SubscriberRelatedID, monitoringEnabled, bounceLimit)
                                                                     .Columns("ContactID, ContactFirstName, ContactLastName, ContactEmail")
                                                                     .TopN(topN);
        ...
        private static SubscriberInfo GetSubscriberForNewsletterFromContactGroupByEmail(ICollection<int> newsletterSubscribersIds, string email)
        {
            ...
            return subscriber != null ? CreateSubscriberFromContact(contact.ContactID, subscriber) : null;
        }
        ...
        internal static SubscriberInfo CreateSubscriberFromContact(int contactId, SubscriberInfo original)
        {
            ...
            return InitializeSubscriberFromContact(original, contact);
        }
        ...
        private static SubscriberInfo InitializeSubscriberFromContact(SubscriberInfo original, ContactInfo contact)
        {
            return new SubscriberInfo(original, false)
            {
                SubscriberID = string.Equals(original.SubscriberType, PredefinedObjectType.CONTACT, StringComparison.InvariantCultureIgnoreCase) ? original.SubscriberID : 0,
                SubscriberEmail = contact.ContactEmail ?? original.SubscriberEmail,
