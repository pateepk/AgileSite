...
namespace CMS.ContactManagement
{
    ...
    internal class ScoringUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("ScoringRulesCountPerRuleType", JsonConvert.SerializeObject(GetNumberOfRulesInScoresGroupedByType(), settings));
            usageData.Add("NumberOfContactsInEachScore", JsonConvert.SerializeObject(GetNumberOfContactsInEachScore(), settings));
