...
namespace CMS.ContactManagement
{
    ...
    internal class ContactGroupUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("NumberContactInContactGroup", JsonConvert.SerializeObject(GetContactsCountPerContactGroup(), new JsonSerializerSettings { StringEscapeHandling = StringEscapeHandling.EscapeHtml }));
