...
namespace CMS.DocumentEngine
{
        ...
        where TObject : TreeNode, new()
    {
        ...
        /// </summary>
        /// <param name="latest">If set to false, the method has the same behavior as the <see cref="PublishedVersion"/> method.</param>
        ...
        /// </summary>
        /// <param name="published">If set to false, the method has the same behavior as the <see cref="LatestVersion"/> method.</param>
