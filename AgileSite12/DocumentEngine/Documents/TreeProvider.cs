...
namespace CMS.DocumentEngine
{
    ...
    public class TreeProvider
    {
        ...
        public virtual bool CombineWithDefaultCulture
        {
            ...
            set => mCombineWithDefaultCulture = value;
        }
        ...
        public virtual string PreferredCultureCode
        {
            ...
            set => mPreferredCultureCode = value;
        }
        ...
        /// </summary>
        public bool SortMergedResults { get; set; } = true;
        ...
        {
            get => mSynchronizeFieldValues && DocumentActionContext.CurrentUseAutomaticOrdering;
            set => mSynchronizeFieldValues = value;
        }
        ...
        public bool UseAutomaticOrdering
        {
            ...
            set => mUseAutomaticOrdering = value;
        }
        ...
        /// </summary>
        public bool UseCustomHandlers { get; set; } = true;


        /// <summary>
        /// If true, new GUID is generated for the inserted nodes where required.
        /// </summary>
        public bool GenerateNewGuid { get; set; } = true;
        ...
        /// </summary>
        public bool EnsureSafeNodeAlias { get; set; } = true;
        ...
        /// </summary>
        public bool CheckUniqueAttachmentNames { get; set; } = true;
        ...
        {
            get => mUpdateTimeStamps && CMSActionContext.CurrentUpdateTimeStamp;
            set => mUpdateTimeStamps = value;
        }
        ...
        {
            get => mUpdateUser && CMSActionContext.CurrentUpdateSystemFields;
        ...
        /// </summary>
        public bool UpdateSKUColumns { get; set; } = true;


        /// <summary>
        /// If true, document content is updated from internal objects.
        /// </summary>
        public bool UpdateDocumentContent { get; set; } = true;
        ...
        {
            get => mLogEvents && CMSActionContext.CurrentLogEvents;
            set => mLogEvents = value;
        }
        ...
        {
            get => mLogSynchronization && CMSActionContext.CurrentLogSynchronization;
            set => mLogSynchronization = value;
        }
        ...
        {
            get => mLogIntegration && CMSActionContext.CurrentLogIntegration;
            set => mLogIntegration = value;
        }
        ...
        {
            get => mTouchCacheDependencies && CMSActionContext.CurrentTouchCacheDependencies;
            set => mTouchCacheDependencies = value;
        }
        ...
        {
            get => mLogWebFarmTasks && CMSActionContext.CurrentLogWebFarmTasks;
            set => mLogWebFarmTasks = value;
        }
        ...
        /// </summary>
        public bool SelectAllData { get; set; } = true;
        ...
        {
            get => mEnableNotifications && CMSActionContext.CurrentSendNotifications;
            set => mEnableNotifications = value;
        }
        ...
        {
            get => mEnableRating && CMSActionContext.CurrentUpdateRating;
            set => mEnableRating = value;
        }
        ...
        {
            get => mAllowAsyncActions && CMSActionContext.CurrentAllowAsyncActions;
            set => mAllowAsyncActions = value;
        }
        ...
        {
            get => mEnableDocumentAliases && DocumentActionContext.CurrentGenerateDocumentAliases;
            set => mEnableDocumentAliases = value;
        }
        ...
        {
            get => mHandleACLs && DocumentActionContext.CurrentHandleACLs;
            set => mHandleACLs = value;
        }
        ...
        public virtual bool UseParentNodeGroupID
        {
            ...
            set => mUseParentNodeGroupID = value;
        }
        ...
        /// </summary>
        internal bool UpdateUrlPath { get; set; } = true;
        ...
        /// </summary>
        internal bool UpdateNodeName { get; set; } = true;
        ...
        public DataSet AttachmentSearch(SearchParameters parameters, List<int> siteIds, out List<string> highlights)
        {
            // Get SQL clauses
            ...
            if (clauses != null)
            {
                ...
                highlights = clauses.HighlightedWords;
            }
        ...
        internal void ChangeRelatedObjectsSite(TreeNode node, int targetSiteId)
        {
            ...
            var originalSiteId = (int)node.GetOriginalValue("NodeSiteID");
            var originalSite = SiteInfoProvider.GetSiteInfo(originalSiteId);

            // NodeSiteID is already updated to target site ID. Non-content-only sites cannot have alternative URLs. 
            if (originalSite.SiteIsContentOnly && !node.Site.SiteIsContentOnly)
            {
                ...
                AlternativeUrlInfoProvider.ProviderObject.BulkDelete(new WhereCondition().WhereIn("AlternativeURLDocumentID", allDocumentIds));
            }
            ...
            {
                bool shouldMoveAlternativeUrls = originalSite.SiteIsContentOnly && node.Site.SiteIsContentOnly;

                // Handle current document
                ChangeDocumentRelatedObjectsSite(node, targetSiteId, shouldMoveAlternativeUrls);
                ...
                foreach (var doc in documents)
                {
                    ...
                    ChangeDocumentRelatedObjectsSite(doc, targetSiteId, shouldMoveAlternativeUrls);
                }
            }
        }
        ...
        private void ChangeDocumentRelatedObjectsSite(TreeNode node, int targetSiteId, bool shouldMoveAlternativeUrls)
        {
            ...
            if (shouldMoveAlternativeUrls)
            {
                MoveAlternativeUrls(node, targetSiteId);
            }
        }
        ...
        /// <param name="node">Document</param>
        /// <param name="targetSiteId">Target site ID</param>
        private void MoveAlternativeUrls(TreeNode node, int targetSiteId)
        {
            var stringBuilder = new StringBuilder();
            AlternativeUrlInfoProvider.GetAlternativeUrls().WhereEquals("AlternativeURLDocumentID", node.DocumentID).ForEachObject(info =>
            {
                try
                {
                    info.AlternativeUrlSiteID = targetSiteId;
                    AlternativeUrlInfoProvider.SetAlternativeUrlInfo(info);
                }
                catch (Exception ex)
                {
                    stringBuilder.AppendLine($"Alternative URL '{info.AlternativeUrlUrl}' was removed during the cross site page move operation. Reason: {ex.Message}");
                    stringBuilder.AppendLine();
                    AlternativeUrlInfoProvider.DeleteAlternativeUrlInfo(info);
                }
            });
            ...
            if (!String.IsNullOrEmpty(errors))
            {
                ...
                {
                    EventLogProvider.LogEvent(EventType.ERROR, "Content", "CANNOTMOVEALTERNATIVEURLS", errors, siteId: targetSiteId, nodeId: node.NodeID);
                }
            }
        }
