...
Param(
	...
	# Optional name of the output subfolder. If this parameter is missing and the junction name is specified, the junction is created in 'Tests' subfolder.
...
function Update-OutputJunctions
{
    ...
    if ($JunctionName)
    {
        Update-TestOutputJunctionPoint -OutputDirectory $outputDirectory -JunctionName $JunctionName -OutputSubfolder $OutputSubfolder
    }
    else
    {
...
function Update-TestOutputJunctionPoint
{
    ...
    Update-OutputJunction -OutputDirectory $OutputDirectory -SolutionName $subFolder -JunctionName $JunctionName
}
...
Update-OutputJunctions -SolutionDirectory $SolutionDirectory -Configuration $Configuration -JunctionName $JunctionName -OutputSubfolder $OutputSubfolder -Verbose:$VerbosePreference