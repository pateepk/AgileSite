...
namespace CMS.TranslationServices
{
    ...
    public class TranslationServicesModule : Module
    {
        ...
        protected override void OnInit()
        {
            ...
            WebFarmHelper.RegisterTask<ClearHumanTranslationServiceHashtablesWebFarmTask>(true);
            WebFarmHelper.RegisterTask<ClearMachineTranslationServiceHashtablesWebFarmTask>(true);
