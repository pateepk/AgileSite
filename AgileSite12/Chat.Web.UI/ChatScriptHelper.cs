...
namespace CMS.Chat.Web.UI
{
    ...
    public class ChatScriptHelper : AbstractHelper<ChatScriptHelper>
    {
        ...
        {
            // Resolve the URL manually to ensure that it's correctly resolved. The framework resolves the URLs incorrectly in some cases 
            // when current request URL has been rewritten, e.g. on 404 pages.
            RegisterAJAXProxy(page, URLHelper.ResolveUrl("~/CMSModules/Chat/Services/ChatService.svc"));
