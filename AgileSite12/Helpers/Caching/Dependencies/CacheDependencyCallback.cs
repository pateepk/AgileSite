        ...
        where TTarget : class
    {
        ...
        public void PerformCallback()
        {
            ...
            if ((target != null) && (Handler != null))
            {
                ...
                CacheDebug.LogCacheOperation("DoCallback", Key, null, null, CacheConstants.NoAbsoluteExpiration, CacheConstants.NoSlidingExpiration, CMSCacheItemPriority.Normal, false);
            }
        }
