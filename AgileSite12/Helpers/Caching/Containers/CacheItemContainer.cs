...
namespace CMS.Helpers
{
    ...
    /// </summary>
    public class CacheItemContainer : ICacheItemContainer
    {
        #region "Properties"
        ...
        /// Cache priority.
        /// </summary>
        public CMSCacheItemPriority Priority
        {
            get;
            private set;
        }
        ...
        public CacheItemContainer(object value, CMSCacheDependency dependencies, DateTime absoluteExpiration, TimeSpan slidingExpiration, CMSCacheItemPriority priority)
        {
            Data = value;
