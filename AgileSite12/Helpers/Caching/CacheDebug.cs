    ...
    public class CacheDebug
    {
        ...
        private static DataTable NewLogTable()
        {
            ...
            try
            {
                ...
                cols.Add(new DataColumn("CachePriority", typeof(CMSCacheItemPriority)));
        ...
        public static void LogCacheOperation(string operation, string key, object value, CMSCacheDependency dependencies, DateTime absoluteExpiration, TimeSpan slidingExpiration, CMSCacheItemPriority priority, bool useFullKey)
        {
        ...
        /// <param name="slidingExpiration">Sliding expiration</param>
        /// <param name="priority">Priority of the cache item</param>
        public static void LogToFile(string operation, string key, object value, DateTime absoluteExpiration, TimeSpan slidingExpiration, CMSCacheItemPriority priority)
        {
            if (Settings.LogToFile)
            {
                ...
                if (isAdd)
                {
                    ...
                    else if (slidingExpiration != CacheConstants.NoSlidingExpiration)
                    {
