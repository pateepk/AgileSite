...
namespace CMS.Helpers
{
    ...
    public class DataHelper : CoreMethods
    {
        ...
        public static DataSet ReadDataSetFromXml(DataSet ds, XmlReader xml, object[] parameters, string rootNode = "NewDataSet")
        {
            List<string> columns;
            return ReadDataSetFromXml(ds, xml, parameters, rootNode, out columns);
        }
        ...
        /// <param name="parameters">Callback parameters</param>
        public static void WriteDataSetToXml(DataSet ds, XmlWriter xml, string filePathColumn, object[] parameters)
        {
            if (ds == null)
            {
                return;
