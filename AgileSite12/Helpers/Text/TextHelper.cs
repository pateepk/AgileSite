...
namespace CMS.Helpers
{
    ...
    public class TextHelper
    {
        ...
        public static string[] SplitPages(string text, int pageSize, bool processTextDecoded = false)
        {
        ...
        public static string EnsureMaximumLineLength(string text, int maxLength, string separation = "<span></span>", bool encode = false)
        {
            if (text == null)
            {
                return null;
        ...
        public static string ReformatCode(string text, int indent = 0, string indentString = "  ")
        {
            if (String.IsNullOrEmpty(text))
            {
                return text;
