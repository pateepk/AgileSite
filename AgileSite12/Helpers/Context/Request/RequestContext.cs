    ...
    public sealed class RequestContext : AbstractContext<RequestContext>
    {
        ...
        public static Uri URL
        {
            get
            {
                ...
                if (url == null)
                {
                    ...
                    c.mUrl = context.Request.GetEffectiveUrl();
                }
        ...
        public static bool IsSSL
        {
            get
            {
                ...
                if (isSSL == null)
                {
                    isSSL = CurrentURL.StartsWith("https://", StringComparison.OrdinalIgnoreCase);
            ...
            set
            {
                ...
                Current.mIsSslExplicit = value;
            }
        }


        /// <summary>
        /// Gets the value that was explicitly set for <see cref="IsSSL"/> property.
        /// </summary>
        internal static bool? IsSSLExplicit
        {
            get
            {
                return Current.mIsSslExplicit;
            }
        }
        ...
        public static string CurrentDomain
        {
            get
            {
                ...
                if (domain == null)
                {
                    // Get domain
                    var context = CMSHttpContext.Current;
#pragma warning disable BH1006
                    if (context?.Request?.Url == null)
#pragma warning restore BH1006
                    {
                        return String.Empty;
                    }
                    else
...
#pragma warning disable BH1005
                        address = CMSHttpContext.Current.Request.UserHostAddress;
#pragma warning restore BH1005
                    }
