...
namespace CMS.Helpers
{
    ...
    public static class HTTPHelper
    {
        ...
        private static void AddContentDispositionHeader(string disposition, string fileName, IResponse response)
        {
        ...
        public static string FilenameEncode(string filename)
        {
            ...
            {
                return HttpUtility.UrlEncode(filename, CMSHttpContext.Current.Response.HeaderEncoding);
            }
