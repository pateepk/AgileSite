...
namespace CMS.MediaLibrary.Web.UI
{
    ...
    public class MediaLibraryTransformationFunctions
    {
        ...
        public static string GetMediaFileUrl(object libraryId, object filePath, object fileGuid, object fileName, object useSecureLinks)
        {
            ...
            {
                return MediaFileURLProvider.GetMediaFileUrl(ValidationHelper.GetGuid(fileGuid, Guid.Empty), fileName.ToString());
            }

            return MediaFileURLProvider.GetMediaFileUrl(SiteContext.CurrentSiteName, libInfo.LibraryFolder, filePath.ToString());
        }
