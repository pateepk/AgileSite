...
namespace CMS.Tests
{
    ...
    public class FakeEventLogProvider : EventLogProvider
    {
        ...
        /// </summary>
        protected override EventLogInfo LogEventInternal(EventLogInfo eventObject, bool logDirectly)
        {
            ...
            return base.LogEventInternal(eventObject, (logDirectly | LogEventsDirectly));
        }
