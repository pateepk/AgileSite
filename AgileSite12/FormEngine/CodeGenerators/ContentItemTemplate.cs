...
string skuProductFieldsPropertyName = ItemTypeName.Equals("Product", StringComparison.InvariantCulture) ? "SKUProduct" : "Product";
string skuProductBackingFieldPropertyName = "m" + skuProductFieldsPropertyName;
string skuProductFieldsTypeName = ItemTypeName.Equals("Product", StringComparison.InvariantCulture) ? "SKUProductFields" : "ProductFields";
...
{ 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsTypeName));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductBackingFieldPropertyName));
            this.Write(";\r\n");
...
if (IsProduct) 
{
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsTypeName));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsPropertyName));
            this.Write("\r\n\t\t{\r\n\t\t\tget\r\n\t\t\t{\r\n\t\t\t\treturn ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductBackingFieldPropertyName));
            this.Write(";\r\n\t\t\t}\r\n\t\t}\r\n");
...
foreach (var field in Fields)
{
	if (field.DataType == CMS.DataEngine.FieldDataType.File)
	{
            ...
            this.Write("\r\n\t\t\t{\r\n\t\t\t\tget\r\n\t\t\t\t{\r\n\t\t\t\t\treturn mInstance.GetFieldDocumentAttachment(\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(field.Name));
            this.Write("\");\r\n\t\t\t\t}\r\n\t\t\t}\r\n");
	...
	else if (field.DataType == CMS.DataEngine.FieldDataType.DocAttachments)
	{
            ...
            this.Write("\r\n\r\n\t\t\t/// <summary>\r\n\t\t\t/// ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GetSummary(field)));
            this.Write("\r\n\t\t\t/// </summary>\r\n\t\t\tpublic IEnumerable<DocumentAttachment> ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GetNestedPropertyName(field)));
            this.Write("\r\n\t\t\t{\r\n\t\t\t\tget\r\n\t\t\t\t{\r\n\t\t\t\t\treturn mInstance.GetFieldDocumentAttachments(\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(field.Name));
            this.Write("\");\r\n\t\t\t\t}\r\n\t\t\t}\r\n");
...
if (IsProduct)
{
            ...
            this.Write("\r\n\r\n\t\t/// <summary>\r\n\t\t/// Provides extended API for working with SKU fields.\r\n\t\t" +
                    "/// </summary>\r\n        [RegisterAllProperties]\r\n\t\tpublic class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsTypeName));
            this.Write(" : AbstractHierarchicalObject<");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsTypeName));
            ...
            this.Write(" mInstance;\r\n\r\n\r\n\t\t\t/// <summary>\r\n\t\t\t/// The <see cref=\"PublicStatusInfo\" /> obj" +
                    ...
                    "ee cref=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(skuProductFieldsTypeName));
            this.Write("\" /> class with SKU related fields of type <see cref=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(ItemTypeName));
            this.Write("\" /> .\r\n\t\t\t/// </summary>\r\n\t\t\t/// <param name=\"instance\">The content item of type" +
                    " ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ItemTypeName));
