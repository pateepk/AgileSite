...
namespace CMS.OnlineMarketing.Web.UI
{
    ...
    /// </summary>
    internal class ABDocumentMarker : IABDocumentMarker
    {
        ...
        private void AppendRunningTestIcon(StringBuilder sb)
        {
            ...
            var testsByAliasPaths = CacheHelper.Cache(GetAliasPathsForUnfinishedTests, new CacheSettings(ABHandlers.CACHE_MINUTES, "nodealiaspathswithunfinishedtest", mSiteName, mCulture)
            {
            ...
            {
                var tooltip = CoreServices.Localization.GetString("ABTesting.DocumentContainsTest");
        ...
        /// </summary>
        private ILookup<string, string> GetAliasPathsForUnfinishedTests()
        {
