...
namespace CMS.Ecommerce
{
    ...
    public class CurrencyInfo : AbstractInfo<CurrencyInfo>
    {
        ...
        /// </summary>
        /// <seealso cref="CurrencyInfoProvider.GetFormattedValue(decimal, CurrencyInfo)"/>
        [DatabaseField]
        ...
        /// <summary>
        /// Returns price HTML encoded and formatted according to <see cref="CurrencyFormatString"/>.
        /// </summary>
