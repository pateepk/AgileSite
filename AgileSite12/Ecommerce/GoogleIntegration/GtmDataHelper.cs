...
namespace CMS.Ecommerce
{
    ...
    public class GtmDataHelper : AbstractHelper<GtmDataHelper>
    {
        ...
        {
            return JsonConvert.SerializeObject(gtmData, new JsonSerializerSettings { StringEscapeHandling = StringEscapeHandling.EscapeHtml });
        }
        ...
        {
            return JsonConvert.SerializeObject(gtmDataCollection, new JsonSerializerSettings { StringEscapeHandling = StringEscapeHandling.EscapeHtml });
        }
    }
}
