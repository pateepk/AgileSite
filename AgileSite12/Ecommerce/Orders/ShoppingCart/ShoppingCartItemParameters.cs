...
namespace CMS.Ecommerce
{
    ...
    public class ShoppingCartItemParameters
    {
        ...
        public static ShoppingCartItemParameters GetShoppingCartItemParameters()
        {
            ...
            foreach (var customParam in query.ColumnNames.Except(new[] { "productid", "quantity", "options", "aliaspath" }, StringComparer.OrdinalIgnoreCase))
            {
                skuParams.CustomParameters[customParam] = query.GetValue(customParam);
            }
