...
namespace CMS.Ecommerce
{
    ...
    internal class ShippingDiscountSource : IShippingDiscountSource
    {
        ...
        public decimal GetRemainingAmountForFreeShipping(CalculatorData data, decimal orderAmount)
        {
            ...
            var codes = GetCoupons(request.CouponCodes.GetAllDistinctCouponCodes(), discounts);
        ...
        {
            var couponCodes = GetCoupons(request.CouponCodes.GetAllDistinctCouponCodes(), shippingDiscounts).ToList();
