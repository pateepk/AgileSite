...
namespace CMS.DancingGoat.Samples
{
    ...
    internal class CampaignDataGenerator
    {
        ...
        /// </summary>
        private const string CAMPAIGN_COFFEE_CLUB_MEMBERSHIP_DRAFT = "DancingGoat.CoffeeClubMembership";


        /// <summary>
        /// Code name of the scheduled 'Coffee club membership' campaign.
        /// </summary>
        private const string CAMPAIGN_COFFEE_CLUB_MEMBERSHIP_SCHEDULED = "DancingGoat.CoffeeClubMembershipTest";


        /// <summary>
        /// Code name of the running 'Cafe sample promotion' campaign.
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING = "DancingGoat.CafeSamplePromotion";


        /// <summary>
        /// Code name of the finished 'Cafe sample promotion' campaign.
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED = "DancingGoat.CafeSamplePromotionTest";
        ...
        public void Generate()
        {
            CampaignInfoProvider.GetCampaigns()
                .WhereStartsWith("CampaignName", "DancingGoat.")
                .OnSite(mSite.SiteID)
                .ToList()
        ...
        private void GenerateActivities(string campaignName, Dictionary<string, IEnumerable<ActivityDataParameters>> conversionHits, int contactsCount)
        {
            ...
            var formFreeSample = BizFormInfoProvider.GetBizFormInfo(TRY_FREE_SAMPLE_FORM_CODE_NAME, mSite.SiteID);
            ...
            CampaignDataGeneratorHelpers.GenerateActivities(conversionHits[CONVERSION_FORMSUBMISSION_TRY_FREE_SAMPLE], campaignCafePromotion, PredefinedActivityType.BIZFORM_SUBMIT, campaignContactsIDs, formFreeSample.FormID);
        }
        ...
        private IEnumerable<CampaignConversionData> PrepareCafeSamplePromotionConversions()
        {
            ...
            return new List<CampaignConversionData>
            {
                ...
                new CampaignConversionData
                {
                    ...
                    ConversionItemID = formFreeSample.FormID,
                    ConversionOrder = 1,
