...
namespace CMS.DancingGoat.Samples
{
    ...
    internal class PersonaWithRulesGenerator
    {
        ...
        private const string COFFEE_GEEK_PERSONA_CONTACT_GROUP_NAME = "IsInPersona_Martina_TheCoffeeGeek";
        ...
        {
            var contactGroup = ContactGroupInfoProvider.GetContactGroupInfo(COFFEE_GEEK_PERSONA_CONTACT_GROUP_NAME);
            ...
            contactGroup.ContactGroupName = COFFEE_GEEK_PERSONA_CONTACT_GROUP_NAME;
        ...
        private RuleInfo GenerateRule(string displayName, int value, int scoreId, string ruleCondition, RuleTypeEnum ruleType, string ruleParameter = null, bool belongsToPersona = true)
        {
            ...
            var rule = RuleInfoProvider.GetRules().WithCodeName(codename).FirstOrDefault();
            if (rule != null)
            {
                return rule;
            }
