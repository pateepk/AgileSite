...
namespace CMS.Synchronization
{
    ...
    public class TaskGroupInfoProvider : AbstractInfoProvider<TaskGroupInfo, TaskGroupInfoProvider>
    {
        ...
        {
            return TaskGroupInfoProvider.GetTaskGroups().WhereIn("TaskGroupID", TaskGroupUserInfoProvider.GetTaskGroupUsers().WhereEquals("UserID", userID).Column("TaskGroupID")).TopN(1).FirstOrDefault();
        }
        ...
        protected virtual void SetTaskGroupForUserInternal(int taskGroupID, int userID)
        {
            ...
            var taskGroupUser = TaskGroupUserInfoProvider.GetTaskGroupUsers().WhereEquals("UserID", userID).TopN(1).FirstOrDefault();
