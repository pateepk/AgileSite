...
namespace CMS.Synchronization
{
    ...
    public class StagingTaskInfoProvider : AbstractInfoProvider<StagingTaskInfo, StagingTaskInfoProvider>
    {
        ...
        {
            return SettingsKeyInfoProvider.GetBoolValue("CMSStagingLogObjectChanges", siteName) && StagingEnabled;
        }
        ...
        {
            return SettingsKeyInfoProvider.GetBoolValue("CMSStagingLogChanges", siteName) && StagingEnabled;
        }
        ...
        public static ObjectQuery<StagingTaskInfo> SelectTaskList(int siteId, int serverId, string where, string orderBy, int topN = -1, string columns = null, int offset = 0, int maxRecords = 0)
        {
            return ProviderObject.SelectTaskListInternal(siteId, serverId, where, orderBy, topN, columns, offset, maxRecords);
        }
        ...
        [Obsolete("Use method without 'totalRecords' parameter and get the total count value from returned object after its result.")]
        ...
        /// <param name="offset">Index of first record to get</param>
        /// <param name="maxRecords">Maximum number of records to get. If maxRecords is zero or less, all records are returned (no paging is used)</param>
        public static ObjectQuery<StagingTaskInfo> SelectDocumentTaskList(int siteId, int serverId, string aliasPath, string where, string orderBy, int topN = -1, string columns = null, int offset = 0, int maxRecords = 0)
        {
            ...
            return SelectTaskList(siteId, serverId, whereCondition.ToString(true), orderBy, topN, columns, offset, maxRecords);
        }
        ...
        /// <param name="offset">Index of first record to get</param>
        /// <param name="maxRecords">Maximum number of records to get. If maxRecords is zero or less, all records are returned (no paging is used)</param>
        public static ObjectQuery<StagingTaskInfo> SelectObjectTaskList(int siteId, int serverId, string objectTypes, string where, string orderBy, int topN = -1, string columns = null, int offset = 0, int maxRecords = 0)
        {
            ...
            return SelectTaskList(siteId, serverId, where, orderBy, topN, columns, offset, maxRecords);
        }
        ...
        /// <param name="offset">Index of first record to get</param>
        /// <param name="maxRecords">Maximum number of records to get. If maxRecords is zero or less, all records are returned (no paging is used)</param>
        protected virtual ObjectQuery<StagingTaskInfo> SelectTaskListInternal(int siteId, int serverId, string where, string orderBy, int topN, string columns, int offset, int maxRecords)
        {
        ...
        {
            var selectTaskList = SelectTaskListInternal(siteId, serverId, where, orderBy, topN, columns, offset, maxRecords);
