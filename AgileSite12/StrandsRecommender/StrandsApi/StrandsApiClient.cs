...
#pragma warning restore BH1014 // Do not use System.IO
        ...
        private string BuildSetupCallQuery(StrandsSetupCallData data)
        {
            ...
            // Url of catalog feed page
            queryString["feedactive"] = data.FeedActive.ToString(System.Globalization.CultureInfo.InvariantCulture).ToLowerInvariant();

            // Number of products per page
            queryString["feedpagination"] = data.Pagination.ToString(System.Globalization.CultureInfo.InvariantCulture);
