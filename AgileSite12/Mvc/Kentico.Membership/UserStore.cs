...
namespace Kentico.Membership
{
                             ...
                             IUserSecurityStampStore<User, int>
    {
        ...
        public Task CreateAsync(User user)
        {
            ...
            RegistrationHelper.RegisterUser(userInfo);
        ...
        public Task SetEmailConfirmedAsync(User user, bool confirmed)
        {
            ...
            if (confirmed)
            {
                ...
                foreach (var definition in EmailConfirmationExtensionDefinitionRegister.Instance.Items)
                {
                    definition.EmailConfirmedAction?.Invoke(user.Id);
                }

                if (MembershipEvents.RegistrationCompleted.IsBound)
                {
                    MembershipEvents.RegistrationCompleted.StartEvent(UserInfoProvider.GetUserInfo(user.Id));
                }
            }
