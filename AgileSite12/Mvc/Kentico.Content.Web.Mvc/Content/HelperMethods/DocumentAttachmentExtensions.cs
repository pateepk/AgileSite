...
{
    /// <summary>
    /// Provides extension methods for the <see cref="DocumentAttachment"/> class.
    /// </summary>
    public static class DocumentAttachmentExtensions
    {
        ...
        public static string GetPath(this DocumentAttachment attachment, string variant = "")
        {
            if (attachment == null)
            {
            ...
            var url = $"~/getattachment/{attachment.AttachmentGUID:D}/{GetFileNameForUrl(fileName)}{variantQueryParameter?.ToQueryString()}";
        ...
        private static string GetFileName(DocumentAttachment attachment)
        {
