...
namespace CMS.Personas.Web.UI
{
    ...
    {
        private const string NOT_PROFILLED_PERSONA_NAME_RESOURCE_KEY = "persona.notprofilledpersona.name";
        private const string NOT_PROFILLED_PERSONA_DESCRIPTION_RESOURCE_KEY = "persona.notprofilledpersona.description";
