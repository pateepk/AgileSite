...
namespace CMS.OnlineMarketing
{
    ...
    internal static class OnlineMarketingImportSpecialActions
    {
        ...
        public static void Init()
        {
            ...
            ImportExportEvents.ImportObject.Before += ResetABTestDatesOnContentOnlySite;
        }


        private static void ResetABTestDatesOnContentOnlySite(object sender, ImportEventArgs e)
        {
            var infoObj = e.Object;

            if ((infoObj.TypeInfo.ObjectType == ABTestInfo.OBJECT_TYPE) && e.Settings.SiteIsContentOnly)
            {
                var abTest = (ABTestInfo)infoObj;

                abTest.ABTestOpenFrom = DateTimeHelper.ZERO_TIME;
                abTest.ABTestOpenTo = DateTimeHelper.ZERO_TIME;
            }
        }
