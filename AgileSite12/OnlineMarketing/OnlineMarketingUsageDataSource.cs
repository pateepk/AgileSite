...
namespace CMS.OnlineMarketing
{
    ...
    internal class OnlineMarketingUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("OMSettingsUsageOnSites", JsonConvert.SerializeObject(GetSettingsUsage(), settings));
            usageData.Add("OMSettingsUsageGlobal", JsonConvert.SerializeObject(GetSettingsUsage(global: true).Select(s => new { s.KeyName, s.KeyValue }), settings));
