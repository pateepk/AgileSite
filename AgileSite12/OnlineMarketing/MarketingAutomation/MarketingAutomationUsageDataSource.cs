...
namespace CMS.MarketingAutomation
{
    ...
    internal class MarketingAutomationUsageDataSource : IModuleUsageDataSource
    {
        ...
        public IModuleUsageDataCollection GetData()
        {
            ...
            usageData.Add("NumberOfContactsWithinEachProcess", JsonConvert.SerializeObject(GetNumberOfContactsWithinEachProcess(), new JsonSerializerSettings { StringEscapeHandling = StringEscapeHandling.EscapeHtml }));
