...
namespace CMS.OnlineMarketing.Internal
{
    ...
    /// </summary>
    public static class ABRequestManager
    {
        #region "Fields"
        ...
        internal static void ExcludeVisitorsBasedOnSegmentationConditions(ABTestInfo abTest, IABUserStateManager<string> manager)
        {
            if (abTest == null)
            {
                throw new ArgumentNullException("abTest");
        ...
        /// </summary>
        /// <param name="manager">AB user state manager</param>
        private static void ExcludeAndSetOriginalPage(IABUserStateManager<string> manager)
        {
            manager.Exclude();
