...
namespace CMS.OnlineMarketing.Internal
{
    ...
    public static class ABSegmentationEvaluator
    {
        ...
        /// </summary>
        public static bool CheckUserIsEditor()
        {
        ...
        public static bool CheckIncludedTrafficCondition(ABTestInfo abTest)
        {
            if (abTest == null)
            {
        ...
        /// <param name="abTest">AB test</param>
        /// <exception cref="ArgumentNullException"><paramref name="abTest"/> is null</exception>
        public static bool CheckVisitorTargetingMacro(ABTestInfo abTest)
        {
            if (abTest == null)
            {
                throw new ArgumentNullException("abTest");
