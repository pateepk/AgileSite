...
namespace CMS.Synchronization
{
    ...
    public class StagingTaskRunner
    {
        ...
        {
            return SettingsKeyInfoProvider.GetBoolValue("CMSStagingServiceEnabled", siteName);
        }
        ...
        {
            switch (SettingsKeyInfoProvider.GetValue("CMSStagingServiceAuthentication", siteName).ToLowerCSafe())
            {
                // X509 authentication
                case "x509":
