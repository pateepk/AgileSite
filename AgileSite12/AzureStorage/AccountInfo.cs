...
namespace CMS.AzureStorage
{
    ...
    public class AccountInfo
    {
        ...
        public AccountInfo()
        {
            ...
            AccountName = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAzureAccountName"], string.Empty), UnicodeCategory.Format).Trim();
            SharedKey = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAzureSharedKey"], string.Empty), UnicodeCategory.Format).Trim();
            QueueEndpoint = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAzureQueueEndPoint"], string.Empty), UnicodeCategory.Format).Trim();
            TableEndpoint = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAzureTableEndPoint"], string.Empty), UnicodeCategory.Format).Trim();
            BlobEndpoint = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAzureBlobEndPoint"], string.Empty), UnicodeCategory.Format).Trim();
        }
