...
namespace CMS.Search.TextExtractors
{
    ...
    public class PdfSearchTextExtractor : ISearchTextExtractor
    {
        ...
        public XmlData ExtractContent(BinaryData data, ExtractionContext context)
        {
            ...
            content = StripInvalidContentCharacters(content);
        ...
        /// </remarks>
        protected virtual string StripInvalidContentCharacters(string content)
        {
            return UnicodeUtils.StripInvalidSurrogatePairs(content);
        }
