...
namespace CMS.AmazonStorage
{
    ...
    public class AccountInfo
    {
        ...
        private AccountInfo()
        {
            AccessKeyID = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAmazonAccessKeyID"], string.Empty), UnicodeCategory.Format).Trim();
            AccessKey = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAmazonAccessKey"], string.Empty), UnicodeCategory.Format).Trim();
            BucketName = TextHelper.RemoveCharacters(ValidationHelper.GetString(SettingsHelper.AppSettings["CMSAmazonBucketName"], string.Empty), UnicodeCategory.Format).Trim();
