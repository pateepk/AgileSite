    ...
    public class UserSearchIndexer : SearchIndexer
    {
        ...
        public override bool FillSearchResult(SearchResultItem resultItem, DataRow resultDr, ILuceneSearchDocument doc)
        {
            ...
            if (result)
            {
                ...
                if (String.IsNullOrEmpty(Convert.ToString(resultItem.Title)))
                {
                    resultItem.Title = DataHelper.GetStringValue(resultDr, "UserName");
                }
        ...
        public override string GetSearchImageUrl(SearchResultItem resultItem)
        {
            ...
            return AvatarInfoProvider.GetUserAvatarImageUrl(resultItem.GetSearchValue("UserAvatarID"), resultItem.GetSearchValue("UserID"), null, 0, 0, 0);
        }
