...
namespace CMS.Membership
{
    ...
    public class UserSettingsInfo : AbstractInfo<UserSettingsInfo>
    {
        ...
        public static ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(UserSettingsInfoProvider), OBJECT_TYPE, "CMS.UserSettings", "UserSettingsID", null, "UserSettingsUserGUID", null, null, null, null, "UserSettingsUserID", UserInfo.OBJECT_TYPE)
        {
            ...
            {
                new ObjectDependency("UserActivatedByUserID", UserInfo.OBJECT_TYPE),
                new ObjectDependency("UserTimeZoneID", TimeZoneInfo.OBJECT_TYPE),
                new ObjectDependency("UserAvatarID", AvatarInfo.OBJECT_TYPE),
                new ObjectDependency("UserBadgeID", BadgeInfo.OBJECT_TYPE)
            },
        ...
        /// User custom data.
        /// </summary>
        protected ContainerCustomData mUserCustomData;


        /// <summary>
        /// User custom data.
        /// </summary>
        protected ContainerCustomData mUserPreferences;
        ...
        /// </summary>
        [DatabaseField]
        [Obsolete("Use property UserCustomData instead.")]
