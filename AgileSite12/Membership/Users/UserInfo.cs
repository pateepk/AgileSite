...
namespace CMS.Membership
{
    ...
    public class UserInfo : AbstractInfo<UserInfo>, IUserInfo
    {
        ...
        /// </para>
        /// <para>
        /// When toggling the enabled state of a user, a new <see cref="UserSecurityStamp"/> should be generated. Use <see cref="UserInfoProvider.SetEnabled"/>
        /// to generate a new stamp automatically.
        /// </para>
        /// </remarks>
        /// <seealso cref="UserInfoProvider.SetEnabled"/>
        ...
        private SafeDictionary<string, SafeDictionary<string, DateTime?>> CreateSiteUIElementsTable()
        {
            ...
            if (userId > 0)
            {
                ...
                foreach (string siteName in securityCollections.SitesRoles.Keys)
                {
                    ...
                    if (siteRoles != null)
                    {
                        roleIds.AddRangeToSet(siteRoles.Values.OfType<int>());
                    }
                }
