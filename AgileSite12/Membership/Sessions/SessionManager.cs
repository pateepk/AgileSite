    ...
    public static class SessionManager
    {
        ...
        public static void RemoveAuthenticatedUser(string siteName, int userId, bool createTask)
        {
            if (siteName != null)
            {
                ...
                if (createTask)
                {
                    WebFarmHelper.CreateTask(new RemoveAuthenticatedUserWebFarmTask
                    {
                        SiteName = siteName,
                        UserId = userId
                    });
        ...
        public static void RemoveUser(int userId, bool createTask)
        {
            if (userId > 0)
            {
                ...
                {
                    WebFarmHelper.CreateTask(new RemoveSessionWebFarmTask { UserId = userId });
                }
            }
        }
        ...
        public static void KickUser(int userID)
        {
            ...
            WebFarmHelper.CreateTask(new AddUserToKickedListWebFarmTask { UserId = userID });
        ...
        public static void RemoveUserFromKicked(int userID)
        {
            ...
            // Create webfarm task if needed
            WebFarmHelper.CreateTask(new RemoveUserFromKickedList { UserId = userID });
        }
