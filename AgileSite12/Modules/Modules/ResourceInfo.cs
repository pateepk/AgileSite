    ...
    public class ResourceInfo : AbstractInfo<ResourceInfo>
    {
        ...
        protected override void InsertAsCloneInternal(CloneSettings settings, CloneResult result, BaseInfo originalObject)
        {
            ...
            if (settings.IncludeChildren && !settings.ExcludedChildTypes.Contains(UIElementInfo.OBJECT_TYPE))
            {
                ...
                var rootParents = UIElementInfoProvider.GetUIElements().From(new QuerySourceTable("CMS_UIElement", "sub"))
                    .WhereEquals("sub.ElementID", "main.ElementParentID".AsColumn())
                    .WhereNotEquals("sub.ElementResourceID", originalObject.Generalized.ObjectID)
                    .Columns("sub.ElementID")
                    .TopN(1);

                var rootElements = UIElementInfoProvider.GetUIElements().From(new QuerySourceTable("CMS_UIElement", "main"))
                    .WhereEquals("main.ElementResourceID", originalObject.Generalized.ObjectID)
                    .WhereIn("ElementParentID", rootParents)
                    .OrderBy("main.ElementLevel", "main.ElementOrder")
                    .ToList();
                ...
                {
                    rootElement.Generalized.InsertAsClone(settings, result);
                }
