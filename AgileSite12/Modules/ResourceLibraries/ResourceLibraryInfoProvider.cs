...
namespace CMS.Modules
{
    ...
    public class ResourceLibraryInfoProvider : AbstractInfoProvider<ResourceLibraryInfo, ResourceLibraryInfoProvider>
    {
        ...
        protected override void SetInfo(ResourceLibraryInfo info)
        {
            ...
            if (IsImplicitlyIncludedLibrary(info, resourceInfo))
            {
        ...
        /// </summary>
        public static bool IsImplicitlyIncludedLibrary(ResourceLibraryInfo libraryInfo, ResourceInfo resourceInfo)
        {
            if (libraryInfo == null)
            {
            ...
            var normalizedPath = NormalizeResourceLibraryPath(libraryInfo.ResourceLibraryPath);
            
            return String.Format("~\\bin\\{0}.dll", resourceInfo.ResourceName).Equals(normalizedPath, StringComparison.InvariantCultureIgnoreCase);
        }
