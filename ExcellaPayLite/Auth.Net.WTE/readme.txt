...
Integration Method (AIM) standards.
  Microsoft-IIS/5.1 using .NET 3.5 SP1
...
- This project file was created using Microsoft Visual Web Developer Express
  2008 service pack 1 and cannot be opened with previous versions.  Visual Web
  Developer Express 2008 SP1 is freely available at:
