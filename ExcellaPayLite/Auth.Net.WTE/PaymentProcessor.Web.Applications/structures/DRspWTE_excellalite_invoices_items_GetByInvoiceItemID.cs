...
{
	public class DRspWTE_excellalite_invoices_items_GetByInvoiceItemID : TableReaderBase 
	{
		...
		public DRspWTE_excellalite_invoices_items_GetByInvoiceItemID(DataSet ds)
		{
			base.setData(ds);
		}
