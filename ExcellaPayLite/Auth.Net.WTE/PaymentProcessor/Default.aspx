<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Default.aspx.cs" Inherits="PaymentProcessor.DefaultPage" %>
...
-->
        <form id="simForm" runat="server" method='post' action='dynamic'>
            <input type="hidden" id="HiddenValue" value="Initial Value" runat="server" />
