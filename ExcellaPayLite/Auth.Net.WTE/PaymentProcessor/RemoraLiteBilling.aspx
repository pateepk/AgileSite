<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoraLiteBilling.aspx.cs" Inherits="PaymentProcessor.DPRemoraLiteBilling" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Remora Lite Billing</title>
...
<body>
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">Remora Lite Subscription</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="9" Text="First Month Trial $49.98, then $99 monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr id="trTeamMember" runat="server" visible="false">
                        ...
                        <td>
                            <asp:DropDownList runat="server" ID="ddlTeamMember" Style="display: inline-block;">
                                ...
                                <asp:ListItem Value="5" Text="Dark Pool Secrets"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
