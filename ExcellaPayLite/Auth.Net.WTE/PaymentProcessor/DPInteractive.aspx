<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DPInteractive.aspx.cs" Inherits="PaymentProcessor.DPCInteractiveRecurringBilling" %>
...
<body> 
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">Dark Pool Interactive App<br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="15" Text="$39.99 monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
