...
{
    /// <summary>
    /// Sample page for Braintree recurring, this does not work
    /// </summary>
    public partial class braintree_recure : System.Web.UI.Page
    {
        #region members
...

            {
                ...
                TransactionRequest transactionRequest = new TransactionRequest
                {
                    ...
                    CreditCard = new TransactionCreditCardRequest
                    {
                        ...
                        Token = dateAsLong.ToString()
                    },
                    Customer = new CustomerRequest
                    {
                        Id = dateAsLong.ToString(),
                ...
                {
                    CustomerId = dateAsLong.ToString(),
                    PaymentMethodNonce = "aa9999"
                };

                Result<PaymentMethod> result2 = Gateway.PaymentMethod.Create(request);

                var request3 = new SubscriptionRequest
                {
                    PaymentMethodToken = dateAsLong.ToString(),
                    PlanId = "WAFBusiness"
                };

                Result<Subscription> result3 = Gateway.Subscription.Create(request3);
