<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="braintree.aspx.cs" Inherits="PaymentProcessor.braintree" %>
...
<section class="excellapay">
    ...
    <asp:Panel runat="server" ID="pnlForm">
        ...
        <div class="epayFoot">
            <p class="center">
                <b>Note: area</b><br />
                <small>&copy; 2015 MyRunner.com | All Rights Reserved</small>
            </p>
        </div>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlResult">
        <div id="divPage" class="Page">
            <div id="divMerchantHeader" class="receipt_header">
                <h1>MyRunner Receipt</h1>
            </div>
            
            <div id="divThankYou"><h3>Thank you for your payment!</h3></div>
            <div id="divReceiptMsg"><p>Your Run has been scheduled.  Click here to return and monitor it's progress.</p></div>
