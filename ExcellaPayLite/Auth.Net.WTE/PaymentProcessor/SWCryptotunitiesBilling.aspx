<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SWCryptotunitiesBilling.aspx.cs" Inherits="PaymentProcessor.SWCryptotunitiesBilling" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Crypto'tunities Membership Billing</title>
    ...
    <!--<link href="https://www.thestockwhisperer.com/App_Themes/TSW12/assets/css/core2.min.css" type="text/css" rel="stylesheet" />-->
</head>
<body>
    <div class="membership container">

        <h3 class="text-center m-b-1">Crypto’tunities<br />
        ...
        <form id="form1" runat="server">
            <div class="m-1">
                <table id="tblFormFields" runat="server" class="excella-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="12" Text="$99.99 monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr id="trTeamMember" runat="server" visible="false">
                        <td>
                        ...
                        <td>
                            <asp:DropDownList runat="server" ID="ddlTeamMember" Style="display: inline-block;">
                                ...
                                <asp:ListItem Value="1" Text="John aka Jay the Trader"></asp:ListItem>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <asp:CheckBox runat="server" ID="chkAgreeToTerm" />&nbsp;<label for="chkAgreeToTerm">I agree to the&nbsp;<a href="http://thestockwhisperer.com/Help/Terms-and-Conditions" target="_blank">terms and conditions</a>&nbsp;and
                                 <a href="http://thestockwhisperer.com/Help/Refund-Policy" target="_blank">refund policy</a></label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="right">
