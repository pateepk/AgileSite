<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DPCRecurringBilling.aspx.cs" Inherits="PaymentProcessor.DPCRecurringBilling" %>

<!DOCTYPE html">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>The Training Pit Membership Billing</title>
    <meta charset="utf" />
...
<body>
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">The Training Pit<br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="1" Text="$99.97 monthly"></asp:ListItem>
                                <asp:ListItem Value="2" Text="$269.97 quarterly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
