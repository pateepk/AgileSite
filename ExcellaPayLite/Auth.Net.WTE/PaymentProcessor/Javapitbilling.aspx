<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Javapitbilling.aspx.cs" Inherits="PaymentProcessor.JavapitBilling" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Java Pit Billing</title>
...
<body>
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">Java Pit Subscription</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="16" Text="$299.95 Monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
