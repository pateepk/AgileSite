<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoraBilling.aspx.cs" Inherits="PaymentProcessor.SWRemoraBilling" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Remora Billing</title>
...
<body>
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">Remora Subscription</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="5" Text="$98 monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
