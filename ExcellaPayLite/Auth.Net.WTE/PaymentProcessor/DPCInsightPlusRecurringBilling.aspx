<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DPCInsightPlusRecurringBilling.aspx.cs" Inherits="PaymentProcessor.DPCInsightPlusRecurringBilling" %>
...
<body>
    <div class="membership container">
        ...
        <h3 class="text-center m-b-1">Dark Pool Insights Plus<br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPaymentOption" runat="server">
                                <asp:ListItem Value="14" Text="$97.00 monthly"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
